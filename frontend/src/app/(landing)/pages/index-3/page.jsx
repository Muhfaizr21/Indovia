...
const Index3 = () => (
  <>
    <Helmet>
      <title>Index 3 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-3">
      <header className="header sticky-bar header-style-5">
          ...
          <main className="main">
            <div className="box-home3-style">
              <section className="section banner-homepage3">
                <div className="container">
                  <div className="box-banner-home3">
                    <div className="box-swiper">
                      <div className="swiper-container swiper-banner pb-0">
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <div className="box-cover-image" style={{backgroundImage: "url(/assets/imgs/page/homepage3/banner.png)"}}></div>
                            <div className="box-banner-info wow fadeInLeft">
                              <h2 className="heading-title-medium color-primary-dark mb-15">End of<br className="d-block" />season sale</h2><a className="link-underline-2 mr-25" href="#">Shop Mens</a><a className="link-underline-2" href="#">Shop Womens</a>
                            </div>
                          </div>
                          <div className="swiper-slide">
                            <div className="box-cover-image" style={{backgroundImage: "url(/assets/imgs/page/homepage3/banner-2.png)"}}></div>
                            <div className="box-banner-info wow fadeInLeft">
                              <h2 className="heading-title-medium color-primary-dark mb-15">Don't miss<br className="d-block" />This Trending</h2><a className="link-underline-2 mr-25" href="#">Shop Mens</a><a className="link-underline-2" href="#">Shop Womens</a>
                            </div>
                          </div>
                        </div>
              ...
              <section className="section box-category-type-2">
                <div className="container"> 
                  <div className="row"> 
                    <div className="col-lg-6">
                      <div className="cardCategory wow fadeInUp">
                        <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage3/cat1.png" alt="Indovia" /></a></div>
                        <div className="cardInfo">
                          <h4 className="cardTitle">Premium Jeans</h4><a className="link-underline-2" href="#">Mens</a><a className="link-underline-2" href="#">Womens</a>
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-6">
                      <div className="cardCategory wow fadeInUp">
                        <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage3/cat2.png" alt="Indovia" /></a></div>
                        <div className="cardInfo">
                          <h4 className="cardTitle">Sweaters</h4><a className="link-underline-2" href="#">Mens</a><a className="link-underline-2" href="#">Womens</a>
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-4 card-style-small">
                      <div className="cardCategory wow fadeInUp">
                        <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage3/cat3.png" alt="Indovia" /></a></div>
                        <div className="cardInfo">
                          <h4 className="cardTitle">Tees</h4><a className="link-underline-2" href="#">Mens</a><a className="link-underline-2" href="#">Womens</a>
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-4 card-style-small">
                      <div className="cardCategory wow fadeInUp">
                        <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage3/cat4.png" alt="Indovia" /></a></div>
                        <div className="cardInfo">
                          <h4 className="cardTitle">Chinos</h4><a className="link-underline-2" href="#">Mens</a><a className="link-underline-2" href="#">Womens</a>
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-4 card-style-small">
                      <div className="cardCategory wow fadeInUp">
                        <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage3/cat5.png" alt="Indovia" /></a></div>
                        <div className="cardInfo">
                          <h4 className="cardTitle">Cozy Sweats</h4><a className="link-underline-2" href="#">Mens</a><a className="link-underline-2" href="#">Womens</a>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <section className="section box-new-in">
                <div className="container"> 
                  <div className="text-center"> 
                    <h3 className="wow fadeInLeft">New-in this week</h3>
                  </div>
                  <div className="box-tabs box-tabs-left wow fadeInRight"> 
                    <ul className="nav nav-tabs nav-tabs-medium" role="tablist">
                      <li className="nav-item" role="presentation">
                        <button className="nav-link active" id="mens-tab" data-bs-toggle="tab" data-bs-target="#mens" type="button" role="tab" aria-controls="mens" aria-selected="true" data-index="1" data-items="4">Mens</button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="womens-tab" data-bs-toggle="tab" data-bs-target="#womens" type="button" role="tab" aria-controls="womens" aria-selected="false" data-index="2" data-items="4">Womens</button>
                      </li>
                    </ul>
                  </div>
                          ...
                          <div className="swiper-wrapper">
                            <div className="swiper-slide">
                              <div className="cardCollectionStyle1 wow fadeInUp">
                                <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage1/collection1.png" alt="Indovia" /></a></div>
                            ...
                            <div className="swiper-slide">
                              <div className="cardCollectionStyle1 wow fadeInUp">
                                <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage1/collection2.png" alt="Indovia" /></a></div>
                                <div className="cardInfo"><a href="#">
                                    <h6>Skirts (5)</h6></a></div>
                              </div>
                            </div>
                            <div className="swiper-slide">
                              <div className="cardCollectionStyle1 wow fadeInUp">
                                <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage1/collection3.png" alt="Indovia" /></a></div>
                                <div className="cardInfo"><a href="#">
                                    <h6>Men’s (12)</h6></a></div>
                              </div>
                            </div>
                            <div className="swiper-slide">
                              <div className="cardCollectionStyle1 wow fadeInUp">
                                <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage1/collection4.png" alt="Indovia" /></a></div>
                                <div className="cardInfo"><a href="#">
                                    <h6>Shirts (3)</h6></a></div>
                              </div>
                            </div>
                          </div>
                        </div>
              ...
              <section className="section block-banner-video"> 
                <div className="container"> 
                  <div className="box-text-banner-video">
                    <p className="text-16-medium color-white mb-15 wow fadeInLeft">MEMORIAL DAY SALE</p>
                    <h1 className="heading-title-medium color-white mb-15 wow fadeInRight">20% OFF $200+ Orders</h1>
                    <p className="text-16-medium color-white mb-30 wow fadeInDown">USE CODE: MEMORIAL20</p><a className="btn btn-white wow fadeInUp" href="#">Shop Now</a>
                  </div>
                </div>
              </section>
              <section className="section block-trending-now">
                <div className="container"> 
                  <div className="text-center"> 
                  ...
                  <div className="text-center wow fadeInUp"> <a className="btn btn-black" href="#">See All Products</a></div>
                </div>
              </section>
