...
const Index26 = () => (
  <>
    <Helmet>
      <title>Index 26 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-26">
      <header className="header sticky-bar header-style-3 header-style-3-fixed">
          ...
          <main className="main">
            <section className="section block-banner-home26">
              <div className="box-swiper">
                <div className="swiper-container swiper-banner pb-0">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <div className="box-banner-cover">
                        <div className="container">
                          <div className="box-banner-cover-inner">
                            <div className="row align-items-center">
                              <div className="col-lg-5">
                                <p className="text-17-medium mb-10">Sneaker Collection</p>
                                <h1 className="mb-30 font-jost font-bold">Good shoes take you good places</h1><a className="btn btn-border" href="#">Shop Now</a>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="swiper-slide">
                      <div className="box-banner-cover">
                        <div className="container">
                          <div className="box-banner-cover-inner bg-2">
                            <div className="row align-items-center">
                              <div className="col-lg-5">
                                <p className="text-17-medium mb-10">Sneaker Collection</p>
                                <h1 className="mb-30 font-jost font-bold">Good shoes take you good places</h1><a className="btn btn-border" href="#">Shop Now</a>
                    ...
                    <div className="swiper-slide">
                      <div className="box-banner-cover">
                        <div className="container">
                          <div className="box-banner-cover-inner bg-3">
                            <div className="row align-items-center">
                              <div className="col-lg-5">
                                <p className="text-17-medium mb-10">Sneaker Collection</p>
                                <h1 className="mb-30 font-jost font-bold">Good shoes take you good places</h1><a className="btn btn-border" href="#">Shop Now</a>
                  ...
                  <div className="swiper-button-prev swiper-button-prev-banner btn-prev-style-3"></div>
                  <div className="swiper-button-next swiper-button-next-banner btn-next-style-3"></div>
                </div>
              </div>
            </section>
            <section className="section block-moving-forward-home26">
              <div className="container"> 
                <div className="text-center"> 
                  <h3 className="text-34-bold mb-40">MOVING FORWARD<br className="d-none d-lg-block" />WITH JULY SHOES</h3>
                </div>
                <div className="box-banner-video" style={{backgroundImage: "url(/assets/imgs/page/homepage26/banner-2.png)"}}><a className="btn btn-play-video popup-youtube" href="https://www.youtube.com/watch?v=9ilb5AhvVwU"></a></div>
              </div>
            </section>
            <section className="section block-categories-home26">
              <div className="container"> 
                <div className="row"> 
                  <div className="col-7 mb-40">
                    <h3>The Essentials</h3>
                  </div>
                  <div className="col-5 mb-40">
                    <div className="position-relative box-button-top-0">
                      <div className="box-page-swiper">
                        <div className="swiper-button-prev swiper-button-prev-popular-product btn-prev-style-1"></div>
                        <div className="swiper-button-next swiper-button-next-popular-product btn-next-style-1"></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="container-slider-padding">   
                <div className="box-swiper">
                  <div className="swiper-container swiper-scrollbar-4-items">
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <div className="cardProductCategory02 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage26/cat.png" alt="Indovia" /></a></div>
                          <div className="cardInfo">
                            <h5 className="text-24-medium">Nyken Air Force</h5>
                      ...
                      <div className="swiper-slide">
                        <div className="cardProductCategory02 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage26/cat2.png" alt="Indovia" /></a></div>
                          <div className="cardInfo">
                            <h5 className="text-24-medium">Lifestyle</h5>
                      ...
                      <div className="swiper-slide">
                        <div className="cardProductCategory02 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage26/cat3.png" alt="Indovia" /></a></div>
                          <div className="cardInfo">
                            <h5 className="text-24-medium">Skate Shoes</h5>
                      ...
                      <div className="swiper-slide">
                        <div className="cardProductCategory02 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage26/cat.png" alt="Indovia" /></a></div>
                          <div className="cardInfo">
                            <h5 className="text-24-medium">Football</h5>
              ...
              <div className="container swiper-full-scroll">
                <div className="swiper-pagination swiper-pagination-popular-product"></div>
              </div>
            </section>
            <section className="section box-product-list-home26">
              <div className="container"> 
                  ...
                  <div className="box-tabs wow fadeInRight"> 
                    <ul className="nav nav-tabs nav-tabs-style-2 nav-tabs-style-4" role="tablist">
                      <li className="nav-item" role="presentation">
                        <button className="nav-link active" id="bestsellers-tab" data-bs-toggle="tab" data-bs-target="#bestsellers" type="button" role="tab" aria-controls="bestsellers" aria-selected="true">Best Sellers</button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="features-tab" data-bs-toggle="tab" data-bs-target="#features" type="button" role="tab" aria-controls="features" aria-selected="true">Featured</button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="newproducts-tab" data-bs-toggle="tab" data-bs-target="#newproducts" type="button" role="tab" aria-controls="newproducts" aria-selected="false">Big Sale</button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="featureproducts-tab" data-bs-toggle="tab" data-bs-target="#featureproducts" type="button" role="tab" aria-controls="featureproducts" aria-selected="false">Top Rate</button>
                      </li>
                    </ul>
                  </div>
                </div>
                <div className="tab-content">
                  <div className="tab-pane fade show active" id="bestsellers" role="tabpanel" aria-labelledby="bestsellers-tab">
                    <div className="row"> 
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProductStyle3 cardProductType03 cardProductType02 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage26/sp.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage26/sp.png" alt="Indovia" /></a>
                          ...
                          <div className="cardInfo">
                            <h6 className="text-16-medium">Huawei Watch Charging Cradle</h6>
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProductStyle3 cardProductType03 cardProductType02 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage26/sp2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage26/sp2.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                          ...
                          <div className="cardInfo">
                            <h6 className="text-16-medium">Smart Watches</h6>
                            <p className="body-p2 cardDesc">$100.00</p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="text-center mt-40"><a className="btn btn-border" href="#"> 
                        <svg className="icon-16" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="tab-pane fade" id="featureproducts" role="tabpanel" aria-labelledby="featureproducts-tab"> 
                    <div className="row"> 
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProductStyle3 cardProductType03 cardProductType02 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage26/sp.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage26/sp.png" alt="Indovia" /></a>
