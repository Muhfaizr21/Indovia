...
const CustomeService = () => (
  <>
    <Helmet>
      <title>Custome Service | Indovia Store</title>
    </Helmet>
    <div className="landing-page-custome-service">
          ...
          <main className="main">
            <section className="section banner-500">
              ...
              <div className="box-banner-info wow fadeInUp"> 
                <p className="overline-t2-medium text-uppercase primary-navy mb-10">CUSTOMER SERVICE</p>
                <h2 className="color-primary-dark mb-30">Any questions?<br className="d-none d-lg-block" />We’re here to help</h2>
              </div>
            </section>
            <section className="section block-content-custome">
              <div className="container"> 
                <div className="row"> 
                  <div className="col-lg-3 wow fadeInUp"> 
                    <ul className="menu-left"> 
                      <li> <a className="active" href="#">Privacy Policy</a></li>
                      <li> <a href="#">Shipping & Returns</a></li>
                      <li> <a href="#">Financing</a></li>
                      <li> <a href="#">Cookie Policy</a></li>
                      <li> <a href="#">Terms & Conditions</a></li>
                      <li> <a href="#">Coupon & Promotions</a></li>
                    </ul>
                  </div>
                  <div className="col-lg-9 wow fadeInUp"> 
                    <div className="content-detail">
                      ...
                      <p className="body-p2 neutral-medium-dark">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas cursus quam ut aliquam porttitor. Fusce finibus, urna in auctor placerat, libero sapien fringilla ex, id gravida libero felis quis risus. Nam eu felis malesuada, dignissim metus pulvinar, semper velit. Mauris orci justo, sodales ut ultrices ac, vulputate nec tortor. Etiam fermentum justo at sem lacinia elementum. Fusce a mauris nunc. In eu pharetra justo. Morbi auctor at nunc sed ullamcorper. Nunc pellentesque, diam hendrerit eleifend pellentesque, lorem quam consectetur quam, eu pharetra turpis lacus in tortor. Morbi facilisis suscipit quam. Maecenas fermentum, urna sed tincidunt dapibus, magna turpis malesuada felis, in imperdiet ipsum ipsum id arcu. Donec vel pretium est.</p>
                      <h5>Personally Identifiable Information</h5>
                      <p>Fusce a mauris nunc. In eu pharetra justo. Morbi auctor at nunc sed ullamcorper. Nunc pellentesque, diam hendrerit eleifend pellentesque, lorem quam consectetur quam, eu pharetra turpis lacus in tortor. Morbi facilisis suscipit quam. Maecenas fermentum, urna sed tincidunt dapibus, magna turpis malesuada felis, in imperdiet ipsum ipsum id arcu. Donec vel pretium est.</p>
                      ...
                      <p>We automatically receive and collect Non-personally Identifiable Information on our server logs from your browser, including your IP address, the Uniform Resource Locator ("URL") that you just came from, which URL you next go to, browser type, browser language, date and time of your query, Rebag cookie information, and the pages you request. This information is compiled and analyzed on both a personal and an aggregated basis. We may use third-party analytics services to collect, monitor and analyze the information collected as described above.</p>
                      <p className="text-17-medium mt-60">Don't see what you're looking for? All you have to do is ask <br />— we'll do our best to track down your request.</p>
                      <div className="mt-25"><a className="btn btn-black" href="#">Contact Us</a></div>
                    </div>
                  </div>
                </div>
              </div>
