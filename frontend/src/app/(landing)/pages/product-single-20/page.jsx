...
const ProductSingle20 = () => (
  <>
    <Helmet>
      <title>Product Single 20 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-product-single-20">
                    ...
                    <div className="detail-gallery">
                      ...
                      <div className="box-main-gallery">
                        <div className="product-image-slider product-image-slider-1">
                          <figure className="border-radius-10"><a className="btn btn-play-video popup-youtube" href="https://www.youtube.com/watch?v=9ilb5AhvVwU"></a><img src="/assets/imgs/page/product/img.png" alt="kidify" /></figure>
...
export default ProductSingle20;
