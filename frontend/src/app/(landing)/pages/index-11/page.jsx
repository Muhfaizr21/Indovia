...
const Index11 = () => (
  <>
    <Helmet>
      <title>Index 11 | Larkon Store</title>
    </Helmet>
                      ...
                      <div className="box-cover-image">
                        <div className="box-banner-info"> 
                          <div className="row align-items-center"> 
                            ...
                            <div className="col-md-6 mb-30">
                              <div className="box-bg-pet"><img src="/assets/imgs/page/homepage11/pets.png" alt="Guza" /></div>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div className="row">
                  <div className="col-lg-6 mb-30">
                    <div className="box-col wow fadeInLeft"> 
                      <div className="row">
                        <div className="col-lg-7 col-md-6 col-sm-6"><a href="#"><img src="/assets/imgs/page/homepage11/dog.png" alt="Guza" /></a></div>
                  ...
                  <div className="col-lg-6 mb-30">
                    <div className="box-col wow fadeInRight"> 
                      <div className="row">
                        <div className="col-md-6 col-sm-6"><a href="#"><img src="/assets/imgs/page/homepage11/cat.png" alt="Guza" /></a></div>
                ...
                <div className="row"> 
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProduceCircle wow fadeInDown">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage11/food.png" alt="Guza" /></a></div>
                      <div className="cardInfo"><a className="text-17-medium" href="#">Food<span className="sub-num">(12)</span></a></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProduceCircle wow fadeInDown">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage11/toys.png" alt="Guza" /></a></div>
                      <div className="cardInfo"><a className="text-17-medium" href="#">Toys<span className="sub-num">(3)</span></a></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProduceCircle wow fadeInDown">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage11/beds.png" alt="Guza" /></a></div>
                      <div className="cardInfo"><a className="text-17-medium" href="#">Beds<span className="sub-num">(4)</span></a></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProduceCircle wow fadeInDown">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage11/flea.png" alt="Guza" /></a></div>
                      <div className="cardInfo"><a className="text-17-medium" href="#">Flea & Tick<span className="sub-num">(7)</span></a></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProduceCircle wow fadeInDown">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage11/bowls.png" alt="Guza" /></a></div>
                      <div className="cardInfo"><a className="text-17-medium" href="#">Bowls<span className="sub-num">(6)</span></a></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProduceCircle wow fadeInDown">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage11/furniture.png" alt="Guza" /></a></div>
                      <div className="cardInfo"><a className="text-17-medium" href="#">Furniture<span className="sub-num">(4)</span></a></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProduceCircle wow fadeInDown">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage11/litter.png" alt="Guza" /></a></div>
                      <div className="cardInfo"><a className="text-17-medium" href="#">Litter<span className="sub-num">(6)</span></a></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProduceCircle wow fadeInDown">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage11/treats.png" alt="Guza" /></a></div>
                ...
                <div className="box-collection-type3">
                  <div className="row align-items-center"> 
                    <div className="col-lg-6">
                      <div className="image-sale-event wow fadeInLeft"> <img src="/assets/imgs/page/homepage11/collection.png" alt="Guza" /></div>
                    </div>
                    <div className="col-lg-6">
                ...
                <div className="row"> 
                  <div className="col-lg-4 col-md-4 col-sm-6"> 
                    <div className="cardProductSmall wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage11/product.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage11/product2.png" alt="guza" /></a>
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6"> 
                    <div className="cardProductSmall wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage11/product2.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage11/product.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6"> 
                    <div className="cardProductSmall wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage11/product3.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage11/product4.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6"> 
                    <div className="cardProductSmall wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage11/product4.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage11/product5.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6"> 
                    <div className="cardProductSmall wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage11/product5.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage11/product6.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6"> 
                    <div className="cardProductSmall wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage11/product6.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage11/product3.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
