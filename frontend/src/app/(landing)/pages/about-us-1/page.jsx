...
const AboutUs1 = () => (
  <>
    <Helmet>
      <title>About Us 1 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-about-us-1">
      <header className="header sticky-bar header-type1">
          ...
          <main className="main">
            <section className="section block-banner-about-1">
              <div className="container"> 
                <div className="text-center box-info-banner wow fadeInUp">
                  <h1>Believe in Craftsmanship <br className="d-none d-lg-block" />and Luxurious Design</h1>
                </div>
              </div>
            </section>
            <section className="section block-our-shop">
              <div className="container"> 
                <div className="text-center wow fadeInUp"> 
                  <p className="text-17-medium text-uppercase mb-15 primary-navy">our shop</p>
                  <h3 className="mb-15">Focusing on Quality <br className="d-none d-lg-block" />Material, Good Design</h3>
                  <div className="box-slide-customers">
                    <p className="body-p2 neutral-medium-dark">Donec non interdum nisl. Sed ut est ac lacus sodales convallis. Nam non velit justo. Mauris vel ultrices tortor. Proin bibendum magna porttitor porttitor suscipit. Praesent sit amet consequat eros. Quisque ullamcorper ornare vulputate. Nam sodales sem id diam sollicitudin, id lobortis tellus tincidunt. </p>
                  </div>
                </div>
                <div className="row mt-60 wow fadeInUp"> 
                  <div className="col-lg-6"><img src="/assets/imgs/page/about1/about1.png" alt="Indovia" /></div>
                  <div className="col-lg-6"><img src="/assets/imgs/page/about1/about2.png" alt="Indovia" /></div>
                </div>
              </div>
            </section>
            ...
            <section className="section block-testimonials">
              <div className="container"> 
                <div className="text-center wow fadeInUp">
                  <p className="text-17-medium text-uppercase mb-15 primary-navy">WHAT BUYERS SAY</p>
                  <h3 className="neutral-dark mb-40 wow fadeInLeft">Customers Reviews</h3>
                </div>
                <div className="box-slide-customers wow fadeInUp wow fadeInUp">
            ...
            <section className="section block-team">
              <div className="container"> 
                <div className="text-center wow fadeInUp"> 
                  <p className="text-17-medium text-uppercase mb-15 primary-navy">Meet the founders</p>
                  <h3 className="mb-15">We're Supply Chain</h3>
                </div>
                <div className="row mt-60 wow zoomIn"> 
                  <div className="col-lg-4">
                    <div className="cardTeam"> 
                      <div className="cardImage"><img src="/assets/imgs/page/about1/team.png" alt="Indovia" /></div>
                      <div className="cardInfo"> 
                        <h6 className="cardTitle text-17-medium">Anna Madsen</h6>
                        <p className="cardDesc text-17 neutral-medium-dark">Co-founder</p>
                        <div className="socials"><a href="#"><img src="/assets/imgs/page/about1/fb.svg" alt="Indovia" /></a><a href="#"><img src="/assets/imgs/page/about1/insta.svg" alt="Indovia" /></a></div>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-4">
                    <div className="cardTeam"> 
                      <div className="cardImage"><img src="/assets/imgs/page/about1/team2.png" alt="Indovia" /></div>
                      <div className="cardInfo"> 
                        <h6 className="cardTitle text-17-medium">Terry Kenter</h6>
                        <p className="cardDesc text-17 neutral-medium-dark">Designer</p>
                        <div className="socials"><a href="#"><img src="/assets/imgs/page/about1/fb.svg" alt="Indovia" /></a><a href="#"><img src="/assets/imgs/page/about1/insta.svg" alt="Indovia" /></a></div>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-4">
                    <div className="cardTeam"> 
                      <div className="cardImage"><img src="/assets/imgs/page/about1/team3.png" alt="Indovia" /></div>
                      <div className="cardInfo"> 
                        <h6 className="cardTitle text-17-medium">Ruben Donin</h6>
                        <p className="cardDesc text-17 neutral-medium-dark">Makerter</p>
                        <div className="socials"><a href="#"><img src="/assets/imgs/page/about1/fb.svg" alt="Indovia" /></a><a href="#"><img src="/assets/imgs/page/about1/insta.svg" alt="Indovia" /></a></div>
                      </div>
                    </div>
                  </div>
