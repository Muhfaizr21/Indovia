...
const Lookbook2 = () => (
  <>
    <Helmet>
      <title>Lookbook 2 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-lookbook-2">
      <header className="header sticky-bar header-style-2">
          ...
          <main className="main">
            <section className="section block-content-lookbook">
              <div className="list-lookbok-style-2">
                <div className="item-lookbook"> 
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook2/banner.png" alt="Indovia" /></div>
                  <div className="item-lookbook-info">
                    <h1 className="color-white">Winter.</h1>
                    <p className="text-24 color-white">Shop and discover the world’s most stylish brands.</p>
                    <div className="box-button-lookbook"> <a className="btn btn-border-white" href="#">Discover</a></div>
                  </div>
                </div>
                <div className="item-lookbook item-lookbook-left">
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook2/banner2.png" alt="Indovia" /></div>
                  <div className="item-lookbook-info">
                    <h1 className="primary-dark">Fall Love.</h1>
                    <p className="text-24 primary-dark">Shop and discover the world’s most stylish brands.</p>
                    <div className="box-button-lookbook"> <a className="btn btn-border" href="#">Discover</a></div>
                  </div>
                </div>
                <div className="item-lookbook item-lookbook-right"> 
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook2/banner3.png" alt="Indovia" /></div>
                  <div className="item-lookbook-info">
                    <h1 className="primary-dark">Winter.</h1>
                    <p className="text-24 primary-dark">Shop and discover the world’s most stylish brands.</p>
                    <div className="box-button-lookbook"> <a className="btn btn-border" href="#">Discover</a></div>
                  </div>
                </div>
                <div className="item-lookbook"> 
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook2/banner4.png" alt="Indovia" /></div>
                  <div className="item-lookbook-info">
                    <h1 className="color-white">Winter.</h1>
                    <p className="text-24 color-white">Shop and discover the world’s most stylish brands.</p>
                    <div className="box-button-lookbook"> <a className="btn btn-border-white" href="#">Discover</a></div>
