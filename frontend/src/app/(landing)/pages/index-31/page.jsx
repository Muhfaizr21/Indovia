...
const Index31 = () => (
  <>
    <Helmet>
      <title>Index 31 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-31">
      <header className="header sticky-bar header-type1">
          ...
          <main className="main">
            <section className="section block-banner-home31">
              <div className="box-banner-cover">
                <div className="container"> 
                  <div className="row align-items-center height-720">
                    <div className="col-lg-4 col-sm-5">
                      <div className="text-center"> 
                        <p className="body-p2 color-white">COLLECTION</p>
                        <h1 className="text-68 font-cormorant color-white mb-15">JULY</h1>
                        <p className="body-p2 color-white mb-30">Lost time is never found again.</p><a className="btn btn-border-white" href="#">Shop Now</a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="section block-our-category block-padding-80 pb-40">
              <div className="container"> 
                <div className="text-center"> 
                  <h2 className="font-cormorant mb-40">Our Category</h2>
                </div>
                <div className="row"> 
                  <div className="col-md-4">
                    <div className="card-our-category"> 
                      <div className="card-image"> <img src="/assets/imgs/page/homepage31/cat.png" alt="Indovia" /></div>
                      <div className="card-info"> <a className="link-underline" href="#">Classic</a></div>
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="card-our-category"> 
                      <div className="card-image"> <img src="/assets/imgs/page/homepage31/cat2.png" alt="Indovia" /></div>
                      <div className="card-info"> <a className="link-underline" href="#">Modern</a></div>
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="card-our-category"> 
                      <div className="card-image"> <img src="/assets/imgs/page/homepage31/cat3.png" alt="Indovia" /></div>
                      <div className="card-info"> <a className="link-underline" href="#">Electric</a></div>
                    </div>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-july-watch block-padding-40"> 
              <div className="container"> 
                <div className="text-center">
                  <h2 className="font-cormorant mb-30">July Watches</h2>
                </div>
                <div className="box-tabs-july"> 
                  <ul className="nav nav-tabs nav-tabs-style-2 nav-tabs-style-5" role="tablist">
                    <li className="nav-item" role="presentation">
                      <button className="nav-link active" id="men-tab" data-bs-toggle="tab" data-bs-target="#men" type="button" role="tab" aria-controls="men" aria-selected="true" data-index="1" data-items="5">Men</button>
                    </li>
                    <li className="nav-item" role="presentation">
                      <button className="nav-link" id="women-tab" data-bs-toggle="tab" data-bs-target="#women" type="button" role="tab" aria-controls="women" aria-selected="false" data-index="2" data-items="5">Women</button>
                    </li>
                    <li className="nav-item" role="presentation">
                      <button className="nav-link" id="unisex-tab" data-bs-toggle="tab" data-bs-target="#unisex" type="button" role="tab" aria-controls="unisex" aria-selected="false" data-index="3" data-items="5">Unisex</button>
                    </li>
                  </ul>
                </div>
              </div>
              <div className="tab-content">
                <div className="tab-pane fade show active" id="men" role="tabpanel" aria-labelledby="men-tab">
                  <div className="container-slider-padding-1">
                        ...
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage31/watch-sp.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage31/watch-sp.png" alt="Indovia" /></a>
                              ...
                              <div className="cardInfo">
                                <h6 className="text-17-medium mb-10">Chronograph 38 mm</h6>
                                <p className="body-p2 cardDesc">$4321.00</p>
                              </div>
                            </div>
                          </div>
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage31/watch-sp2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage31/watch-sp2.png" alt="Indovia" /></a>
                                <div className="button-select"><a href="#">Select Options</a></div>
                                <div className="box-quick-button"><a className="btn" href="#">
                                    <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                      <g clipPath="url(#clip0_116_452)">
                              ...
                              <div className="cardInfo">
                                <h6 className="text-17-medium mb-10">Co-axial Chronometer </h6>
                                <p className="body-p2 cardDesc">$5000.00</p>
                              </div>
                            </div>
                          </div>
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage31/watch-sp3.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage31/watch-sp3.png" alt="Indovia" /></a>
                                <div className="button-select"><a href="#">Select Options</a></div>
                                <div className="box-quick-button"><a className="btn" href="#">
                                    <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                      <g clipPath="url(#clip0_116_452)">
                              ...
                              <div className="cardInfo">
                                <h6 className="text-17-medium mb-10">Co-axial international</h6>
                                <p className="body-p2 cardDesc"><span className="sale-price">$8200.00</span><span className="main-price">$9000.00</span></p>
                              </div>
                            </div>
                          </div>
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage31/watch-sp4.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage31/watch-sp4.png" alt="Indovia" /></a>
                                <div className="button-select"><a href="#">Select Options</a></div>
                                <div className="box-quick-button"><a className="btn" href="#">
                                    <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                      <g clipPath="url(#clip0_116_452)">
                              ...
                              <div className="cardInfo">
                                <h6 className="text-17-medium mb-10">Master Co-axial</h6>
                ...
                <div className="tab-pane fade" id="women" role="tabpanel" aria-labelledby="women-tab"> 
                  <div className="container-slider-padding-2">
                    <div className="box-swiper button-slide-square button-slide-square-2">   
                ...
                <div className="tab-pane fade" id="unisex" role="tabpanel" aria-labelledby="unisex-tab"> 
                  <div className="container-slider-padding-3"> 
                    <div className="box-swiper button-slide-square button-slide-square-2">   
            ...
            <section className="section block-our-collection block-padding-40"> 
              <div className="container"> 
                <div className="row align-items-center"> 
                  <div className="col-lg-4 mb-30">
                    <div className="text-center">
                      <p className="body-p2 neutral-medium-dark">COLLECTION</p>
                      <h2 className="mb-15 font-cormorant">Elegant</h2>
                      <p className="text-17-medium mb-30">Elevate every moment.</p><a className="btn btn-border" href="#">Shop Now</a>
                    </div>
                  </div>
                  <div className="col-lg-4 col-sm-6 mb-30"><img className="w-100" src="/assets/imgs/page/homepage31/watch1.png" alt="Indovia" /></div>
                  <div className="col-lg-4 col-sm-6 mb-30"><img className="w-100" src="/assets/imgs/page/homepage31/watch2.png" alt="Indovia" /></div>
                </div>
              </div>
            </section>
            <section className="section block-our-story block-padding-40"> 
              <div className="container"> 
                <div className="row align-items-center"> 
                  <div className="col-lg-6 mb-30">
                    <div className="row image-story"> 
                      <div className="col-lg-12"><img className="w-100" src="/assets/imgs/page/homepage31/story.png" alt="Indovia" /></div>
                      <div className="col-lg-6 col-sm-6"><img className="w-100" src="/assets/imgs/page/homepage31/story2.png" alt="Indovia" /></div>
                      <div className="col-lg-6 col-sm-6"><img className="w-100" src="/assets/imgs/page/homepage31/story3.png" alt="Indovia" /></div>
                    </div>
                  </div>
                  <div className="col-lg-6 mb-30">
                    <div className="text-center mw-410">
                      <h2 className="mb-15 font-cormorant">The Beginning</h2>
                      <p className="mb-30 body-p2">All great achievements require time. We initially asked the question, what if a watch were not limited to the cost of making it, what would it be like. For July we aim for perfection.</p><a className="btn btn-border" href="#">Learn More</a>
                    </div>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-brands block-padding-40">
              <div className="container"> 
                <div className="brand-list"> 
                  <div className="brand-item"> <img src="/assets/imgs/page/homepage31/rolex.png" alt="Indovia" /></div>
                  <div className="brand-item"> <img src="/assets/imgs/page/homepage31/chopard.png" alt="Indovia" /></div>
                  <div className="brand-item"> <img src="/assets/imgs/page/homepage31/omega.png" alt="Indovia" /></div>
                  <div className="brand-item"> <img src="/assets/imgs/page/homepage31/patex.png" alt="Indovia" /></div>
                  <div className="brand-item"> <img src="/assets/imgs/page/homepage31/hublot.png" alt="Indovia" /></div>
                </div>
              </div>
            </section>
            <section className="section block-instagram-type-3 block-instagram-type-3-grey block-padding-40">
              <div className="container"> 
                <div className="text-center">
              ...
              <div className="box-gallery-instagram mt-65 wow fadeInDown"> 
                <div className="gallery-item"><img src="/assets/imgs/page/homepage31/insta.png" alt="Indovia" /></div>
                <div className="gallery-item"><img src="/assets/imgs/page/homepage31/insta2.png" alt="Indovia" /></div>
                <div className="gallery-item"><img src="/assets/imgs/page/homepage31/insta3.png" alt="Indovia" /></div>
                <div className="gallery-item"><img src="/assets/imgs/page/homepage31/insta4.png" alt="Indovia" /></div>
                <div className="gallery-item"><img src="/assets/imgs/page/homepage31/insta5.png" alt="Indovia" /></div>
              </div>
            </section>
