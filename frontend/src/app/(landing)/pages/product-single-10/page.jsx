...
const ProductSingle10 = () => (
  <>
    <Helmet>
      <title>Product Single 10 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-product-single-10">
      <header className="header sticky-bar header-type1 header-type1-1">
          ...
          <main className="main">
            <section className="section block-product-single block-product-single-10">
              <div className="container-product-10">
                <div className="row">
                  <div className="col-lg-6">
                    <div className="detail-gallery detail-gallery-2">
                      <div className="box-main-gallery">
                        <div className="product-image-slider product-image-slider-5">
                          <figure className="border-radius-10"><a className="zoom-image glightbox" href="/assets/imgs/page/product/img.png"></a><a className="glightbox" href="/assets/imgs/page/product/img.png"><img src="/assets/imgs/page/product/img.png" alt="kidify" /></a></figure>
                          <figure className="border-radius-10"><a className="zoom-image glightbox" href="/assets/imgs/page/product/img.png"></a><a className="glightbox" href="/assets/imgs/page/product/img.png"><img src="/assets/imgs/page/product/img.png" alt="kidify" /></a></figure>
                          <figure className="border-radius-10"><a className="zoom-image glightbox" href="/assets/imgs/page/product/img.png"></a><a className="glightbox" href="/assets/imgs/page/product/img.png"><img src="/assets/imgs/page/product/img.png" alt="kidify" /></a></figure>
                          <figure className="border-radius-10"><a className="zoom-image glightbox" href="/assets/imgs/page/product/img.png"></a><a className="glightbox" href="/assets/imgs/page/product/img.png"><img src="/assets/imgs/page/product/img.png" alt="kidify" /></a></figure>
                          <figure className="border-radius-10"><a className="zoom-image glightbox" href="/assets/imgs/page/product/img.png"></a><a className="glightbox" href="/assets/imgs/page/product/img.png"><img src="/assets/imgs/page/product/img.png" alt="kidify" /></a></figure>
                      ...
                      <div className="slider-nav-thumbnails slider-nav-thumbnails-5">
                        <div>
                  ...
                  <div className="col-lg-4">
                    <div className="box-product-info">
                      ...
                      <div className="block-according">
                        <div className="accordion wow fadeInUp mb-60" id="accordionFAQ">
                          <div className="accordion-item">
                            <h6 className="accordion-header" id="headingOne">
                              <button className="accordion-button text-heading-5" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Desciption</button>
                            </h6>
                            <div className="accordion-collapse collapse show" id="collapseOne" aria-labelledby="headingOne" data-bs-parent="#accordionFAQ">
                              <div className="accordion-body">The shorts are made from soft organic cotton. They have an elasticated waistband with an internal drawstring and side pockets. They’re the same fit as our classic 365 organic cotton shorts and feature a multicolored embroidered logo on the hem.</div>
                            </div>
                          </div>
                          <div className="accordion-item">
                            <h5 className="accordion-header" id="headingTwo">
                              <button className="accordion-button text-heading-5 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Size Chart</button>
                            </h5>
                          ...
                          <div className="accordion-item">
                            <h5 className="accordion-header" id="headingThree">
                              <button className="accordion-button text-heading-5 collapsed text-heading-5 type=" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Review (3)</button>
                            </h5>
...
export default ProductSingle10;
