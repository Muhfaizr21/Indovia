...
const BlogList = () => (
  <>
    <Helmet>
      <title>Blog List | Larkon Store</title>
    </Helmet>
                ...
                <div className="row">
                  <div className="col-lg-9">
                    <div className="cardBlog cardBlogList wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/blog-list/img1.png" alt="guza" /></a></div>
                    ...
                    <div className="cardBlog cardBlogList wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/blog-list/img2.png" alt="guza" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post text-uppercase">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet</p><a className="link-underline link-l2" href="#">Read More</a>
                    ...
                    <div className="cardBlog cardBlogList wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/blog-list/img3.png" alt="guza" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post text-uppercase">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet</p><a className="link-underline link-l2" href="#">Read More</a>
                    ...
                    <div className="cardBlog cardBlogList wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/blog-list/img4.png" alt="guza" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post text-uppercase">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet</p><a className="link-underline link-l2" href="#">Read More</a>
                    ...
                    <div className="cardBlog cardBlogList wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/blog-list/img5.png" alt="guza" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post text-uppercase">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet</p><a className="link-underline link-l2" href="#">Read More</a>
                    ...
                    <div className="cardBlog cardBlogList wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/blog-list/img6.png" alt="guza" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post text-uppercase">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet</p><a className="link-underline link-l2" href="#">Read More</a>
