...
const ShopCustomBanner = () => (
  <>
    <Helmet>
      <title>Shop Custom Banner | Indovia Store</title>
    </Helmet>
    <div className="landing-page-shop-custom-banner">
                  ...
                  <div className="col-lg-9">
                    <div className="banner-shop">
                      <div className="box-text-banner">
                        <h3 className="text-34-semibold mb-10">FLAT<span className="tone-red">30%</span>OFF</h3>
                        <p className="text-20 mb-25">On Fashion Footwear</p><a className="btn btn-border" href="#">View Collection</a>
                      </div>
                    </div>
...
export default ShopCustomBanner;
