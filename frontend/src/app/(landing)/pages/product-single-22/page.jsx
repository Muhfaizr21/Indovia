...
const ProductSingle22 = () => (
  <>
    <Helmet>
      <title>Product Single 22 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-product-single-22">
      <header className="header sticky-bar header-type1">
          ...
          <main className="main">
            ...
            <section className="section block-product-single block-product-single-12">
              <div className="container">
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    <div className="box-product-info">
                      <div className="product-title">
                        <h3 className="mb-5">Summer Stripes Shorts</h3><a className="btn" href="#">
                          <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                            <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="block-grouped">
                        <div className="list-grouped">
                          <div className="item-grouped">
                            <div className="item-grouped-image"><a href="#"><img src="/assets/imgs/page/product/thumnb.png" alt="Indovia" /></a></div>
                            <div className="item-grouped-info"><a className="text-16-medium neutral-dark" href="#">Lace Shirt Cut II</a>
                              <p className="text-16 neutral-medium-dark">12 in stock</p>
                            </div>
                            <div className="item-grouped-quanlity">
                            ...
                            <div className="item-grouped-price">
                              <p className="text-16 neutral-medium-dark">$15.00</p>
                            </div>
                          </div>
                          <div className="item-grouped">
                            <div className="item-grouped-image"><a href="#"><img src="/assets/imgs/page/product/thumnb2.png" alt="Indovia" /></a></div>
                            <div className="item-grouped-info"><a className="text-16-medium neutral-dark" href="#">Lace Shirt Cut II</a>
                              <p className="text-16 neutral-medium-dark">12 in stock</p>
                            </div>
                            <div className="item-grouped-quanlity">
                      ...
                      <div className="block-button-cart"><a className="btn btn-black" href="#">Add to Cart</a><a className="text-17-medium link-underline" href="#">Size Guide</a></div>
                      ...
                      <div className="block-share"><a className="campage body-p2 mr-30" href="#">Campage</a><a className="link-share body-p2" href="#">Share</a></div>
...
export default ProductSingle22;
