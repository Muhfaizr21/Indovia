...
const Index12 = () => (
  <>
    <Helmet>
      <title>Index 12 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-12">
      <header className="header sticky-bar header-type1">
          ...
          <main className="main">
            <section className="section banner-homepage2 banner-homepage12">
              <div className="box-swiper"> 
                <div className="swiper-container swiper-banner pb-0">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <div className="box-cover-image" style={{backgroundImage: "url(/assets/imgs/page/homepage12/banner.png)"}}></div>
                      <div className="box-banner-info"> 
                        <div className="row align-items-center"> 
                          <div className="col-md-6 mb-30">
                            <h1 className="text-56-medium color-primary-dark mb-10">BELIEVE IN  <br className="d-none d-lg-block" />FRUITS + <br className="d-none d-lg-block" />VEGGIES</h1>
                            <h5 className="mb-30">Elevated, organic cotton basics.<br className="d-none d-lg-block" />Impeccable fit. Compromise-free. </h5>
            ...
            <section className="section block-why-best"> 
              <div className="container"> 
                <div className="text-center"> 
                  <h3 className="mb-40">We believe in a world well fed, <br className="d-none d-lg-block" />one where food is:</h3>
                </div>
                <div className="row"> 
                  <div className="col-lg-4 mb-30"> 
                    <div className="cardBorderImageLeft"> 
                      <div className="cardImage"> <img src="/assets/imgs/page/homepage12/certified.svg" alt="Indovia" /></div>
                      <div className="cardInfo"> 
                        <h5>Best Quality</h5>
                        <p className="text-17 neutral-medium-dark">Etiam eu turpis tincidunt, vehicula mi ut</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-4 mb-30"> 
                    <div className="cardBorderImageLeft"> 
                      <div className="cardImage"> <img src="/assets/imgs/page/homepage12/ship.svg" alt="Indovia" /></div>
                      <div className="cardInfo"> 
                        <h5>Free Shipping</h5>
                        <p className="text-17 neutral-medium-dark">Etiam eu turpis tincidunt, vehicula mi ut</p>
                      </div>
                  ...
                  <div className="col-lg-4 mb-30"> 
                    <div className="cardBorderImageLeft"> 
                      <div className="cardImage"> <img src="/assets/imgs/page/homepage12/vegetables.svg" alt="Indovia" /></div>
                      <div className="cardInfo"> 
                        <h5>Warranty</h5>
                        <p className="text-17 neutral-medium-dark">Etiam eu turpis tincidunt, vehicula mi ut</p>
                      </div>
            ...
            <section className="section block-new-product-homepage12">
              <div className="container"> 
                <div className="text-center"> 
                  <h3 className="mb-30 wow fadeInUp">Actually healthy. <br className="d-none d-lg-block" />Undeniably delicious.</h3>
                  <div className="box-tabs mt-0 mb-0 text-center wow fadeInDown"> 
                    <ul className="nav nav-tabs nav-tabs-small" role="tablist">
                      <li className="nav-item" role="presentation">
                        <button className="nav-link active" id="smoothies-tab" data-bs-toggle="tab" data-bs-target="#smoothies" type="button" role="tab" aria-controls="smoothies" aria-selected="true" data-index="1" data-items="3">Smoothies</button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="harvestbowls-tab" data-bs-toggle="tab" data-bs-target="#harvestbowls" type="button" role="tab" aria-controls="harvestbowls" aria-selected="false" data-index="2" data-items="3">Harvest Bowls</button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="harvest-tab" data-bs-toggle="tab" data-bs-target="#harvest" type="button" role="tab" aria-controls="harvest" aria-selected="false" data-index="3" data-items="3">Harvest Bakes</button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="flatbreads-tab" data-bs-toggle="tab" data-bs-target="#flatbreads" type="button" role="tab" aria-controls="flatbreads" aria-selected="false" data-index="4" data-items="3">Flatbreads</button>
                      </li>
                    </ul>
                  </div>
                </div>
                <div className="mt-40 box-button-leftright"> 
                  <div className="tab-content">
                    <div className="tab-pane fade show active" id="smoothies" role="tabpanel" aria-labelledby="smoothies-tab">
                      <div className="box-swiper">                            
                        <div className="swiper-container swiper-tab-1 pb-0">
                          <div className="swiper-wrapper">
                            <div className="swiper-slide">
                              <div className="cardProductStyle3 wow fadeInUp">
                                <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage12/product.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage12/product2.png" alt="Indovia" /></a>
                            ...
                            <div className="swiper-slide">
                              <div className="cardProductStyle3 wow fadeInUp">
                                <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage12/product2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage12/product3.png" alt="Indovia" /></a>
                                  <div className="button-select"><a href="#">Select Options</a></div>
                                  <div className="box-quick-button"><a className="btn" href="#">
                                      <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_116_452)">
                            ...
                            <div className="swiper-slide">
                              <div className="cardProductStyle3 wow fadeInUp">
                                <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage12/product3.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage12/product.png" alt="Indovia" /></a>
                                  <div className="button-select"><a href="#">Select Options</a></div>
                                  <div className="box-quick-button"><a className="btn" href="#">
                                      <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_116_452)">
                        ...
                        <div className="swiper-button-prev swiper-button-prev-tab-1 btn-prev-style-1"></div>
                        <div className="swiper-button-next swiper-button-next-tab-1 btn-next-style-1"></div>
                      </div>
                    </div>
                    <div className="tab-pane fade" id="harvestbowls" role="tabpanel" aria-labelledby="harvestbowls-tab"> 
                      <div className="box-swiper"> 
                        <div className="swiper-container swiper-tab-2 pb-0">
                          <div className="swiper-wrapper">
                            <div className="swiper-slide">
                              <div className="cardProductStyle3 wow fadeInUp">
                                <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage12/product.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage12/product2.png" alt="Indovia" /></a>
                        ...
                        <div className="swiper-button-prev swiper-button-prev-tab-2 btn-prev-style-1"></div>
                        <div className="swiper-button-next swiper-button-next-tab-2 btn-next-style-1"></div>
                      </div>
                    </div>
                    <div className="tab-pane fade" id="harvest" role="tabpanel" aria-labelledby="harvest-tab"> 
                      <div className="box-swiper"> 
                        <div className="swiper-container swiper-tab-3 pb-0">
                          <div className="swiper-wrapper">
                            <div className="swiper-slide">
                              <div className="cardProductStyle3 wow fadeInUp">
                                <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage12/product.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage12/product2.png" alt="Indovia" /></a>
                        ...
                        <div className="swiper-button-prev swiper-button-prev-tab-3 btn-prev-style-1"></div>
                        <div className="swiper-button-next swiper-button-next-tab-3 btn-next-style-1"></div>
                      </div>
                    </div>
                    <div className="tab-pane fade" id="flatbreads" role="tabpanel" aria-labelledby="flatbreads-tab"> 
                      <div className="box-swiper"> 
                        <div className="swiper-container swiper-tab-4 pb-0">
                          <div className="swiper-wrapper">
                            <div className="swiper-slide">
                              <div className="cardProductStyle3 wow fadeInUp">
                                <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage12/product.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage12/product2.png" alt="Indovia" /></a>
                        ...
                        <div className="swiper-button-prev swiper-button-prev-tab-4 btn-prev-style-1"></div>
                        <div className="swiper-button-next swiper-button-next-tab-4 btn-next-style-1"></div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="section block-about-homepage12">
              <div className="container"> 
                <div className="row align-items-center"> 
                  <div className="col-lg-7">
                    <div className="box-about-image-homepage12"> <img src="/assets/imgs/page/homepage12/about.jpg" alt="Indovia" /></div>
                  </div>
                  <div className="col-lg-5">
                    <div className="box-about-homepage12"> 
                      <h3 className="mb-25">7am to 7pm. We got you.</h3>
                      <p className="body-p2 mb-35">Start your day with a dose of delicious goodness — nutrient-packed options built on organic fruits + veggies.</p><a className="btn btn-border-medium" href="#">Choose Your Plan</a>
                    </div>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-review">
              <div className="container"> 
                <div className="text-center"> 
                  <h3 className="mb-40">Our Customers Feed Back</h3>
                </div>
                <div className="box-swiper box-page-style2 pb-90"> 
                  <div className="swiper-container swiper-3-items pb-0">
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <div className="cardReview"> 
                          <div className="cardRate"> <img src="/assets/imgs/template/icons/star.svg" alt="Indovia" /><img src="/assets/imgs/template/icons/star.svg" alt="Indovia" /><img src="/assets/imgs/template/icons/star.svg" alt="Indovia" /><img src="/assets/imgs/template/icons/star.svg" alt="Indovia" /><img src="/assets/imgs/template/icons/star.svg" alt="Indovia" /></div>
                          <div className="cardText"> 
                            <h5>I like the way the staff advises me. Thank you for the very good quality of the case. I will come back and buy more stuff.</h5>
                          </div>
            ...
            <section className="section block-instagram-type-5"> 
              <div className="container"> 
                ...
                <div className="box-gallery-instagram-type-5 wow fadeInRight"> 
                  <div className="gallery-1"><img src="/assets/imgs/page/homepage12/inst-img.png" alt="Indovia" /></div>
                  <div className="gallery-2"> <img src="/assets/imgs/page/homepage12/inst-img2.png" alt="Indovia" /><img src="/assets/imgs/page/homepage12/inst-img3.png" alt="Indovia" /><img src="/assets/imgs/page/homepage12/inst-img4.png" alt="Indovia" /><img src="/assets/imgs/page/homepage12/inst-img5.png" alt="Indovia" /><img src="/assets/imgs/page/homepage12/inst-img6.png" alt="Indovia" /><img src="/assets/imgs/page/homepage12/inst-img7.png" alt="Indovia" /></div>
                </div>
              </div>
            </section>
          </main>
