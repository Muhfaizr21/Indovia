...
const Index23 = () => (
  <>
    <Helmet>
      <title>Index 23 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-23">
      <header className="header sticky-bar header-style-3">
          ...
          <main className="main">
            ...
            <section className="section banner-homepage22 banner-homepage23">
              <div className="box-swiper"> 
                <div className="swiper-container swiper-banner pb-0">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <div className="box-cover-image wow fadeInUp" style={{backgroundImage: "url(/assets/imgs/page/homepage23/banner.png)"}}></div>
                      <div className="box-banner-info wow fadeInLeft"> 
                        <div className="box-banner-info-inner">
                          <h2 className="color-white mb-10">New Backpack</h2>
                          <p className="body-p2 mb-30 color-white">For Urban Outdoors</p>
                          <div className="text-center"> <a className="btn btn-white" href="#">Shop all</a></div>
                        </div>
                      </div>
                    </div>
                    <div className="swiper-slide">
            ...
            <section className="section block-best-seller-home23"> 
              <div className="container"> 
                <div className="text-start">
                  <div className="box-tabs wow fadeInRight"> 
                    <ul className="nav nav-tabs nav-tabs-style-2 nav-tabs-style-4 nav-tabs-upper" role="tablist">
                      <li className="nav-item" role="presentation">
                        <button className="nav-link active" id="bestsellers-tab" data-bs-toggle="tab" data-bs-target="#bestsellers" type="button" role="tab" aria-controls="bestsellers" aria-selected="true" data-index="1" data-items="5">Best Sellers</button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="newproducts-tab" data-bs-toggle="tab" data-bs-target="#newproducts" type="button" role="tab" aria-controls="newproducts" aria-selected="false" data-index="2" data-items="5">New in</button>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="tab-content">
                <div className="tab-pane swiper-full-scroll fade show active" id="bestsellers" role="tabpanel" aria-labelledby="bestsellers-tab">
                  <div className="container-slider-padding">   
                    <div className="box-swiper">                            
                      <div className="swiper-container swiper-tab-scrollbar-1">
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage23/sp.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage23/sp.png" alt="Indovia" /></a>
                              ...
                              <div className="cardInfo">
                                <h6 className="text-17-medium mb-10">Shell All Black</h6>
                                <p className="body-p2 cardDesc"><span className="price-line">$100.00</span><span className="price-main">$100.00</span></p>
                              </div>
                            </div>
                          </div>
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage23/sp2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage23/sp.png" alt="Indovia" /></a>
                                <div className="button-select"><a href="#">Select Options</a></div>
                                <div className="box-quick-button"><a className="btn" href="#">
                                    <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                      <g clipPath="url(#clip0_116_452)">
                              ...
                              <div className="cardInfo">
                                <h6 className="text-17-medium mb-10">Jungle Night Blue</h6>
                                <p className="body-p2 cardDesc"><span className="price-line">$100.00</span><span className="price-main">$100.00</span></p>
                              </div>
                            </div>
                          </div>
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage23/sp3.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage23/sp.png" alt="Indovia" /></a>
                                <div className="button-select"><a href="#">Select Options</a></div>
                                <div className="box-quick-button"><a className="btn" href="#">
                                    <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                      <g clipPath="url(#clip0_116_452)">
                              ...
                              <div className="cardInfo">
                                <h6 className="text-17-medium mb-10">Hive Walnut Sand</h6>
                                <p className="body-p2 cardDesc"><span className="price-line">$100.00</span><span className="price-main">$100.00</span></p>
                              </div>
                            </div>
                          </div>
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage23/sp4.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage23/sp.png" alt="Indovia" /></a>
                                <div className="button-select"><a href="#">Select Options</a></div>
                                <div className="box-quick-button"><a className="btn" href="#">
                                    <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                      <g clipPath="url(#clip0_116_452)">
                              ...
                              <div className="cardInfo">
                                <h6 className="text-17-medium mb-10">Monsoon Core Black</h6>
                                <p className="body-p2 cardDesc"><span className="price-line">$100.00</span><span className="price-main">$100.00</span></p>
                              </div>
                            </div>
                          </div>
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage23/sp5.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage23/sp.png" alt="Indovia" /></a>
                                <div className="button-select"><a href="#">Select Options</a></div>
                                <div className="box-quick-button"><a className="btn" href="#">
                                    <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                      <g clipPath="url(#clip0_116_452)">
                              ...
                              <div className="cardInfo">
                                <h6 className="text-17-medium mb-10">Sunset Hedge Green</h6>
                                <p className="body-p2 cardDesc"><span className="price-line">$100.00</span><span className="price-main">$100.00</span></p>
                              </div>
                            </div>
                          </div>
                  ...
                  <div className="box-pagination-button">
                    <div className="swiper-pagination swiper-pagination-popular-product swiper-pagination-scrollbar-1"></div>
                  </div>
                </div>
                <div className="tab-pane swiper-full-scroll fade" id="newproducts" role="tabpanel" aria-labelledby="newproducts-tab"> 
                  <div className="container-slider-padding">  
                    <div className="box-swiper">
                      <div className="swiper-container swiper-tab-scrollbar-2">
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage23/sp.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage23/sp.png" alt="Indovia" /></a>
                  ...
                  <div className="box-pagination-button">
                    <div className="swiper-pagination swiper-pagination-popular-product swiper-pagination-scrollbar-2"></div>
                  </div>
                </div>
              </div>
            </section>
            <section className="section box-banner-2-home23">
              <div className="container"> 
                <div className="row"> 
                  <div className="col-lg-6">
                    <div className="card-banner-summer"> 
                      <div className="card-info"> 
                        <p className="body-p2 mb-5">Summer discount</p>
                        <h2 className="mb-15">UP TO 50%</h2><a className="btn btn-black" href="#">Shop now</a>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="card-banner-mega">
                      <div className="card-info"> 
                        <p className="body-p2 mb-5">Mega sale on July</p>
                        <h2 className="mb-15">UP TO 40%</h2><a className="btn btn-black" href="#">Shop now</a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="section box-product-list-home23">
              <div className="container"> 
                <div className="box-title-between">
                  <div className="box-title-main"> 
                    <h3 className="wow fadeInLeft font-bebas text-uppercase">Backpacks</h3>
                  </div>
                  <div className="box-link wow fadeInRight"><a className="text-17" href="#">View all</a></div>
                </div>
              </div>
              <div className="container-slider-padding">   
                <div className="box-swiper swiper-full-scroll">                            
                  <div className="swiper-container swiper-scrollbar-5-items">
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage23/sp.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage23/sp.png" alt="Indovia" /></a>
              ...
              <div className="box-pagination-button">
                <div className="swiper-pagination swiper-pagination-popular-product swiper-pagination-scrollbar-product"></div>
              </div>
            </section>
            <section className="section box-banner-video-home23">
              <div className="container"> 
                <div className="box-banner-video-bg box-banner-video-bg-2"> 
                  <div className="box-banner-video-info"> 
                    <h1 className="heading-h1 text-uppercase">In a Good way.</h1>
                    <p className="body-p2">Let's create interesting experiences for you</p><a className="btn btn-black" href="#">Shop Now</a>
                  </div>
                </div>
              </div>
            </section>
            <section className="section box-product-list-home23">
              <div className="container"> 
                <div className="box-title-between">
                  <div className="box-title-main"> 
                    <h3 className="wow fadeInLeft font-bebas text-uppercase">Sneakers</h3>
                  </div>
                  <div className="box-link wow fadeInRight"><a className="text-17" href="#">View all</a></div>
                </div>
              </div>
              <div className="container-slider-padding">   
                <div className="box-swiper swiper-full-scroll">                            
                  <div className="swiper-container swiper-scrollbar-5-items-2">
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage23/sp.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage23/sp.png" alt="Indovia" /></a>
              ...
              <div className="box-pagination-button">
                <div className="swiper-pagination swiper-pagination-popular-product swiper-pagination-scrollbar-product-2"></div>
              </div>
            </section>
            <section className="section box-banner-video-home23">
              <div className="container"> 
                <div className="box-banner-video-bg"> 
                  <div className="box-banner-video-info"> 
                    <h1 className="heading-h1 text-uppercase">play. let loose. repeat.</h1>
                    <p className="body-p2">Turn it up in styles made for living life to the max</p><a className="btn btn-white" href="#">Shop Now</a>
                  </div>
                </div>
              </div>
            </section>
            <section className="section box-blogs box-blogs-style-2">
              <div className="container">
                <div className="text-start">
                  <h3 className="mb-40 wow fadeInLeft text-uppercase">Latest News</h3>
                </div>
                <div className="row">
                  <div className="col-md-4">
                    <div className="cardBlog wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage23/news.png" alt="Indovia" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet from anywhere between 1991 and 2005...</p><a className="link-underline link-l2" href="#">Read More</a>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="cardBlog wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage23/news2.png" alt="Indovia" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet from anywhere between 1991 and 2005...</p><a className="link-underline link-l2" href="#">Read More</a>
                  ...
                  <div className="col-md-4">
                    <div className="cardBlog wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage23/news3.png" alt="Indovia" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet from anywhere between 1991 and 2005...</p><a className="link-underline link-l2" href="#">Read More</a>
            ...
            <section className="section block-instagram-type4-home7">
              <div className="container"> 
                <div className="text-center">
                  <h6 className="text-18-medium instagram-title wow fadeInLeft">Instagram with #July</h6>
                </div>
              </div>
              <div className="box-gallery-instagram"> 
                <div className="gallery-item wow fadeInLeft"><img src="/assets/imgs/page/homepage23/insta.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage23/insta2.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage23/insta3.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage23/insta4.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInRight"><img src="/assets/imgs/page/homepage23/insta5.png" alt="Indovia" /></div>
              </div>
            </section>
            <section className="section subsciber-type-1-bg">
              <div className="container"> 
          ...
          <footer className="footer footer-type2-light footer-white">
            <div className="footer-1">
              <div className="container">
                <div className="row">
                  <div className="col-lg-6 col-md-12 text-center text-lg-start"><a className="logo-footer" href="#"><img alt="Indovia" src="/assets/imgs/template/logo.svg" /></a>
            ...
            <div className="footer-2">
              <div className="container">
                <div className="footer-bottom">
                  <div className="row align-items-center">
                    <div className="col-lg-6 col-md-12 text-center text-lg-start mb-20"><span className="body-p1 neutral-medium-dark">© 2023 Indovia.Co. All rights reserved</span></div>
                    <div className="col-lg-6 col-md-12 text-center text-lg-end mb-20">
