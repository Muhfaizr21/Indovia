...
const AboutUs2 = () => (
  <>
    <Helmet>
      <title>About Us 2 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-about-us-2">
      <header className="header sticky-bar">
          ...
          <main className="main">
            <section className="section banner-about-us2">
              <div className="box-cover-image wow fadeInUp" style={{backgroundImage: "url(/assets/imgs/page/about1/banner-2.png)"}}></div>
              <div className="box-banner-info wow fadeInUp"> 
                <p className="overline-t2-medium primary-navy mb-10">ABOUT</p>
                <h1 className="color-primary-dark mb-30">Believe in  <br className="d-block" />Craftsmanship <br className="d-block" />and Luxurious Design.</h1>
              </div>
            </section>
            <section className="section block-our-shop-2">
              <div className="container"> 
                <div className="row align-items-center"> 
                  <div className="col-lg-6 mb-80">
                    <div className="box-image-about-2-top wow fadeInUp"> <img src="/assets/imgs/page/about1/about3.png" alt="Indovia" /></div>
                  </div>
                  <div className="col-lg-6 mb-80 wow fadeInUp"> 
                    <p className="text-17-medium text-uppercase mb-10 primary-navy">our shop</p>
                    <h3 className="mb-15">We believe in Empathy and Honesty</h3>
                    <p className="body-p2 neutral-medium-dark mb-25">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed et ante suscipit tellus ultrices facilisis. Vestibulum dapibus at risus ac porttitor. Integer ultricies dui in eros pharetra facilisis. </p>
                    <p className="text-17-medium mb-5">Location</p>
                    <p className="text-16 neutral-medium-dark mb-25">Provider Store, 381b Riley St, Surry Hills, Australia NSW 2010</p>
                    <p className="text-17-medium mb-5">Opening hours</p>
                    <p className="text-16 neutral-medium-dark mb-25">Mon: Closed, Tue-Sat: 12PM-6PM, Sun: Closed</p>
                  </div>
                </div>
                <div className="row align-items-center">
                  <div className="col-lg-6 mb-80">
                    <div className="box-image-about-2-bottom wow fadeInUp"> <img src="/assets/imgs/page/about1/about4.png" alt="Indovia" /></div>
                  </div>
                  <div className="col-lg-6 mb-80 wow fadeInUp"> 
                    <p className="text-17-medium text-uppercase mb-15 primary-navy">Meet the founder</p>
                    <h3 className="mb-15">Jakob Curtis</h3>
                    ...
                    <div className="socials mt-55 justify-content-start"><a href="#"><img src="/assets/imgs/page/about1/fb.svg" alt="Indovia" /></a><a href="#"><img src="/assets/imgs/page/about1/insta.svg" alt="Indovia" /></a></div>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-icon-box block-icon-box-grey"> 
              <div className="container"> 
            ...
            <section className="section block-testimonials block-testimonials-2">
              <div className="container"> 
                <div className="text-center wow fadeInUp"> 
