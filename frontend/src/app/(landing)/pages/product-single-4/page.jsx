...
const ProductSingle4 = () => (
  <>
    <Helmet>
      <title>Product Single 4 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-product-single-4">
