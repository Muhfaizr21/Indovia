...
const ShopInfinityScrolling = () => (
  <>
    <Helmet>
      <title>Shop Infinity Scrolling | Indovia Store</title>
    </Helmet>
    <div className="landing-page-shop-infinity-scrolling">
              ...
              <div className="container">
                <div className="row">
                  ...
                  <div className="col-lg-9">
                    ...
                    <div className="text-center mt-50"><a className="btn btn-border" href="#">
...
export default ShopInfinityScrolling;
