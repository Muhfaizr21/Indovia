...
const Index15 = () => (
  <>
    <Helmet>
      <title>Index 15 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-15">
      <header className="header sticky-bar header-type1">
          ...
          <main className="main">
            <section className="section banner-homepage2 banner-homepage15">
              <div className="box-swiper">
                <div className="swiper-container swiper-banner pb-0">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <div className="box-cover-image" style={{backgroundImage: "url(/assets/imgs/page/homepage15/banner.png)"}}>
                        <div className="box-banner-info">
                          <div className="row align-items-center">
                            <div className="col-md-6 mb-30">
                              <h5 className="color-primary-dark mb-10">From the Farm</h5>
                              <h2 className="heading-title-medium color-primary-dark mb-30">To Your Face</h2>
                    ...
                    <div className="swiper-slide">
                      <div className="box-cover-image" style={{backgroundImage: "url(/assets/imgs/page/homepage15/banner2.png)"}}>
                        <div className="box-banner-info">
                          <div className="row align-items-center">
                            <div className="col-md-6 mb-30">
                              <h5 className="color-primary-dark mb-10">From the Farm</h5>
            ...
            <section className="section block-intro">
              <div className="container"> 
                <div className="text-center"> 
                  <h3 className="mb-20">Welcome to our store</h3>
                  <h5 className="mb-60">The self care brand that’s setting a new standard. Clean <br className="d-none d-lg-block" />products and sex ed, to help you feel good in your own body.</h5>
                </div>
                <div className="list-intros"> 
                  <div className="item-intro"> 
                    <div className="item-intro-icon"><img src="/assets/imgs/page/homepage15/icon1.svg" alt="Indovia" /></div>
                    <div className="item-intro-info">
                      <h6 className="primary-dark">Powered By Nature</h6>
                      <p className="body-p2 neutral-dark">Aliquam venenatis vel lorem id mollis. </p>
                    </div>
                  </div>
                  <div className="item-intro"> 
                    <div className="item-intro-icon"><img src="/assets/imgs/page/homepage15/icon2.svg" alt="Indovia" /></div>
                    <div className="item-intro-info">
                      <h6 className="primary-dark">Exceptional Quality</h6>
                      <p className="body-p2 neutral-dark">Nulla tincidunt gravida augue, eget pellentesque.</p>
                    </div>
                  </div>
                  <div className="item-intro"> 
                    <div className="item-intro-icon"><img src="/assets/imgs/page/homepage15/icon3.svg" alt="Indovia" /></div>
                    <div className="item-intro-info">
                      <h6 className="primary-dark">Skin First Formulas</h6>
                      <p className="body-p2 neutral-dark">Aliquam sed diam fringilla, lobortis orci nec.</p>
                    </div>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-banner-video-2">
              <div className="container"> 
                <div className="box-banner-video">
                  <div className="box-banner-video-info">
                    <h2 className="mb-25">We make going all <br className="d-none d-lg-block" />natural second nature.</h2><a className="btn btn-border-white" href="#">Our Story</a>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-shop-1"> 
              <div className="container"> 
                <div className="text-center">
                  <h3 className="neutral-dark wow fadeInLeft">Our Best Sellers</h3>
                  <div className="box-tabs wow fadeInRight"> 
                    <ul className="nav nav-tabs nav-tabs-style-2 nav-tabs-style-3" role="tablist">
                      <li className="nav-item" role="presentation">
                        <button className="nav-link active" id="skincare-tab" data-bs-toggle="tab" data-bs-target="#skincare" type="button" role="tab" aria-controls="skincare" aria-selected="true">Skincare Best Sellers</button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="haircare-tab" data-bs-toggle="tab" data-bs-target="#haircare" type="button" role="tab" aria-controls="haircare" aria-selected="false">Haircare Best Sellers</button>
                      </li>
                    </ul>
                  </div>
                </div>
                <div className="tab-content">
                  <div className="tab-pane fade show active" id="skincare" role="tabpanel" aria-labelledby="skincare-tab">
                    <div className="row"> 
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProduct wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage15/sp1.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage15/sp8.png" alt="Indovia" /></a>
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProduct wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage15/sp2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage15/sp7.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProduct wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage15/sp3.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage15/sp6.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProduct wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage15/sp4.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage15/sp5.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProduct wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage15/sp5.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage15/sp4.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProduct wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage15/sp6.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage15/sp3.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProduct wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage15/sp7.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage15/sp2.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProduct wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage15/sp8.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage15/sp1.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="tab-pane fade" id="haircare" role="tabpanel" aria-labelledby="haircare-tab"> 
                    <div className="row"> 
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProduct wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage15/sp1.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage15/sp8.png" alt="Indovia" /></a>
            ...
            <section className="section block-feature-product-home15">
              <div className="container"> 
                <div className="row align-items-center"> 
                  <div className="col-lg-4 mb-30">
                    <h3 className="overline-t2 title-feature">Featured product</h3>
                    <h3 className="title-main-feature">72 hours of <br className="d-none d-lg-block" />hydration</h3>
                    <p className="body-p2 mb-25">Too much time in the sun can dehydrate and damage your skin, causing premature aging. Look for a fast absorbing moisturiser to provide that instant hydration boost.</p><a className="btn btn-black" href="#">Shop Now</a>
                  </div>
                  <div className="col-lg-4 mb-30"><img src="/assets/imgs/page/homepage15/feature.png" alt="Indovia" /></div>
                  <div className="col-lg-4 mb-30"><img src="/assets/imgs/page/homepage15/feature2.png" alt="Indovia" /></div>
                </div>
              </div>
            </section>
            <section className="section block-review block-testimonials-type4-homepage15">
              <div className="container"> 
                <div className="text-center"> 
            ...
            <section className="section block-banner-collection-home15">
              <div className="container"> 
                <h2 className="mb-10">Your Skin<br className="d-none d-lg-block" />Deserves Better.</h2>
                <h5 className="mb-30">Organic. Phytoactive. Skincare</h5><a className="btn btn-black" href="#">Shop the Collection</a>
              </div>
            </section>
          </main>
