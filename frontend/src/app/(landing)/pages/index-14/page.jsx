...
const Index14 = () => (
  <>
    <Helmet>
      <title>Index 14 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-14">
      <header className="header sticky-bar header-type1">
          ...
          <main className="main">
            <section className="section banner-homepage7 banner-homepage14">
              <div className="box-swiper"> 
                <div className="swiper-container swiper-banner pb-0">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <div className="box-cover-image"> <img src="/assets/imgs/page/homepage14/banner.jpg" alt="Indovia" /></div>
                      <div className="box-banner-info"> 
                        <div className="text-center"> 
                          <h2 className="text-68 color-white mb-10">Top Hottest <br className="d-none d-lg-block" />Skater Girls</h2>
                          <p className="fonticon-24 mb-30 color-white">Find their next great adventure with <br className="d-none d-lg-block" />our favourite kids' scooters.</p>
                          <div className="text-center"> <a className="btn btn-white" href="#">Shop Now</a></div>
                        </div>
                      </div>
                    </div>
                    <div className="swiper-slide">
            ...
            <section className="section block-intro">
              <div className="container"> 
                <div className="text-center"> 
                  <h2 className="text-34 mb-5 text-uppercase">ABOUT Skateboards</h2>
                  <p className="body-p2">We've expanded our signature use of sustainably sourced wood and bamboo, continuing <br className="d-none d-lg-block" />a tradition of balancing style with performance for over 25 years.</p>
                </div>
              </div>
            </section>
            <section className="section block-cat-homepage14">
              <div className="container"> 
                <div className="row"> 
                  <div className="col-lg-6">
                    <div className="box-cat"><img src="/assets/imgs/page/homepage14/cat.png" alt="Indovia" />
                      <div className="box-link"><a className="link-cat" href="#">Skateboard</a></div>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="box-cat"><img src="/assets/imgs/page/homepage14/cat2.png" alt="Indovia" />
                      <div className="box-link"><a className="link-cat" href="#">Deck Skate</a></div>
                    </div>
                    <div className="box-cat"><img src="/assets/imgs/page/homepage14/cat3.png" alt="Indovia" />
                      <div className="box-link"><a className="link-cat" href="#">Cruiser</a></div>
                    </div>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-popular-product">
              <div className="container"> 
                <div className="text-center"> 
                  <h3 className="text-34 mb-40 text-uppercase">POPULAR IN STORE</h3>
                </div>
                <div className="box-swiper"> 
                  <div className="swiper-container swiper-popular-product pb-0">
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <div className="cardProductStyle4 wow fadeInUp"> 
                          <div className="cardImage"> 
                            <div className="box-swiper"> 
                              <div className="swiper-container swiper-product pb-0" data-lg="1" data-md="1" data-sm="1" data-xs="1" data-prev=".swiper-button-prev-product-1" data-next=".swiper-button-next-product-1" data-pagination=".swiper-pagination-product-1">
                                <div className="swiper-wrapper">
                                  <div className="swiper-slide"><img className="imageMain" src="/assets/imgs/page/homepage14/product.png" alt="Indovia" /></div>
                                  <div className="swiper-slide"><img className="imageMain" src="/assets/imgs/page/homepage14/product2.png" alt="Indovia" /></div>
                                </div>
                              </div>
                              <div className="swiper-button-prev swiper-button-prev-style-4 swiper-button-prev-product-1"></div>
                              <div className="swiper-button-next swiper-button-next-style-4 swiper-button-next-product-1"></div>
                            </div>
                          ...
                          <div className="cardInfo"> <a className="mb-10 cardTitle" href="#">Battler Abberation</a>
                            <p className="body-p2 cardDesc">$16.00</p><a className="btn btn-black-medium" href="#">Add to cart</a>
                          </div>
                        </div>
                      </div>
                      <div className="swiper-slide">
                        <div className="cardProductStyle4 wow fadeInUp"> 
                          <div className="cardImage"> 
                            <div className="box-swiper"> 
                              <div className="swiper-container swiper-product pb-0" data-lg="1" data-md="1" data-sm="1" data-xs="1" data-prev=".swiper-button-prev-product-2" data-next=".swiper-button-next-product-2" data-pagination=".swiper-pagination-product-2">
                                <div className="swiper-wrapper">
                                  <div className="swiper-slide"><img className="imageMain" src="/assets/imgs/page/homepage14/product.png" alt="Indovia" /></div>
                                  <div className="swiper-slide"><img className="imageMain" src="/assets/imgs/page/homepage14/product2.png" alt="Indovia" /></div>
                                </div>
                              </div>
                              <div className="swiper-button-prev swiper-button-prev-style-4 swiper-button-prev-product-2"></div>
                              <div className="swiper-button-next swiper-button-next-style-4 swiper-button-next-product-2"></div>
                            </div>
                            <div className="box-quick-button"> <a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                          ...
                          <div className="cardInfo"> <a className="mb-10 cardTitle" href="#">Battler Abberation</a>
                            <p className="body-p2 cardDesc">$16.00</p><a className="btn btn-black-medium" href="#">Select Options</a>
                          </div>
                        </div>
                      </div>
                      <div className="swiper-slide">
                        <div className="cardProductStyle4 wow fadeInUp"> 
                          <div className="cardImage"> 
                            <div className="box-swiper"> 
                              <div className="swiper-container swiper-product pb-0" data-lg="1" data-md="1" data-sm="1" data-xs="1" data-prev=".swiper-button-prev-product-3" data-next=".swiper-button-next-product-3" data-pagination=".swiper-pagination-product-3">
                                <div className="swiper-wrapper">
                                  <div className="swiper-slide"><img className="imageMain" src="/assets/imgs/page/homepage14/product.png" alt="Indovia" /></div>
                                  <div className="swiper-slide"><img className="imageMain" src="/assets/imgs/page/homepage14/product2.png" alt="Indovia" /></div>
                                </div>
                              </div>
                              <div className="swiper-button-prev swiper-button-prev-style-4 swiper-button-prev-product-3"></div>
                              <div className="swiper-button-next swiper-button-next-style-4 swiper-button-next-product-3"></div>
                            </div>
                            <div className="box-quick-button"> <a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="swiper-slide">
                        <div className="cardProductStyle4 wow fadeInUp"> 
                          <div className="cardImage"> 
                            <div className="box-swiper"> 
                              <div className="swiper-container swiper-product pb-0" data-lg="1" data-md="1" data-sm="1" data-xs="1" data-prev=".swiper-button-prev-product-4" data-next=".swiper-button-next-product-4" data-pagination=".swiper-pagination-product-4">
                                <div className="swiper-wrapper">
                                  <div className="swiper-slide"><img className="imageMain" src="/assets/imgs/page/homepage14/product.png" alt="Indovia" /></div>
                                  <div className="swiper-slide"><img className="imageMain" src="/assets/imgs/page/homepage14/product2.png" alt="Indovia" /></div>
                                </div>
                              </div>
                              <div className="swiper-button-prev swiper-button-prev-style-4 swiper-button-prev-product-4"></div>
                              <div className="swiper-button-next swiper-button-next-style-4 swiper-button-next-product-4"></div>
                            </div>
                            <div className="box-quick-button"> <a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="swiper-slide">
                        <div className="cardProductStyle4 wow fadeInUp"> 
                          <div className="cardImage"> 
                            <div className="box-swiper"> 
                              <div className="swiper-container swiper-product pb-0" data-lg="1" data-md="1" data-sm="1" data-xs="1" data-prev=".swiper-button-prev-product-5" data-next=".swiper-button-next-product-5" data-pagination=".swiper-pagination-product-5">
                                <div className="swiper-wrapper">
                                  <div className="swiper-slide"><img className="imageMain" src="/assets/imgs/page/homepage14/product.png" alt="Indovia" /></div>
                                  <div className="swiper-slide"><img className="imageMain" src="/assets/imgs/page/homepage14/product2.png" alt="Indovia" /></div>
                                </div>
                              </div>
                              <div className="swiper-button-prev swiper-button-prev-style-4 swiper-button-prev-product-5"></div>
                              <div className="swiper-button-next swiper-button-next-style-4 swiper-button-next-product-5"></div>
                            </div>
                            <div className="box-quick-button"> <a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="swiper-pagination swiper-pagination-popular-product"></div>
                </div>
              </div>
            </section>
            <section className="section block-banner-street"> 
              <div className="container"> 
                <div className="box-banner-street">
                  <h1 className="text-68 mb-10">Street Completes</h1>
                  <p className="text-24 mb-30">Ready to roll from the jump</p><a className="btn btn-white" href="#">Shop Now</a>
                </div>
              </div>
            </section>
            <section className="section block-product-detail">
              <div className="container">
                <div className="row">
                  <div className="col-lg-6">
                    <div className="box-slider-product-images">
                      <div className="box-swiper">
                        <div className="swiper-container swiper-1-item pb-0">
                          <div className="swiper-wrapper">
                            <div className="swiper-slide"><img src="/assets/imgs/page/homepage14/product-main.png" alt="Indovia" /></div>
                            <div className="swiper-slide"><img src="/assets/imgs/page/homepage14/product-main.png" alt="Indovia" /></div>
                          </div>
                        </div>
                        <div className="box-button-leftright">
                          <div className="swiper-button-prev btn-prev-style-1 swiper-button-prev-group-1"></div>
                          <div className="swiper-button-next btn-next-style-1 swiper-button-next-group-1"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <h2 className="title-product text-34">ACE SPACE SUPER SAP R7 8.75</h2>
                    ...
                    <div className="block-price"><span className="price-line">$25.00</span><span className="price-main">$15.00</span></div>
                    <div className="block-view">
                      <p className="viewed-product">24 guests are viewing this product</p>
                    </div>
                    <div className="block-hurry">
                      <p className="text-24 tone-red">Hurry up! Sale ends in</p>
                      <div className="box-count box-count-square">
                        <div className="deals-countdown" data-countdown="2023/12/25 00:00:00"></div>
                      </div>
                    </div>
            ...
            <section className="section block-instagram-type4-home7">
              <div className="container"> 
                <div className="text-center">
                  <h6 className="text-18-medium instagram-title wow fadeInUp">Instagram with #July</h6>
                </div>
              </div>
              <div className="box-gallery-instagram"> 
                <div className="gallery-item wow fadeInLeft"><img src="/assets/imgs/page/homepage14/inst.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage14/inst2.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage14/inst3.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage14/inst4.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInRight"><img src="/assets/imgs/page/homepage14/inst5.png" alt="Indovia" /></div>
              </div>
            </section>
          </main>
                  ...
                  <div className="col-lg-8 mb-30">
                    <div className="row">
                      ...
                      <div className="col-lg-6 mb-30">
                        <h6 className="color-white mb-20">Newsletter</h6>
                        <p className="body-p2 color-white">Sign up now to get first update about our new collection.</p>
              ...
              <div className="container">
                <div className="footer-bottom">
                  <div className="row align-items-center">
                    <div className="col-lg-6 col-md-12 text-center text-lg-start mb-20"><span className="body-p1 color-white">© 2023 Indovia.Co. All rights reserved</span>
