...
const Index7 = () => (
  <>
    <Helmet>
      <title>Index 7 | Larkon Store</title>
    </Helmet>
          ...
          <main className="main">
                ...
                <div className="swiper-container swiper-banner pb-0">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <div className="box-cover-image"><img src="/assets/imgs/page/homepage7/banner.png" alt="Guza" /></div>
                    ...
                    <div className="swiper-slide">
                      <div className="box-cover-image"><img src="/assets/imgs/page/homepage7/banner-2.png" alt="Guza" /></div>
                      <div className="box-banner-info">
                        <div className="row">
                          <div className="col-sm-6"></div>
                          <div className="col-sm-6">
                ...
                <div className="row"> 
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProductStyle2 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage7/product1.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage7/product2.png" alt="guza" /></a>
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProductStyle2 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage7/product2.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage7/product1.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProductStyle2 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage7/product3.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage7/product4.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProductStyle2 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage7/product4.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage7/product3.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProductStyle2 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage7/product5.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage7/product6.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProductStyle2 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage7/product6.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage7/product5.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProductStyle2 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage7/product7.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage7/product8.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProductStyle2 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage7/product8.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage7/product7.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                ...
                <div className="row">
                  <div className="col-lg-6">
                    <div className="cardFeature text-center wow fadeInUp">
                      <div className="cardImage"><img src="/assets/imgs/page/homepage7/bg-under.png" alt="Guza" /></div>
                ...
                <div className="row"> 
                  <div className="col-lg-4 hasborder"> 
                    <div className="cardIcon wow fadeInUp">
                      <div className="cardImage"><img src="/assets/imgs/page/homepage7/simplicity.svg" alt="Guza" /></div>
                  ...
                  <div className="col-lg-4 hasborder"> 
                    <div className="cardIcon wow fadeInUp">
                      <div className="cardImage"><img src="/assets/imgs/page/homepage7/clothes.svg" alt="Guza" /></div>
                      <div className="cardInfo">
                  ...
                  <div className="col-lg-4"> 
                    <div className="cardIcon wow fadeInUp">
                      <div className="cardImage"><img src="/assets/imgs/page/homepage7/nature.svg" alt="Guza" /></div>
                      <div className="cardInfo">
            ...
            <section className="section block-instagram-type4-home7">
              ...
              <div className="box-gallery-instagram"> 
                <div className="gallery-item wow fadeInLeft"><img src="/assets/imgs/page/homepage7/under.png" alt="Guza" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage7/under2.png" alt="Guza" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage7/under3.png" alt="Guza" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage7/under4.png" alt="Guza" /></div>
                <div className="gallery-item wow fadeInRight"><img src="/assets/imgs/page/homepage7/under5.png" alt="Guza" /></div>
              </div>
            </section>
