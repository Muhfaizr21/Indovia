...
const Index11 = () => (
  <>
    <Helmet>
      <title>Index 11 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-11">
      <header className="header sticky-bar header-type7">
            <div className="container">
              <div className="main-header">
                <div className="header-search"> 
                  <form action="#">
                    <input className="form-control" type="text" placeholder="Search prodcut" />
          ...
          <main className="main">
            <section className="section banner-homepage2 banner-homepage11">
                        ...
                        <div className="box-banner-info"> 
                          <div className="row align-items-center"> 
                            <div className="col-md-6 mb-30">
                              <p className="overline-t2-medium color-primary-dark mb-10 text-uppercase">A gift for you</p>
                              <h2 className="text-64-semibold color-primary-dark mb-10">Enjoy <span className="tone-red">15% </span>of <br className="d-none d-lg-block" />money</h2>
                              <p className="text-18-medium mb-30">Use code HOLIDAY at checkout. </p>
                              <div className="box-button-banner"> <a className="btn btn-black" href="#">View Collection</a></div>
                            </div>
                            <div className="col-md-6 mb-30">
                              <div className="box-bg-pet"><img src="/assets/imgs/page/homepage11/pets.png" alt="Indovia" /></div>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <section className="section block-cols">
              <div className="container"> 
                <div className="row">
                  <div className="col-lg-6 mb-30">
                    <div className="box-col wow fadeInLeft"> 
                      <div className="row">
                        <div className="col-lg-7 col-md-6 col-sm-6"><a href="#"><img src="/assets/imgs/page/homepage11/dog.png" alt="Indovia" /></a></div>
                        <div className="col-lg-5 col-md-6 col-sm-6"><a href="#">
                            <h3 className="mb-10">Sopping for Dogs</h3></a>
                          <h6 className="mb-15">We've got it all!</h6><a className="link-underline link-l2" href="#">Shop Now</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-6 mb-30">
                    <div className="box-col wow fadeInRight"> 
                      <div className="row">
                        <div className="col-md-6 col-sm-6"><a href="#"><img src="/assets/imgs/page/homepage11/cat.png" alt="Indovia" /></a></div>
                        <div className="col-md-6 col-sm-6"><a href="#">
                            <h3 className="mb-10">Shopping for Cats</h3></a>
                          <h6 className="mb-15">You’ll find those here too</h6><a className="link-underline link-l2" href="#">Shop Now</a>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <section className="section block-cat-homepage11"> 
              <div className="container"> 
                <div className="text-center"> 
                  <h3 className="mb-40 wow fadeInLeft">Shop By Category</h3>
                </div>
                <div className="row"> 
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProduceCircle wow fadeInDown">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage11/food.png" alt="Indovia" /></a></div>
                      <div className="cardInfo"><a className="text-17-medium" href="#">Food<span className="sub-num">(12)</span></a></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProduceCircle wow fadeInDown">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage11/toys.png" alt="Indovia" /></a></div>
                      <div className="cardInfo"><a className="text-17-medium" href="#">Toys<span className="sub-num">(3)</span></a></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProduceCircle wow fadeInDown">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage11/beds.png" alt="Indovia" /></a></div>
                      <div className="cardInfo"><a className="text-17-medium" href="#">Beds<span className="sub-num">(4)</span></a></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProduceCircle wow fadeInDown">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage11/flea.png" alt="Indovia" /></a></div>
                      <div className="cardInfo"><a className="text-17-medium" href="#">Flea & Tick<span className="sub-num">(7)</span></a></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProduceCircle wow fadeInDown">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage11/bowls.png" alt="Indovia" /></a></div>
                      <div className="cardInfo"><a className="text-17-medium" href="#">Bowls<span className="sub-num">(6)</span></a></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProduceCircle wow fadeInDown">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage11/furniture.png" alt="Indovia" /></a></div>
                      <div className="cardInfo"><a className="text-17-medium" href="#">Furniture<span className="sub-num">(4)</span></a></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProduceCircle wow fadeInDown">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage11/litter.png" alt="Indovia" /></a></div>
                      <div className="cardInfo"><a className="text-17-medium" href="#">Litter<span className="sub-num">(6)</span></a></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProduceCircle wow fadeInDown">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage11/treats.png" alt="Indovia" /></a></div>
                      <div className="cardInfo"><a className="text-17-medium" href="#">Treats<span className="sub-num">(3)</span></a></div>
                    </div>
                  </div>
                </div>
                <div className="text-center"> <a className="link-underline text-17-medium" href="#">View All Categories</a></div>
              </div>
            </section>
            <section className="section block-collection-type3">
              <div className="container"> 
                <div className="box-collection-type3">
                  <div className="row align-items-center"> 
                    <div className="col-lg-6">
                      <div className="image-sale-event wow fadeInLeft"> <img src="/assets/imgs/page/homepage11/collection.png" alt="Indovia" /></div>
                    </div>
                    <div className="col-lg-6">
                      <div className="box-padding wow fadeInRight">
                        <h3 className="neutral-dark mb-5 mt-10">Made for all  <br className="d-none d-lg-block" />life's adventures.</h3>
                        <p className="body-p2 neutral-dark mb-30">Aliquam venenatis vel lorem id mollis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. </p><a className="btn btn-border" href="#">Shop Our Collections</a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="section box-product-pets"> 
              <div className="container"> 
                <div className="text-center"> 
                  <h3 className="mb-40">Our Popular Treats</h3>
                </div>
                <div className="row"> 
                  <div className="col-lg-4 col-md-4 col-sm-6"> 
                    <div className="cardProductSmall wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage11/product.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage11/product2.png" alt="Indovia" /></a>
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6"> 
                    <div className="cardProductSmall wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage11/product2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage11/product.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6"> 
                    <div className="cardProductSmall wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage11/product3.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage11/product4.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6"> 
                    <div className="cardProductSmall wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage11/product4.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage11/product5.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6"> 
                    <div className="cardProductSmall wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage11/product5.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage11/product6.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6"> 
                    <div className="cardProductSmall wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage11/product6.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage11/product3.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
