...
const Index21 = () => (
  <>
    <Helmet>
      <title>Index 21 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-21">
      <header className="header sticky-bar header-style-3">
          ...
          <main className="main">
            <section className="section banner-homepage21">
              <div className="container-banner">
                <div className="box-banner-home21">
                      ...
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
                          <div className="row align-items-end"> 
                            ...
                            <div className="col-lg-7"><img src="/assets/imgs/page/homepage21/banner.png" alt="Indovia" /></div>
                          </div>
                        </div>
                        <div className="swiper-slide">
                          <div className="row align-items-end"> 
            ...
            <section className="section block-categories-home21"> 
              <div className="container"> 
                <div className="row"> 
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="card-categories"> 
                      <div className="card-image"><a href="#"><img className="bdrd-16" src="/assets/imgs/page/homepage21/cat.png" alt="Indovia" /></a></div>
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="card-categories"> 
                      <div className="card-image"><a href="#"><img className="bdrd-16" src="/assets/imgs/page/homepage21/cat2.png" alt="Indovia" /></a></div>
                      <div className="card-info"> <a href="#">
                          <h5>Infants</h5></a></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="card-categories"> 
                      <div className="card-image"><a href="#"><img className="bdrd-16" src="/assets/imgs/page/homepage21/cat3.png" alt="Indovia" /></a></div>
                      <div className="card-info"> <a href="#">
                          <h5>Toddlers</h5></a></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="card-categories"> 
                      <div className="card-image"><a href="#"><img className="bdrd-16" src="/assets/imgs/page/homepage21/cat4.png" alt="Indovia" /></a></div>
                      <div className="card-info"> <a href="#">
                          <h5>Parents</h5></a></div>
                    </div>
                  </div>
            ...
            <section className="section block-banner-2-home21"> 
              <div className="container-banner">
                <div className="row"> 
                  <div className="col-lg-6 mb-30"> 
                    <div className="card-block-banner banner-enjoy"> 
                      <div className="card-info"> 
                        <p className="text-17-medium">ENJOY AN EXTRA</p>
                        <h2>20% OFF</h2><a className="btn btn-black-medium" href="#">Shop now</a>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-6 mb-30"> 
                    <div className="card-block-banner banner-sale"> 
                      <div className="card-info"> 
                        <p className="text-17-medium">ALL SALE STYLES </p>
                        <h2>10% OFF</h2><a className="btn btn-black-medium" href="#">Shop now</a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="section block-categories-slider-home21"> 
              <div className="container-slider-padding"> 
                <div className="box-categories-slider-home21"> 
                  <div className="box-categories-left">
                    <h3 className="text-34-semibold font-quicksand mb-15">Shop by Category</h3>
                    <p className="body-p2">Looking for infant sizes 0-24 months? Browse our collection of Baby Clothes. </p>
                  </div>
                  <div className="box-categories-right">
                    <div className="box-swiper swiper-full-scroll"> 
                      <div className="swiper-container swiper-scrollbar-4-items pb-10">
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <div className="card-categories-slide">
                              <div className="card-image"> <img className="imageMain" src="/assets/imgs/page/homepage21/cat5.png" alt="Indovia" /></div>
                              <div className="card-info"> <a href="#">
                                  <h5>Layers</h5></a></div>
                            </div>
                          </div>
                          <div className="swiper-slide">
                            <div className="card-categories-slide">
                              <div className="card-image"> <img className="imageMain" src="/assets/imgs/page/homepage21/cat6.png" alt="Indovia" /></div>
                              <div className="card-info"> <a href="#">
                                  <h5>Clothes</h5></a></div>
                            </div>
                          </div>
                          <div className="swiper-slide">
                            <div className="card-categories-slide">
                              <div className="card-image"> <img className="imageMain" src="/assets/imgs/page/homepage21/cat7.png" alt="Indovia" /></div>
                              <div className="card-info"> <a href="#">
                                  <h5>Bedding</h5></a></div>
                            </div>
                          </div>
                          <div className="swiper-slide">
                            <div className="card-categories-slide">
                              <div className="card-image"> <img className="imageMain" src="/assets/imgs/page/homepage21/cat8.png" alt="Indovia" /></div>
                              <div className="card-info"> <a href="#">
                                  <h5>Swaddles</h5></a></div>
                            </div>
                          </div>
                          <div className="swiper-slide">
                            <div className="card-categories-slide">
                              <div className="card-image"> <img className="imageMain" src="/assets/imgs/page/homepage21/cat9.png" alt="Indovia" /></div>
                              <div className="card-info"> <a href="#">
                                  <h5>Toys</h5></a></div>
                            </div>
                          </div>
            ...
            <section className="section block-banner-video-home21"> 
              <div className="container-banner">
                <div className="box-banner-video-2">
                  <div className="box-banner-video-inner">
                    <h1>We Make Parenting Cool</h1>
                    <p className="body-p2">We are a team of driven designers and engineers united in a common cause. </p><a className="btn btn-white" href="#">Explore more</a>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-products-slider-home21"> 
              <div className="container-slider-padding"> 
                <div className="box-categories-slider-home21"> 
                  <div className="box-categories-left">
                    <h3 className="text-34-semibold font-quicksand mb-15">New Best Seller</h3>
                    <p className="body-p2">Looking for infant sizes 0-24 months? Browse our collection of Baby Clothes.</p>
                  </div>
                  <div className="box-categories-right">
                    <div className="box-swiper swiper-full-scroll box-product-border-radius"> 
                      <div className="swiper-container swiper-scrollbar-4-items-2 pb-0">
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage21/sp.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage21/sp.png" alt="Indovia" /></a>
                              ...
                              <div className="cardInfo">
                                <h6 className="text-17-medium mb-10">Sleep Suit Bag 3.5 TOG</h6>
                          ...
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage21/sp2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage21/sp2.png" alt="Indovia" /></a>
                                <div className="button-select"><a href="#">Select Options</a></div>
                                <div className="box-quick-button"><a className="btn" href="#">
                                    <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                      <g clipPath="url(#clip0_116_452)">
                              ...
                              <div className="cardInfo">
                                <h6 className="text-17-medium mb-10">Baby Essentials Gift Pack</h6>
                                <p className="body-p2 cardDesc">$100.00</p>
                              </div>
                            </div>
                          </div>
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage21/sp3.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage21/sp3.png" alt="Indovia" /></a>
                                <div className="button-select"><a href="#">Select Options</a></div>
                                <div className="box-quick-button"><a className="btn" href="#">
                                    <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                      <g clipPath="url(#clip0_116_452)">
                              ...
                              <div className="cardInfo">
                                <h6 className="text-17-medium mb-10">Little Bamboo Textured Knit Baby</h6>
                                <p className="body-p2 cardDesc">$100.00</p>
                              </div>
                            </div>
                          </div>
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage21/sp4.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage21/sp4.png" alt="Indovia" /></a>
                                <div className="button-select"><a href="#">Select Options</a></div>
                                <div className="box-quick-button"><a className="btn" href="#">
                                    <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                      <g clipPath="url(#clip0_116_452)">
                              ...
                              <div className="cardInfo">
                                <h6 className="text-17-medium mb-10">Sleep Suit Bag 2.5 TOG</h6>
                                <p className="body-p2 cardDesc">$100.00</p>
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="swiper-pagination swiper-pagination-scrollbar-product"></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section className="section block-instagram-type-5"> 
              <div className="container"> 
                ...
                <div className="box-gallery-instagram-type-5 wow fadeInRight"> 
                  <div className="gallery-1"><img src="/assets/imgs/page/homepage21/inst-img.png" alt="kidify" /></div>
                  <div className="gallery-2"> <img src="/assets/imgs/page/homepage21/inst-img2.png" alt="kidify" /><img src="/assets/imgs/page/homepage21/inst-img3.png" alt="kidify" /><img src="/assets/imgs/page/homepage21/inst-img4.png" alt="kidify" /><img src="/assets/imgs/page/homepage21/inst-img5.png" alt="kidify" /><img src="/assets/imgs/page/homepage21/inst-img6.png" alt="kidify" /><img src="/assets/imgs/page/homepage21/inst-img7.png" alt="kidify" /></div>
                </div>
              </div>
            </section>
          </main>
          <footer className="footer footer-type3-light footer-type3-light-top-border">
