...
const Index26 = () => (
  <>
    <Helmet>
      <title>Index 26 | Larkon Store</title>
    </Helmet>
                    ...
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <div className="cardProductCategory02 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage26/cat.png" alt="guza" /></a></div>
                      ...
                      <div className="swiper-slide">
                        <div className="cardProductCategory02 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage26/cat2.png" alt="guza" /></a></div>
                          <div className="cardInfo">
                      ...
                      <div className="swiper-slide">
                        <div className="cardProductCategory02 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage26/cat3.png" alt="guza" /></a></div>
                          <div className="cardInfo">
                    ...
                    <div className="row"> 
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProductStyle3 cardProductType03 cardProductType02 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage26/sp.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage26/sp.png" alt="guza" /></a>
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProductStyle3 cardProductType03 cardProductType02 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage26/sp2.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage26/sp2.png" alt="guza" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
