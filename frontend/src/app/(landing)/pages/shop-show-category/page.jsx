...
const ShopShowCategory = () => (
  <>
    <Helmet>
      <title>Shop Show Category | Indovia Store</title>
    </Helmet>
    <div className="landing-page-shop-show-category">
      <header className="header sticky-bar">
          ...
          <main className="main">
            ...
            <section className="section block-content-shop">
              <div className="container">
                <div className="box-filter-top box-filter-top-style3"> 
                  <div className="box-filters d-none d-lg-block"> 
                  ...
                  <div className="box-sort"> <a className="btn-open-filter btn-open-filter-click" href="#">Filter </a>
...
export default ShopShowCategory;
