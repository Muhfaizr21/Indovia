...
const AboutUs2 = () => (
  <>
    <Helmet>
      <title>About Us 2 | Larkon Store</title>
    </Helmet>
              ...
              <div className="container"> 
                <div className="row align-items-center"> 
                  <div className="col-lg-6 mb-80">
                    <div className="box-image-about-2-top wow fadeInUp"> <img src="/assets/imgs/page/about1/about3.png" alt="Guza" /></div>
                  </div>
                ...
                <div className="row align-items-center">
                  <div className="col-lg-6 mb-80">
                    <div className="box-image-about-2-bottom wow fadeInUp"> <img src="/assets/imgs/page/about1/about4.png" alt="Guza" /></div>
                  </div>
                  <div className="col-lg-6 mb-80 wow fadeInUp"> 
                    ...
                    <div className="socials mt-55 justify-content-start"><a href="#"><img src="/assets/imgs/page/about1/fb.svg" alt="Guza" /></a><a href="#"><img src="/assets/imgs/page/about1/insta.svg" alt="Guza" /></a></div>
                  </div>
                </div>
              </div>
            </section>
