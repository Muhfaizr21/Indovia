...
const ProductSingle7 = () => (
  <>
    <Helmet>
      <title>Product Single 7 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-product-single-7">
              ...
              <div className="container">
                <div className="row mb-40">
                  <div className="col-lg-6">
                    <div className="detail-gallery detail-gallery-6 detail-gallery-7">
