...
const Index9 = () => (
  <>
    <Helmet>
      <title>Index 9 | Larkon Store</title>
    </Helmet>
          ...
          <main className="main">
                ...
                <div className="swiper-container swiper-banner pb-0">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <div className="box-cover-image"> <img src="/assets/imgs/page/homepage9/banner.png" alt="Guza" /></div>
                    ...
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <div className="cardCategorySmall wow fadeInUp">
                          <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage9/cat.png" alt="Guza" /></a></div>
                      ...
                      <div className="swiper-slide">
                        <div className="cardCategorySmall wow fadeInUp">
                          <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage9/cat2.png" alt="Guza" /></a></div>
                          <div className="cardInfo"><a href="#">
                      ...
                      <div className="swiper-slide">
                        <div className="cardCategorySmall wow fadeInUp">
                          <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage9/cat3.png" alt="Guza" /></a></div>
                          <div className="cardInfo"><a href="#">
                      ...
                      <div className="swiper-slide">
                        <div className="cardCategorySmall wow fadeInUp">
                          <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage9/cat4.png" alt="Guza" /></a></div>
                          <div className="cardInfo"><a href="#">
                      ...
                      <div className="swiper-slide">
                        <div className="cardCategorySmall wow fadeInUp">
                          <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage9/cat5.png" alt="Guza" /></a></div>
                          <div className="cardInfo"><a href="#">
                      ...
                      <div className="swiper-slide">
                        <div className="cardCategorySmall wow fadeInUp">
                          <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage9/cat6.png" alt="Guza" /></a></div>
                          <div className="cardInfo"><a href="#">
            ...
            <section className="section block-product-home8">
              <div className="container"> 
                ...
                <div className="row mt-40"> 
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage8/product2.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage8/product3.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage8/product4.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage8/product5.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage8/product6.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage8/product7.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage8/product8.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage8/product.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
            ...
            <section className="section block-instagram-type4-home7">
              ...
              <div className="box-gallery-instagram"> 
                <div className="gallery-item wow fadeInLeft"><img src="/assets/imgs/page/homepage9/insta.png" alt="Guza" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage9/insta2.png" alt="Guza" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage9/insta3.png" alt="Guza" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage9/insta4.png" alt="Guza" /></div>
                <div className="gallery-item wow fadeInRight"><img src="/assets/imgs/page/homepage9/insta5.png" alt="Guza" /></div>
              </div>
            </section>
