...
const Index25 = () => (
  <>
    <Helmet>
      <title>Index 25 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-25">
      <header className="header sticky-bar header-type1">
          ...
          <main className="main">
            <section className="section block-banner-home25">
              <div className="box-swiper button-slide-square button-slide-square-2">
                <div className="swiper-container swiper-banner">
                  <div className="swiper-wrapper">
                        ...
                        <div className="container">
                          <div className="row align-items-center">
                            <div className="col-lg-5">
                              <p className="text-17-medium mb-5">Winter 2022</p>
                              <p className="text-68-medium mb-10 font-cormorant">New Collection</p>
                              <p className="text-17-medium mb-35">You can have anything you want in life if you dress for it.</p><a className="btn btn-border" href="#">Shop Now</a>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="swiper-slide">
                      <div className="box-banner-cover cover-2">
                        <div className="container">
                          <div className="row align-items-center">
                            <div className="col-lg-5">
                              <p className="text-17-medium mb-5">Winter 2022</p>
            ...
            <section className="section block-banner-2-home25"> 
              <div className="container"> 
                <div className="row"> 
                  <div className="col-lg-6 mb-30">
                    <div className="card-banner-grey"> 
                      <div className="row align-items-center"> 
                        <div className="col-lg-5 col-sm-6 col-12">
                          <div className="text-center text-sm-start">
                            <h3 className="font-cormorant mb-5">New Trend</h3>
                            <p className="text-17 mb-20">Embroidered Straw Bag</p><a className="btn btn-border-medium" href="#">Shop Now</a>
                          </div>
                        </div>
                        <div className="col-lg-7 col-sm-6 col-12">
                          <div className="text-center text-sm-end"><img src="/assets/imgs/page/homepage25/banner2.png" alt="kidify" /></div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="card-banner-grey"> 
                      <div className="row align-items-center"> 
                        <div className="col-lg-6 col-sm-6 col-12">
                          <div className="text-center text-sm-start">
                            <h3 className="font-cormorant mb-5">Shoes Collection</h3>
                            <p className="mb-20"> <i className="text-17-medium">Platform Boots</i></p><a className="btn btn-border-medium" href="#">Shop Now</a>
                          </div>
                        </div>
                        <div className="col-lg-6 col-sm-6 col-12">
                          <div className="text-center text-sm-end"><img src="/assets/imgs/page/homepage25/banner3.png" alt="kidify" /></div>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <section className="section block-week-highlight"> 
              <div className="container position-relative"> 
                <div className="d-flex justify-content-between align-items-center">
                  <h3 className="text-34-semibold mb-40 font-cormorant"> <i>This week’s highlight</i></h3>
                  <div className="button-slide-square button-slide-square-2"> 
                    <div className="box-pagination-button">
                      <div className="swiper-pagination swiper-pagination-cat-4"></div>
                    </div>
                  </div>
                </div>
              </div>
              <div className="container-slider-padding">   
                <div className="box-swiper">
                  <div className="swiper-container swiper-group-4-category">
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <div className="cardProductCategory01 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp.png" alt="Indovia" /></a></div>
                          <div className="cardInfo">
                            <h6 className="text-24-medium">Shirts</h6>
                            <p className="text-17-medium cardDesc">11 items</p>
                          </div>
                        </div>
                      </div>
                      <div className="swiper-slide">
                        <div className="cardProductCategory01 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp2.png" alt="Indovia" /></a></div>
                          <div className="cardInfo">
                            <h6 className="text-24-medium">Pants</h6>
                            <p className="text-17-medium cardDesc">21 items</p>
                          </div>
                        </div>
                      </div>
                      <div className="swiper-slide">
                        <div className="cardProductCategory01 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp3.png" alt="Indovia" /></a></div>
                          <div className="cardInfo">
                            <h6 className="text-24-medium">Coats</h6>
                            <p className="text-17-medium cardDesc">14 items</p>
                          </div>
                        </div>
                      </div>
                      <div className="swiper-slide">
                        <div className="cardProductCategory01 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp8.png" alt="Indovia" /></a></div>
                          <div className="cardInfo">
                            <h6 className="text-24-medium">Blouse</h6>
                            <p className="text-17-medium cardDesc">22 items</p>
                          </div>
                        </div>
                      </div>
                      <div className="swiper-slide">
                        <div className="cardProductCategory01 wow fadeInUp">
                          ...
                          <div className="cardInfo">
                            <h6 className="text-24-medium">Shirts</h6>
                            <p className="text-17-medium cardDesc">16 items</p>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <section className="section block-new-arrival-home24">
              <div className="container"> 
                <div className="text-center"> 
                  <h3 className="title-dropdown mb-40"> <i className="neutral-medium font-cormorant">You are in </i>
                    <div className="dropdown">
                      <button className="btn btn-arrow-right dropdown-toggle" id="dropdownIn" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <h3 className="font-cormorant"><span>best sellers</span></h3>
                      </button>
                      <ul className="dropdown-menu" aria-labelledby="dropdownIn">
                ...
                <div className="row"> 
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp4.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage25/sp4.png" alt="Indovia" /></a>
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp5.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage25/sp5.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="cardInfo">
                        <h6 className="text-16-medium">Slim Mom High Ankle Jeans</h6>
                        <p className="body-p2 cardDesc">$39.00</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp6.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage25/sp6.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="cardInfo">
                        <h6 className="text-16-medium">Simple Light Dress</h6>
                        <p className="body-p2 cardDesc">$111.00</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp7.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage25/sp7.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="cardInfo">
                        <h6 className="text-16-medium">Linda Dress</h6>
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp9.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage25/sp9.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="cardInfo">
                        <h6 className="text-16-medium">Cropped Cotton Top</h6>
                        <p className="body-p2 cardDesc"><span className="sale-price">$150.00</span><span className="main-price">$100.00</span></p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp10.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage25/sp10.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="cardInfo">
                        <h6 className="text-16-medium">Linen Blend Shirt</h6>
                        <p className="body-p2 cardDesc">$60.00</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp11.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage25/sp11.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="cardInfo">
                        <h6 className="text-16-medium">Black Long Sleeve Shirt</h6>
                        <p className="body-p2 cardDesc">$60.00</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp12.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage25/sp12.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="cardInfo">
                        <h6 className="text-16-medium">Princess Knitwear</h6>
                        <p className="body-p2 cardDesc">$80.00</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="text-center"> <a className="btn btn-border" href="#"> <i>Load More</i></a></div>
              </div>
            </section>
            <section className="section block-icon-box-type-4"> 
              <div className="container"> 
                <div className="border-bottom mb-60"></div>
                <div className="row"> 
                  <div className="col-md-4"> 
                    <div className="card-icon-box-type4">
                      <div className="card-icon-image"><img src="/assets/imgs/page/homepage25/ship.svg" alt="Indovia" /></div>
                      <div className="card-icon-info">
                        <h6 className="card-icon-title">Express Delivery</h6>
                        <p className="card-icon-desc body-p2">Receive goods within 24 hours.</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4"> 
                    <div className="card-icon-box-type4">
                      <div className="card-icon-image"><img src="/assets/imgs/page/homepage25/member.svg" alt="Indovia" /></div>
                      <div className="card-icon-info">
                        <h6 className="card-icon-title">Membership</h6>
                        <p className="card-icon-desc body-p2">Get special offers.</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4"> 
                    <div className="card-icon-box-type4">
                      <div className="card-icon-image"><img src="/assets/imgs/page/homepage25/safe.svg" alt="Indovia" /></div>
                      <div className="card-icon-info">
                        <h6 className="card-icon-title">Safe Online Shopping</h6>
                        <p className="card-icon-desc body-p2">Secure payment information by July.</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="section block-instagram-type-4 block-instagram-type-2">
              ...
              <div className="box-gallery-instagram box-gallery-instagram-type2 mt-40 wow fadeInDown"> 
                <div className="box-gallery-instagram-type2-inner">
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage25/instagram.png" alt="Indovia" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage25/instagram2.png" alt="Indovia" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage25/instagram3.png" alt="Indovia" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage25/instagram.png" alt="Indovia" /><a href="#">Shop on Instagram</a></div>
                </div>
              </div>
            </section>
