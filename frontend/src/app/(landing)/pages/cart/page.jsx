...
const Cart = () => (
  <>
    <Helmet>
      <title>Cart | Indovia Store</title>
    </Helmet>
    <div className="landing-page-cart">
                  ...
                  <div className="col-lg-7">
                      ...
                      <div className="item-cart">
                        ...
                        <div className="item-cart-info">
                          ...
                          <div className="item-cart-info-2">
                            <p className="body-p2">$24.00</p><a className="btn-remove-cart" href="#"></a>
                          </div>
                        </div>
                      </div>
                      <div className="item-cart">
                    ...
                    <div className="box-coupon">
                      <div className="coupon-left">
                        <input className="form-control input-coupon" type="text" placeholder="Coupon code" />
                        <button className="btn btn-border">Apply</button>
                      </div>
                      <div className="coupon-right"><a className="btn btn-border" href="#">Update Cart</a></div>
                    </div>
                    <div className="box-may-also-like">
                      ...
                      <div className="list-items-also-like">
                        <div className="item-also-like">
                          <div className="item-also-like-image"><img src="/assets/imgs/page/cart/sp3.png" alt="Indovia" /></div>
                          <div className="item-also-like-info">
                            <div className="item-also-like-info-1"><a className="text-16-medium" href="#">Ball Crew Shirt</a>
                              <p className="body-2 neutral-medium-dark mb-8">$35.00</p>
                              <div className="box-color box-size mb-8"><span className="body-p2 neutral-medium-dark">Color:</span>
                                <div className="dropdown">
                                  <button className="btn dropdown-toggle" id="dropdownColor" type="button" data-bs-toggle="dropdown" aria-expanded="false"><span>Black</span></button>
                                  <ul className="dropdown-menu" aria-labelledby="dropdownColor">
                                    <li><a className="dropdown-item" href="#">Black</a></li>
                                    <li><a className="dropdown-item" href="#">Navy</a></li>
                                  </ul>
                                </div>
                              </div>
                              <div className="box-size mb-8"><span className="body-p2 neutral-medium-dark">Size:</span>
                                <div className="dropdown">
                                  <button className="btn dropdown-toggle" id="dropdownSize" type="button" data-bs-toggle="dropdown" aria-expanded="false"><span>M</span></button>
                            ...
                            <div className="item-also-like-info-2">
                              <div className="box-form-cart">
                                <div className="form-cart detail-qty"><span className="minus"></span>
                                  <input className="qty-val form-control" type="text" name="quantity" value="1" min="1" /><span className="plus"></span>
                                </div><a className="btn btn-black-medium" href="#">Add to Cart</a>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="item-also-like">
                          <div className="item-also-like-image"><img src="/assets/imgs/page/cart/sp4.png" alt="Indovia" /></div>
                          <div className="item-also-like-info">
                            <div className="item-also-like-info-1"><a className="text-16-medium" href="#">Ball Crew Shirt</a>
                              <p className="body-2 neutral-medium-dark mb-8">$35.00</p>
                              <div className="box-color box-size mb-8"><span className="body-p2 neutral-medium-dark">Color:</span>
                        ...
                        <div className="item-also-like">
                          <div className="item-also-like-image"><img src="/assets/imgs/page/cart/sp5.png" alt="Indovia" /></div>
                          <div className="item-also-like-info">
                            <div className="item-also-like-info-1"><a className="text-16-medium" href="#">Ball Crew Shirt</a>
                              <p className="body-2 neutral-medium-dark mb-8">$35.00</p>
                              <div className="box-color box-size mb-8"><span className="body-p2 neutral-medium-dark">Color:</span>
                    ...
                    <div className="box-detail-cart">
                      ...
                      <div className="box-info-cart">
                        ...
                        <div className="box-info-cart-inner">
                          <p className="text-17-medium text-uppercase mb-15">Shipping</p>
                          ...
                          <p className="body-p2 neutral-medium-dark mb-12">Shipping options will be updated during checkout.</p><a className="text-17 calculate-shipping" href="#">Calculate shipping</a>
                        </div>
                        ...
                        <div className="box-button-cart"><a className="btn btn-black" href="#">Proceed To Checkout</a></div>
                        <div className="box-other-link"><a className="text-17 link-green" href="#">Free shipping on orders over $200.00</a><a className="text-17" href="#">Continue Shopping</a></div>
                      </div>
                    </div>
                  </div>
                </div>
