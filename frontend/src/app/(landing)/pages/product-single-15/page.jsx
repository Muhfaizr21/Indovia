...
const ProductSingle15 = () => (
  <>
    <Helmet>
      <title>Product Single 15 | Larkon Store</title>
    </Helmet>
                      ...
                      <div className="block-color"><span>Color:</span>
                        ...
                        <div className="list-img-colors">
                          <div className="box-img-colors">
                            <div className="item-img-color"><img src="/assets/imgs/page/product15/img-color.png" alt="Guza" /></div>
                            <div className="item-img-color active"><img src="/assets/imgs/page/product15/img-color2.png" alt="Guza" /></div>
                            <div className="item-img-color"><img src="/assets/imgs/page/product15/img-color3.png" alt="Guza" /></div>
                          </div>
                        </div>
                      </div>
