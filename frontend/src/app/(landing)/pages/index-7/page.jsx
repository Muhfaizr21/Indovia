...
const Index7 = () => (
  <>
    <Helmet>
      <title>Index 7 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-7">
      <header className="header sticky-bar header-type1">
          ...
          <main className="main">
            <section className="section banner-homepage7">
              <div className="box-swiper">
                <div className="swiper-container swiper-banner pb-0">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <div className="box-cover-image"><img src="/assets/imgs/page/homepage7/banner.png" alt="Indovia" /></div>
                      <div className="box-banner-info">
                        <div className="row">
                          <div className="col-sm-6"></div>
                          <div className="col-sm-6">
                            <h2 className="heading-title-medium color-primary-dark mb-12">Find Your Fit</h2>
                            <p className="fonticon-24 mb-30">Elevated, organic cotton basics. Impeccable fit. Compromise-free.</p>
                            <div className="text-start"><a className="btn btn-black" href="#">View Collection</a></div>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="swiper-slide">
                      <div className="box-cover-image"><img src="/assets/imgs/page/homepage7/banner-2.png" alt="Indovia" /></div>
                      <div className="box-banner-info">
                        <div className="row">
                          <div className="col-sm-6"></div>
                          <div className="col-sm-6">
                            <h2 className="heading-title-medium color-primary-dark mb-15">Find Your Fit</h2>
                            <p className="fonticon-24 mb-30">Elevated, organic cotton basics. Impeccable fit. Compromise-free.</p>
                            <div className="text-start"><a className="btn btn-black" href="#">View Collection</a></div>
                          </div>
                        </div>
            ...
            <section className="section box-bestseller-home7">
              <div className="container"> 
                <div className="box-title-between">
                  <div className="box-title-main"> 
                    <h3 className="wow fadeInUp">Bestsellers</h3>
                  </div>
                  <div className="box-link wow fadeInDown"><a className="link-underline" href="#">View All Products</a></div>
                </div>
                <div className="row"> 
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProductStyle2 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage7/product1.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage7/product2.png" alt="Indovia" /></a>
                      ...
                      <div className="cardInfo"><a href="#">
                          <h6 className="cardTitle">Lace Shirt Cut II</h6></a>
                        <p className="link-l2 cardDesc">$24.00</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProductStyle2 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage7/product2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage7/product1.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProductStyle2 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage7/product3.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage7/product4.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProductStyle2 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage7/product4.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage7/product3.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProductStyle2 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage7/product5.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage7/product6.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProductStyle2 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage7/product6.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage7/product5.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProductStyle2 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage7/product7.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage7/product8.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProductStyle2 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage7/product8.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage7/product7.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
            ...
            <section className="section box-category-home7">
              <div className="container">
                <div className="row">
                  <div className="col-lg-6">
                    <div className="cardFeature text-center wow fadeInUp">
                      <div className="cardImage"><img src="/assets/imgs/page/homepage7/bg-under.png" alt="Indovia" /></div>
                      <div className="cardInfo justify-content-center">
                  ...
                  <div className="col-lg-6">
                    <div className="cardCategoryText bg-1 wow fadeInUp">
                      <div className="cardInfo"><a href="#">Undies</a></div>
                    </div>
                    <div className="cardCategoryText bg-2 wow fadeInUp">
                      <div className="cardInfo"><a href="#">Bralettes</a></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section className="section block-icon-box"> 
              <div className="container"> 
                <div className="text-center"> 
                  <h6 className="text-17-medium primary-navy text-uppercase mb-15 wow fadeInLeft">Our quality promise</h6>
                  <h3 className="mb-65 wow fadeInRight">We Developed Products We Need</h3>
                </div>
                <div className="row"> 
                  <div className="col-lg-4 hasborder"> 
                    <div className="cardIcon wow fadeInUp">
                      <div className="cardImage"><img src="/assets/imgs/page/homepage7/simplicity.svg" alt="Indovia" /></div>
                      <div className="cardInfo">
                        <h6 className="cardTitle">Shipping Worldwide</h6>
                  ...
                  <div className="col-lg-4 hasborder"> 
                    <div className="cardIcon wow fadeInUp">
                      <div className="cardImage"><img src="/assets/imgs/page/homepage7/clothes.svg" alt="Indovia" /></div>
                      <div className="cardInfo">
                        <h6 className="cardTitle">60 - Days Returns</h6>
                  ...
                  <div className="col-lg-4"> 
                    <div className="cardIcon wow fadeInUp">
                      <div className="cardImage"><img src="/assets/imgs/page/homepage7/nature.svg" alt="Indovia" /></div>
                      <div className="cardInfo">
                        <h6 className="cardTitle">Security Payment</h6>
            ...
            <section className="section block-instagram-type4-home7">
              ...
              <div className="box-gallery-instagram"> 
                <div className="gallery-item wow fadeInLeft"><img src="/assets/imgs/page/homepage7/under.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage7/under2.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage7/under3.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage7/under4.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInRight"><img src="/assets/imgs/page/homepage7/under5.png" alt="Indovia" /></div>
              </div>
            </section>
