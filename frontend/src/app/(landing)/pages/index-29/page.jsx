...
const Index29 = () => (
  <>
    <Helmet>
      <title>Index 29 | Larkon Store</title>
    </Helmet>
      ...
      <header className="header sticky-bar header-type1">
          ...
          <main className="main">
                      ...
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage29/diamond.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage29/diamond.png" alt="guza" /></a>
                        ...
                        <div className="swiper-slide">
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage29/diamond2.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage29/diamond2.png" alt="guza" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                        ...
                        <div className="swiper-slide">
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage29/diamond3.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage29/diamond3.png" alt="guza" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                        ...
                        <div className="swiper-slide">
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage29/diamond4.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage29/diamond4.png" alt="guza" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
            ...
            <section className="section block-earings-collection block-padding-80"> 
              <div className="container"> 
                <div className="row"> 
                  <div className="col-md-6 mb-30"><img className="mw-500" src="/assets/imgs/page/homepage29/left-image.png" alt="guza" /></div>
                    ...
                    <div className="text-center"> 
                      ...
                      <div className="row mt-30"> 
                        <div className="col-sm-6">
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage29/sp-earing.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage29/sp-earing.png" alt="guza" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                        ...
                        <div className="col-sm-6">
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage29/sp-earing2.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage29/sp-earing2.png" alt="guza" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
              ...
              <div className="container"> 
                <div className="row align-items-center">
                  <div className="col-lg-8 mb-40 position-relative">
                    <div className="mw-470"><img src="/assets/imgs/page/homepage29/img-why.png" alt="guza" />
                      <div className="box-image-video"> <img src="/assets/imgs/page/homepage29/img-why2.png" alt="guza" /><a className="btn btn-play-center" href=""><img src="/assets/imgs/page/homepage29/play.svg" alt="guza" /></a></div>
                    </div>
                  </div>
            ...
            <section className="section block-instagram-type-4 block-instagram-type-2">
              ...
              <div className="box-gallery-instagram box-gallery-instagram-type2 mt-40 wow fadeInDown"> 
                <div className="box-gallery-instagram-type2-inner">
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage29/inst2.png" alt="Guza" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage29/inst.png" alt="Guza" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage29/inst2.png" alt="Guza" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage29/inst3.png" alt="Guza" /><a href="#">Shop on Instagram</a></div>
                </div>
              </div>
            </section>
          </main>
            ...
            <div className="footer-2">
              <div className="container">
                <div className="footer-bottom">
                  <div className="row align-items-center">
                    <div className="col-lg-6 col-md-12 text-center text-lg-start mb-20"><img className="mr-25 d-inline-block align-middle" src="/assets/imgs/template/logo.svg" alt="Guza" /><span className="body-p1 color-white d-inline-block align-middle">© 2023 Guza.Co. All rights reserved</span></div>
                    <div className="col-lg-6 col-md-12 text-center text-lg-end mb-20">
                      <div className="d-flex justify-content-center justify-content-lg-end align-items-center box-all-payments">
                        <div className="d-inline-block box-payments mr-20"><img src="/assets/imgs/template/icons/visa-grey.svg" alt="Guza" /><img src="/assets/imgs/template/icons/master-grey.svg" alt="Guza" /><img src="/assets/imgs/template/icons/stripe-grey.svg" alt="Guza" /><img src="/assets/imgs/template/icons/paypal-grey.svg" alt="Guza" /></div>
