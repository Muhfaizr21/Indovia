...
const Index21 = () => (
  <>
    <Helmet>
      <title>Index 21 | Larkon Store</title>
    </Helmet>
                      ...
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
                          <div className="row align-items-end"> 
                            ...
                            <div className="col-lg-7"><img src="/assets/imgs/page/homepage21/banner.png" alt="Guza" /></div>
                          </div>
                        </div>
                        <div className="swiper-slide">
                          <div className="row align-items-end"> 
                ...
                <div className="row"> 
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="card-categories"> 
                      <div className="card-image"><a href="#"><img className="bdrd-16" src="/assets/imgs/page/homepage21/cat.png" alt="Guza" /></a></div>
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="card-categories"> 
                      <div className="card-image"><a href="#"><img className="bdrd-16" src="/assets/imgs/page/homepage21/cat2.png" alt="Guza" /></a></div>
                      <div className="card-info"> <a href="#">
                          <h5>Infants</h5></a></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="card-categories"> 
                      <div className="card-image"><a href="#"><img className="bdrd-16" src="/assets/imgs/page/homepage21/cat3.png" alt="Guza" /></a></div>
                      <div className="card-info"> <a href="#">
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="card-categories"> 
                      <div className="card-image"><a href="#"><img className="bdrd-16" src="/assets/imgs/page/homepage21/cat4.png" alt="Guza" /></a></div>
                      <div className="card-info"> <a href="#">
                          <h5>Parents</h5></a></div>
                    </div>
                  </div>
                        ...
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <div className="card-categories-slide">
                              <div className="card-image"> <img className="imageMain" src="/assets/imgs/page/homepage21/cat5.png" alt="guza" /></div>
                              <div className="card-info"> <a href="#">
                                  <h5>Layers</h5></a></div>
                            </div>
                          </div>
                          <div className="swiper-slide">
                            <div className="card-categories-slide">
                              <div className="card-image"> <img className="imageMain" src="/assets/imgs/page/homepage21/cat6.png" alt="guza" /></div>
                              <div className="card-info"> <a href="#">
                                  <h5>Clothes</h5></a></div>
                            </div>
                          </div>
                          <div className="swiper-slide">
                            <div className="card-categories-slide">
                              <div className="card-image"> <img className="imageMain" src="/assets/imgs/page/homepage21/cat7.png" alt="guza" /></div>
                              <div className="card-info"> <a href="#">
                                  <h5>Bedding</h5></a></div>
                            </div>
                          </div>
                          <div className="swiper-slide">
                            <div className="card-categories-slide">
                              <div className="card-image"> <img className="imageMain" src="/assets/imgs/page/homepage21/cat8.png" alt="guza" /></div>
                              <div className="card-info"> <a href="#">
                          ...
                          <div className="swiper-slide">
                            <div className="card-categories-slide">
                              <div className="card-image"> <img className="imageMain" src="/assets/imgs/page/homepage21/cat9.png" alt="guza" /></div>
                              <div className="card-info"> <a href="#">
                                  <h5>Toys</h5></a></div>
                            </div>
                          </div>
                        ...
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage21/sp.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage21/sp.png" alt="guza" /></a>
                          ...
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage21/sp2.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage21/sp2.png" alt="guza" /></a>
                                <div className="button-select"><a href="#">Select Options</a></div>
                                <div className="box-quick-button"><a className="btn" href="#">
                                    <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                      <g clipPath="url(#clip0_116_452)">
                          ...
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage21/sp3.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage21/sp3.png" alt="guza" /></a>
                                <div className="button-select"><a href="#">Select Options</a></div>
                                <div className="box-quick-button"><a className="btn" href="#">
                                    <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                      <g clipPath="url(#clip0_116_452)">
                          ...
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage21/sp4.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage21/sp4.png" alt="guza" /></a>
                                <div className="button-select"><a href="#">Select Options</a></div>
                                <div className="box-quick-button"><a className="btn" href="#">
                                    <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                      <g clipPath="url(#clip0_116_452)">
