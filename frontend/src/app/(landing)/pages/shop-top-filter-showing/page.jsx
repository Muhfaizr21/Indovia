...
const ShopTopFilterShowing = () => (
  <>
    <Helmet>
      <title>Shop Top Filter Showing | Indovia Store</title>
    </Helmet>
    <div className="landing-page-shop-top-filter-showing">
...
export default ShopTopFilterShowing;
