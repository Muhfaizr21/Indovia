...
const ProductSingle2 = () => (
  <>
    <Helmet>
      <title>Product Single 2 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-product-single-2">
                  ...
                  <div className="col-lg-6">
                    <div className="detail-gallery detail-gallery-2">
                      <div className="box-main-gallery"><a className="zoom-image glightbox" href="/assets/imgs/page/product/img.png"></a>
                        <div className="product-image-slider product-image-slider-2">
                      ...
                      <div className="slider-nav-thumbnails slider-nav-thumbnails-2">
                        <div>
