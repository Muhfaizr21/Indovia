...
const Index10 = () => (
  <>
    <Helmet>
      <title>Index 10 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-10">
      <header className="header sticky-bar header-style-3">
          ...
          <main className="main">
            <section className="section banner-homepage10">
              <div className="row align-items-center"> 
                <div className="col-md-6"><img src="/assets/imgs/page/homepage10/banner.jpg" alt="Indovia" /></div>
                <div className="col-md-6">
                  <div className="box-banner-info-home10">
                    <h1 className="text-56-bold mb-10">Join us at the table</h1>
                    <h5 className="mb-30">Elevated, organic cotton basics. <br className="d-none d-lg-block" />Impeccable fit. Compromise-free.</h5><a className="btn btn-black" href="#">View Collection</a>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-cat-homepage10">
              <div className="container"> 
                <div className="text-center"> 
                  <h3 className="mb-40 wow fadeInUp">Featured Collection</h3>
                </div>
                <div className="row"> 
                  <div className="col-lg-4"> 
                    <div className="cardCatImageText wow fadeInUp">
                      <div className="cardImage"> <img src="/assets/imgs/page/homepage10/cat.jpg" alt="Indovia" /></div>
                      <div className="cardInfo"> 
                        <div className="cardInfoInner">
                          <h2 className="text-28-bold mb-10">The Kitchen</h2>
                          <p className="text-17 neutral-medium-dark mb-30">Shop our favorite décor and furniture pieces for your southern home.</p><a className="btn btn-border-medium" href="#">Shop Now</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-4"> 
                    <div className="cardCatImageText wow fadeInUp">
                      <div className="cardImage"> <img src="/assets/imgs/page/homepage10/cat2.jpg" alt="Indovia" /></div>
                      <div className="cardInfo"> 
                        <div className="cardInfoInner">
                          <h2 className="text-28-bold mb-10">The Hallway</h2>
                          <p className="text-17 neutral-medium-dark mb-30">Shop our favorite décor and furniture pieces for your southern home.</p><a className="btn btn-border-medium" href="#">Shop Now</a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="col-lg-4"> 
                    <div className="cardCatImageText wow fadeInUp">
                      <div className="cardImage"> <img src="/assets/imgs/page/homepage10/cat3.jpg" alt="Indovia" /></div>
                      <div className="cardInfo"> 
                        <div className="cardInfoInner">
                          <h2 className="text-28-bold mb-10">The Living Room</h2>
                          <p className="text-17 neutral-medium-dark mb-30">Shop our favorite décor and furniture pieces for your southern home.</p><a className="btn btn-border-medium" href="#">Shop Now</a>
                        </div>
                      </div>
                    </div>
            ...
            <section className="section block-new-product">
              <div className="container"> 
                <div className="row align-items-center">
                  <div className="col-lg-4">
                    <div className="text-center text-lg-start">
                      <h2 className="text-46-semibold wow fadeInUp">The Home</h2>
                    </div>
                  </div>
                  <div className="col-lg-8">
                    <div className="box-tabs mt-0 mb-0 text-end wow fadeInDown"> 
                      <ul className="nav nav-tabs nav-tabs-small justify-content-end" role="tablist">
                        <li className="nav-item" role="presentation">
                          <button className="nav-link active" id="bedroom-tab" data-bs-toggle="tab" data-bs-target="#bedroom" type="button" role="tab" aria-controls="bedroom" aria-selected="true" data-index="1" data-items="3">The Bedroom</button>
                        </li>
                        <li className="nav-item" role="presentation">
                          <button className="nav-link" id="hallway-tab" data-bs-toggle="tab" data-bs-target="#hallway" type="button" role="tab" aria-controls="hallway" aria-selected="false" data-index="2" data-items="3">The Hallway</button>
                        </li>
                        <li className="nav-item" role="presentation">
                          <button className="nav-link" id="livingroom-tab" data-bs-toggle="tab" data-bs-target="#livingroom" type="button" role="tab" aria-controls="livingroom" aria-selected="false" data-index="3" data-items="3">The Living Room</button>
                        </li>
                        <li className="nav-item" role="presentation">
                          <button className="nav-link" id="kitchen-tab" data-bs-toggle="tab" data-bs-target="#kitchen" type="button" role="tab" aria-controls="kitchen" aria-selected="false" data-index="4" data-items="3">The Kitchen</button>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div className="mt-40 box-button-leftright"> 
                  <div className="tab-content">
                    <div className="tab-pane fade show active" id="bedroom" role="tabpanel" aria-labelledby="bedroom-tab">
                      <div className="box-swiper">                            
                        <div className="swiper-container swiper-tab-1 pb-0">
                          <div className="swiper-wrapper">
                            <div className="swiper-slide">
                              <div className="cardProductStyle3 wow fadeInUp">
                                <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage10/peach.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage10/peach2.png" alt="Indovia" /></a>
                            ...
                            <div className="swiper-slide">
                              <div className="cardProductStyle3 wow fadeInUp">
                                <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage10/peach2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage10/peach3.png" alt="Indovia" /></a>
                                  <div className="button-select"><a href="#">Select Options</a></div>
                                  <div className="box-quick-button"><a className="btn" href="#">
                                      <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_116_452)">
                            ...
                            <div className="swiper-slide">
                              <div className="cardProductStyle3 wow fadeInUp">
                                <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage10/peach3.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage10/peach.png" alt="Indovia" /></a>
                                  <div className="button-select"><a href="#">Select Options</a></div>
                                  <div className="box-quick-button"><a className="btn" href="#">
                                      <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_116_452)">
                    ...
                    <div className="tab-pane fade" id="hallway" role="tabpanel" aria-labelledby="hallway-tab"> 
                      <div className="box-swiper"> 
                    ...
                    <div className="tab-pane fade" id="livingroom" role="tabpanel" aria-labelledby="livingroom-tab"> 
                      <div className="box-swiper"> 
                    ...
                    <div className="tab-pane fade" id="kitchen" role="tabpanel" aria-labelledby="kitchen-tab"> 
                      <div className="box-swiper"> 
            ...
            <section className="section block-collection-homepage10">
              <div className="container"> 
                <div className="row align-items-center"> 
                  <div className="col-lg-7">
                    <div className="box-slide-collection">
                      <div className="text-center"> 
                        <h2 className="text-46-semibold mb-35 wow fadeInUp">New Collections</h2>
                      </div>
                          ...
                          <div className="swiper-wrapper">
                            <div className="swiper-slide">
                              <div className="cardProductSmall wow fadeInUp">
                                <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage10/collection.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage10/collection2.png" alt="Indovia" /></a>
                                  <div className="button-select"><a href="#">Select Options</a></div>
                                  <div className="box-quick-button"><a className="btn" href="#">
                                      <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_116_452)">
                            ...
                            <div className="swiper-slide">
                              <div className="cardProductSmall wow fadeInUp">
                                <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage10/collection2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage10/collection.png" alt="Indovia" /></a>
                                  <div className="button-select"><a href="#">Select Options</a></div>
                                  <div className="box-quick-button"><a className="btn" href="#">
                                      <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-5">
                    <div className="text-center wow fadeInDown"> <img src="/assets/imgs/page/homepage10/collection2.png" alt="Indovia" /></div>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-instagram-type4-home7">
              ...
              <div className="box-gallery-instagram"> 
                <div className="gallery-item wow fadeInLeft"><img src="/assets/imgs/page/homepage10/insta.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage10/insta2.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage10/insta3.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage10/insta4.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInRight"><img src="/assets/imgs/page/homepage10/insta5.png" alt="Indovia" /></div>
              </div>
            </section>
