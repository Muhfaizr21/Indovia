...
const Index23 = () => (
  <>
    <Helmet>
      <title>Index 23 | Larkon Store</title>
    </Helmet>
      ...
      <header className="header sticky-bar header-style-3">
          ...
          <main className="main">
                        ...
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage23/sp.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage23/sp.png" alt="guza" /></a>
                          ...
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage23/sp2.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage23/sp.png" alt="guza" /></a>
                                <div className="button-select"><a href="#">Select Options</a></div>
                                <div className="box-quick-button"><a className="btn" href="#">
                                    <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                      <g clipPath="url(#clip0_116_452)">
                          ...
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage23/sp3.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage23/sp.png" alt="guza" /></a>
                                <div className="button-select"><a href="#">Select Options</a></div>
                                <div className="box-quick-button"><a className="btn" href="#">
                                    <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                      <g clipPath="url(#clip0_116_452)">
                          ...
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage23/sp4.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage23/sp.png" alt="guza" /></a>
                                <div className="button-select"><a href="#">Select Options</a></div>
                                <div className="box-quick-button"><a className="btn" href="#">
                                    <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                      <g clipPath="url(#clip0_116_452)">
                          ...
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage23/sp5.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage23/sp.png" alt="guza" /></a>
                                <div className="button-select"><a href="#">Select Options</a></div>
                                <div className="box-quick-button"><a className="btn" href="#">
                                    <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                      <g clipPath="url(#clip0_116_452)">
                ...
                <div className="row">
                  <div className="col-md-4">
                    <div className="cardBlog wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage23/news.png" alt="guza" /></a></div>
                      <div className="cardInfo">
                  ...
                  <div className="col-md-4">
                    <div className="cardBlog wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage23/news2.png" alt="guza" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet from anywhere between 1991 and 2005...</p><a className="link-underline link-l2" href="#">Read More</a>
                  ...
                  <div className="col-md-4">
                    <div className="cardBlog wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage23/news3.png" alt="guza" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet from anywhere between 1991 and 2005...</p><a className="link-underline link-l2" href="#">Read More</a>
            ...
            <section className="section block-instagram-type4-home7">
              ...
              <div className="box-gallery-instagram"> 
                <div className="gallery-item wow fadeInLeft"><img src="/assets/imgs/page/homepage23/insta.png" alt="Guza" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage23/insta2.png" alt="Guza" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage23/insta3.png" alt="Guza" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage23/insta4.png" alt="Guza" /></div>
                <div className="gallery-item wow fadeInRight"><img src="/assets/imgs/page/homepage23/insta5.png" alt="Guza" /></div>
              </div>
            </section>
          ...
          <footer className="footer footer-type2-light footer-white">
            <div className="footer-1">
              <div className="container">
                <div className="row">
                  <div className="col-lg-6 col-md-12 text-center text-lg-start"><a className="logo-footer" href="#"><img alt="luxride" src="/assets/imgs/template/logo.svg" /></a>
            ...
            <div className="footer-2">
              <div className="container">
                <div className="footer-bottom">
                  <div className="row align-items-center">
                    <div className="col-lg-6 col-md-12 text-center text-lg-start mb-20"><span className="body-p1 neutral-medium-dark">© 2023 Guza.Co. All rights reserved</span></div>
                    <div className="col-lg-6 col-md-12 text-center text-lg-end mb-20">
