...
const Checkout = () => (
  <>
    <Helmet>
      <title>Checkout | Indovia Store</title>
    </Helmet>
    <div className="landing-page-checkout">
                  ...
                  <div className="row mt-20"> 
                    <div className="col-lg-6">
                      <div className="box-customer-login">
                         Returning customer? <a href="#">Click here to login</a></div>
                      <div className="box-gift-coupon">
                         Have a coupon?  <a href="#">Click here to enter your code</a></div>
                      ...
                      <div className="box-form-checkout form-comment"> 
                        <div className="form-group"> 
                          ...
                          <label className="mt-12">
                            <input className="cb-left" type="checkbox" />Email me with news and offers 
                          </label>
                        </div>
                        ...
                        <div className="row"> 
                          ...
                          <div className="col-lg-12"> 
                            <div className="form-group"> 
                              <label className="form-label" htmlFor="region">Country / Region *</label>
                              <input className="form-control" id="region" type="text" value="United Kingdoom (UK)" />
                            </div>
                          </div>
                          <div className="col-lg-12"> 
                            <div className="form-group"> 
                          ...
                          <div className="col-lg-12"> 
                            <div className="form-group"> 
                              <label className="form-label" htmlFor="apartment">Apartment, suite, unit, etc. (optional)</label>
                              <input className="form-control" id="apartment" type="text" />
                            </div>
                          </div>
                          <div className="col-lg-12"> 
                            <div className="form-group"> 
                              <label className="form-label" htmlFor="towncity">Town / City *</label>
                              <input className="form-control" id="towncity" type="text" />
                            </div>
                          </div>
                          <div className="col-lg-12"> 
                            <div className="form-group"> 
                          ...
                          <div className="col-lg-12"> 
                            <div className="form-group"> 
                              ...
                              <input className="form-control" id="postcode" type="text" />
                            </div>
                          </div>
                          <div className="col-lg-12"> 
                            <div className="form-group"> 
                          ...
                          <div className="col-lg-12"> 
                            <div className="form-group"> 
                              <label>
                                <input className="cb-left" type="checkbox" />Create an account? 
                              </label>
                            </div>
                          </div>
                          <div className="col-lg-12"> 
                            <div className="form-group"> 
                              <label> 
                                <input className="cb-left" type="checkbox" />Ship to a different address?
                              </label>
                            </div>
                          </div>
                          <div className="col-lg-12"> 
                            <div className="form-group"> 
                              <label className="form-label" htmlFor="ordernote">Order Note (optional)</label>
                              <textarea className="form-control" id="ordernote" rows="6"></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="box-detail-cart">
                        ...
                        <div className="box-info-cart"> 
                            ...
                            <div className="list-items-cart"> 
                              <div className="item-cart"> 
                                ...
                                <div className="item-cart-info">
                                  <div className="item-cart-info-1"> <a className="text-17-medium" href="#">Ball Crew Shirt - x1</a>
                          ...
                          <div className="box-info-cart-inner">
                            <p className="text-17-medium text-uppercase mb-15 neutral-medium-dark">Shipping</p>
                            <div className="list-radio"> 
                              <div className="item-radio">
                                <label>
                                  <input type="radio" name="shipping" checked="checked" />Flat rate: $50.00
                                </label><span className="price-ship">$50.00</span>
                              </div>
                              <div className="item-radio">
                                <label>
                          ...
                          <div className="box-other-link text-start box-border-bottom"> <span className="text-17 link-green">Free shipping on orders over $200.00</span><a className="text-17" href="#">Continue Shopping</a></div>
                          <div className="box-payment-method"> 
                            <p className="text-17-medium text-uppercase mb-15 neutral-medium-dark">Shipping</p>
                            <div className="list-radio"> 
                              <div className="item-radio">
                                <label>
                                  <input type="radio" name="payment" checked="checked" />Direct bank transfer
                                </label>
                                <p className="body-p2 neutral-medium-dark extra-info active">Please send a check to Store Name, Store Street, Store Town, Store State / County, Store Postcode.</p>
                              </div>
                              <div className="item-radio">
                                <label>
                                  <input type="radio" name="payment" />Cash on delivery
                                </label>
                                <p className="body-p2 neutral-medium-dark extra-info">Please send a check to Store Name, Store Street, Store Town, Store State / County, Store Postcode.</p>
                              </div>
                              <div className="item-radio">
                                <label>
                                  <input type="radio" name="payment" />Credit Card (Stripe)
                                </label>
                                <p className="body-p2 neutral-medium-dark extra-info">Please send a check to Store Name, Store Street, Store Town, Store State / County, Store Postcode.</p>
                              </div>
                              <div className="item-radio">
                          ...
                          <div className="box-desc-checkout"> 
                            <p className="body-p2 neutral-medium-dark mb-20">Your personal data will be used to process your order, support your experience throughout this website, and for other purposes described in our privacy policy.</p>
                            <div className="form-group"> 
                              <label>
                                <input className="cb-left" type="checkbox" />I agree to the website <a href="#">terms and conditions *</a>
                              </label>
                            </div>
                          </div>
                          <div className="box-button-checkout"> <a className="btn btn-black" href="#">Place Order</a></div>
                        </div>
                      </div>
                    </div>
                  </div>
