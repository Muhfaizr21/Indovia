...
const Contact = () => (
  <>
    <Helmet>
      <title>Contact | Indovia Store</title>
    </Helmet>
          ...
          <main className="main">
            <section className="section banner-500">
              ...
              <div className="box-banner-info wow fadeInUp"> 
                <p className="overline-t2-medium text-uppercase primary-navy mb-10">NEED HELP?</p>
                <h2 className="color-primary-dark mb-30">Haven’t found what <br className="d-none d-lg-block" />you’re looking for? <br className="d-none d-lg-block" />Contact us</h2>
              </div>
            </section>
            <div className="section block-maps"> 
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d25958.466260663557!2d-81.44280595924573!3d35.58312354977769!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8856d2948d052daf%3A0xe3fa19c20612b365!2zTkMtMTAgSHd5LCBOZXd0b24sIE5DLCBIb2EgS-G7sw!5e0!3m2!1svi!2s!4v1683730972471!5m2!1svi!2s" width="100%" height="550" style={{border: "0"}} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
            </div>
            <section className="section block-form-contact">
              <div className="container"> 
                <div className="row"> 
                  <div className="col-lg-5 mb-40 wow fadeInUp"> 
                    <h4>Address</h4>
                    <p className="body-p2 neutral-medium-dark mb-45">8425 Melrose Ave, Los Angeles, CA 90069</p>
                    <h4 className="mb-20">Contact</h4>
                    <p className="body-p2 neutral-medium-dark mb-10">Phone.  +1 970 429 4170</p>
                    <p className="body-p2 neutral-medium-dark mb-45">Email.  hello@uxper.co</p>
                    <h4 className="mb-15">Hour of Operation</h4>
                    <p className="body-p2 neutral-medium-dark mb-45">Mon - Fri: 08:30 - 20:00<br />Sat & Sun: 09:30 - 21:30</p>
                    <div className="socials mt-55 justify-content-start"><a className="ml-0" href="#"><img src="/assets/imgs/page/about1/fb.svg" alt="Indovia" /></a><a href="#"><img src="/assets/imgs/page/about1/insta.svg" alt="Indovia" /></a></div>
                  </div>
                  <div className="col-lg-7 mb-40 wow fadeInUp"> 
                    <h4 className="mb-10">Get in Touch</h4>
                    <p className="text-16-medium neutral-medium mb-30">Your email address will not be published. Required fields are marked *</p>
                    <div className="row"> 
                      ...
                      <div className="col-lg-12"> 
                        <div className="form-group"> 
                          <textarea className="form-control" placeholder="Contents" rows="6"></textarea>
                        </div>
                      </div>
                      <div className="col-lg-12"> 
