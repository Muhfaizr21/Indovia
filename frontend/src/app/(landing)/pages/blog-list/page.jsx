...
const BlogList = () => (
  <>
    <Helmet>
      <title>Blog List | Indovia Store</title>
    </Helmet>
    <div className="landing-page-blog-list">
                ...
                <div className="row">
                  <div className="col-lg-9">
                    <div className="cardBlog cardBlogList wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/blog-list/img1.png" alt="Indovia" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post text-uppercase">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                    ...
                    <div className="cardBlog cardBlogList wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/blog-list/img2.png" alt="Indovia" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post text-uppercase">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet</p><a className="link-underline link-l2" href="#">Read More</a>
                    ...
                    <div className="cardBlog cardBlogList wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/blog-list/img3.png" alt="Indovia" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post text-uppercase">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet</p><a className="link-underline link-l2" href="#">Read More</a>
                    ...
                    <div className="cardBlog cardBlogList wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/blog-list/img4.png" alt="Indovia" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post text-uppercase">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet</p><a className="link-underline link-l2" href="#">Read More</a>
                    ...
                    <div className="cardBlog cardBlogList wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/blog-list/img5.png" alt="Indovia" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post text-uppercase">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet</p><a className="link-underline link-l2" href="#">Read More</a>
                    ...
                    <div className="cardBlog cardBlogList wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/blog-list/img6.png" alt="Indovia" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post text-uppercase">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet</p><a className="link-underline link-l2" href="#">Read More</a>
                    ...
                    <div className="sidebar-right">
                      ...
                      <div className="block-sidebar">
                        ...
                        <ul className="list-latest-posts">
                          <li>
                            <div className="image-post"><a href="#"><img src="/assets/imgs/page/blog-list/post.png" alt="" /></a></div>
                            <div className="info-post"><span className="date-post text-uppercase">13 Dec, 2022</span><a href="#">
                                <h5 className="title-post">Milan Highlights Summer 2020</h5></a></div>
                          </li>
                          <li>
                            <div className="image-post"><a href="#"><img src="/assets/imgs/page/blog-list/post2.png" alt="" /></a></div>
                            <div className="info-post"><span className="date-post text-uppercase">13 Dec, 2022</span><a href="#">
                                <h5 className="title-post">Milan Highlights Summer 2020</h5></a></div>
                          </li>
                          <li>
                            <div className="image-post"><a href="#"><img src="/assets/imgs/page/blog-list/post3.png" alt="" /></a></div>
                            <div className="info-post"><span className="date-post text-uppercase">13 Dec, 2022</span><a href="#">
                                <h5 className="title-post">Milan Highlights Summer 2020</h5></a></div>
                          </li>
                        </ul>
                      ...
                      <div className="block-sidebar">
                        ...
                        <div className="box-tags"><a className="btn btn-tag-filter" href="#">Accessories</a><a className="btn btn-tag-filter" href="#">Beauty</a><a className="btn btn-tag-filter" href="#">Hats</a><a className="btn btn-tag-filter" href="#">Collection</a><a className="btn btn-tag-filter" href="#">Makeup</a><a className="btn btn-tag-filter" href="#">Jacket</a><a className="btn btn-tag-filter" href="#">Vintage</a><a className="btn btn-tag-filter" href="#">Life Style</a></div>
                      </div>
                      <div className="block-sidebar"><img src="/assets/imgs/page/blog-list/sale.png" alt="" /></div>
                    </div>
                  </div>
                </div>
              </div>
