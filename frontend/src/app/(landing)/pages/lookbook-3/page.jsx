...
const Lookbook3 = () => (
  <>
    <Helmet>
      <title>Lookbook 3 | Larkon Store</title>
    </Helmet>
            ...
            <section className="section block-content-lookbook">
              <div className="container">
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-6 mb-120"><img className="w-100" src="/assets/imgs/page/lookbook3/img.png" alt="Guza" /></div>
                </div>
                <div className="row align-items-center">
                  <div className="col-lg-6 mb-120"><img className="w-100" src="/assets/imgs/page/lookbook3/img2.png" alt="Guza" /></div>
                  <div className="col-lg-6 mb-120">
                    <div className="box-lookbook3-info">
                      <h2 className="mb-10">Winter 2023</h2>
                      <p className="text-24 mb-30">Shop and discover the world’s<br className="d-none d-lg-block" />most stylish brands.</p><a className="btn btn-border" href="">Discover</a>
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-6 mb-120"><img className="w-100" src="/assets/imgs/page/lookbook3/img3.jpg" alt="Guza" /></div>
                </div>
                <div className="row align-items-center">
                  <div className="col-lg-6 mb-120"><img className="w-100" src="/assets/imgs/page/lookbook3/img4.jpg" alt="Guza" /></div>
                  <div className="col-lg-6 mb-120">
                    <div className="box-lookbook3-info">
                      <h2 className="mb-10">Winter 2023</h2>
                      <p className="text-24 mb-30">Shop and discover the world’s<br className="d-none d-lg-block" />most stylish brands.</p><a className="btn btn-border" href="">Discover</a>
