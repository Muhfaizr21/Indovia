...
const Index10 = () => (
  <>
    <Helmet>
      <title>Index 10 | Larkon Store</title>
    </Helmet>
          ...
          <main className="main">
            <section className="section banner-homepage10">
              <div className="row align-items-center"> 
                <div className="col-md-6"><img src="/assets/imgs/page/homepage10/banner.jpg" alt="Guza" /></div>
                ...
                <div className="row"> 
                  <div className="col-lg-4"> 
                    <div className="cardCatImageText wow fadeInUp">
                      <div className="cardImage"> <img src="/assets/imgs/page/homepage10/cat.jpg" alt="Guza" /></div>
                  ...
                  <div className="col-lg-4"> 
                    <div className="cardCatImageText wow fadeInUp">
                      <div className="cardImage"> <img src="/assets/imgs/page/homepage10/cat2.jpg" alt="Guza" /></div>
                      <div className="cardInfo"> 
                        <div className="cardInfoInner">
                  ...
                  <div className="col-lg-4"> 
                    <div className="cardCatImageText wow fadeInUp">
                      <div className="cardImage"> <img src="/assets/imgs/page/homepage10/cat3.jpg" alt="Guza" /></div>
                      <div className="cardInfo"> 
                        <div className="cardInfoInner">
                          ...
                          <div className="swiper-wrapper">
                            <div className="swiper-slide">
                              <div className="cardProductStyle3 wow fadeInUp">
                                <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage10/peach.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage10/peach2.png" alt="guza" /></a>
                            ...
                            <div className="swiper-slide">
                              <div className="cardProductStyle3 wow fadeInUp">
                                <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage10/peach2.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage10/peach3.png" alt="guza" /></a>
                                  <div className="button-select"><a href="#">Select Options</a></div>
                                  <div className="box-quick-button"><a className="btn" href="#">
                                      <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_116_452)">
                            ...
                            <div className="swiper-slide">
                              <div className="cardProductStyle3 wow fadeInUp">
                                <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage10/peach3.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage10/peach.png" alt="guza" /></a>
                                  <div className="button-select"><a href="#">Select Options</a></div>
                                  <div className="box-quick-button"><a className="btn" href="#">
                                      <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_116_452)">
              ...
              <div className="container"> 
                <div className="row align-items-center"> 
                          ...
                          <div className="swiper-wrapper">
                            <div className="swiper-slide">
                              <div className="cardProductSmall wow fadeInUp">
                                <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage10/collection.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage10/collection2.png" alt="guza" /></a>
                                  <div className="button-select"><a href="#">Select Options</a></div>
                                  <div className="box-quick-button"><a className="btn" href="#">
                                      <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_116_452)">
                            ...
                            <div className="swiper-slide">
                              <div className="cardProductSmall wow fadeInUp">
                                <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage10/collection2.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage10/collection.png" alt="guza" /></a>
                                  <div className="button-select"><a href="#">Select Options</a></div>
                                  <div className="box-quick-button"><a className="btn" href="#">
                                      <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-5">
                    <div className="text-center wow fadeInDown"> <img src="/assets/imgs/page/homepage10/collection2.png" alt="Guza" /></div>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-instagram-type4-home7">
              ...
              <div className="box-gallery-instagram"> 
                <div className="gallery-item wow fadeInLeft"><img src="/assets/imgs/page/homepage10/insta.png" alt="Guza" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage10/insta2.png" alt="Guza" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage10/insta3.png" alt="Guza" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage10/insta4.png" alt="Guza" /></div>
                <div className="gallery-item wow fadeInRight"><img src="/assets/imgs/page/homepage10/insta5.png" alt="Guza" /></div>
              </div>
            </section>
