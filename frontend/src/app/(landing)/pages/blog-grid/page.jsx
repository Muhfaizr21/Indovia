...
const BlogGrid = () => (
  <>
    <Helmet>
      <title>Blog Grid | Indovia Store</title>
    </Helmet>
            ...
            <section className="section block-blog-list">
              <div className="container">
                ...
                <div className="row wow fadeInUp">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="cardBlog wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/blog/img1.png" alt="Indovia" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet</p><a className="link-underline link-l2" href="#">Read More</a>
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="cardBlog wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/blog/img2.png" alt="Indovia" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet</p><a className="link-underline link-l2" href="#">Read More</a>
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="cardBlog wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/blog/img3.png" alt="Indovia" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet</p><a className="link-underline link-l2" href="#">Read More</a>
