...
const Index3 = () => (
  <>
    <Helmet>
      <title>Index 3 | Larkon Store</title>
    </Helmet>
                  ...
                  <div className="row"> 
                    <div className="col-lg-6">
                      <div className="cardCategory wow fadeInUp">
                        <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage3/cat1.png" alt="Guza" /></a></div>
                    ...
                    <div className="col-lg-6">
                      <div className="cardCategory wow fadeInUp">
                        <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage3/cat2.png" alt="Guza" /></a></div>
                        <div className="cardInfo">
                    ...
                    <div className="col-lg-4 card-style-small">
                      <div className="cardCategory wow fadeInUp">
                        <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage3/cat3.png" alt="Guza" /></a></div>
                        <div className="cardInfo">
                    ...
                    <div className="col-lg-4 card-style-small">
                      <div className="cardCategory wow fadeInUp">
                        <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage3/cat4.png" alt="Guza" /></a></div>
                        <div className="cardInfo">
                    ...
                    <div className="col-lg-4 card-style-small">
                      <div className="cardCategory wow fadeInUp">
                        <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage3/cat5.png" alt="Guza" /></a></div>
                        <div className="cardInfo">
