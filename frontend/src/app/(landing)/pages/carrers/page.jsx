...
const Carrers = () => (
  <>
    <Helmet>
      <title>Carrers | Larkon Store</title>
    </Helmet>
            ...
            <section className="section block-testimonials block-testimonials-2">
              <div className="container"> 
                <div className="row align-items-center"> 
                  ...
                  <div className="col-lg-4 wow fadeInUp"> <img src="/assets/imgs/page/carrers/img1.png" alt="Guza" /></div>
                  <div className="col-lg-4 wow fadeInUp"> <img src="/assets/imgs/page/carrers/img2.png" alt="Guza" /></div>
                </div>
              </div>
            </section>
