  ...
  <>
    ...
    <div className="landing-page-index-33">
      <header className="header sticky-bar header-style-2 header-style-2-nofix">
          ...
          <main className="main">
            <div className="section block-banner-home33">
            ...
            <section className="section block-products-home33 block-padding-80"> 
              <div className="container"> 
                <div className="text-center"> 
                  <p className="text-16-medium mb-10">FEATURED COLLECTION</p>
                  <h3 className="mb-40">Autumn Winter Style</h3>
                </div>
                <div className="row productNotsaleType02"> 
                  <div className="col-md-4 col-sm-6"> 
                    <div className="cardProduct cardProductColorStyle2 wow fadeInUp">
                      ...
                      <div className="cardInfo"><a href="#">
                          <h6 className="text-16-medium cardTitle">Ryder</h6></a>
                  ...
                  <div className="col-md-4 col-sm-6"> 
                    <div className="cardProduct cardProductColorStyle2 wow fadeInUp">
                      ...
                      <div className="cardInfo"><a href="#">
                          <h6 className="text-16-medium cardTitle">Tweety</h6></a>
                        <p className="body-p2 cardDesc">$100.00</p>
                        <div className="box-colors"> 
                          <div className="item-color color-7"></div>
                          <div className="item-color color-8"></div>
                  ...
                  <div className="col-md-4 col-sm-6"> 
                    <div className="cardProduct cardProductColorStyle2 wow fadeInUp">
                      ...
                      <div className="cardInfo"><a href="#">
                          <h6 className="text-16-medium cardTitle">Fantasia</h6></a>
                        <p className="body-p2 cardDesc">$100.00</p>
                        <div className="box-colors"> 
                          <div className="item-color color-7"></div>
                          <div className="item-color color-8"></div>
                  ...
                  <div className="col-md-4 col-sm-6"> 
                    <div className="cardProduct cardProductColorStyle2 wow fadeInUp">
                      ...
                      <div className="cardInfo"><a href="#">
                          <h6 className="text-16-medium cardTitle">Ginger</h6></a>
                        <p className="body-p2 cardDesc">$100.00</p>
                        <div className="box-colors"> 
                          <div className="item-color color-7"></div>
                          <div className="item-color color-8"></div>
                  ...
                  <div className="col-md-4 col-sm-6"> 
                    <div className="cardProduct cardProductColorStyle2 wow fadeInUp">
                      ...
                      <div className="cardInfo"><a href="#">
                          <h6 className="text-16-medium cardTitle">Glorious</h6></a>
                        <p className="body-p2 cardDesc">$100.00</p>
                        <div className="box-colors"> 
                          <div className="item-color color-7"></div>
                          <div className="item-color color-8"></div>
                  ...
                  <div className="col-md-4 col-sm-6"> 
                    <div className="cardProduct cardProductColorStyle2 wow fadeInUp">
                      ...
                      <div className="cardInfo"><a href="#">
                          <h6 className="text-16-medium cardTitle">Frizzante</h6></a>
                        <p className="body-p2 cardDesc">$100.00</p>
                        <div className="box-colors"> 
                          <div className="item-color color-7"></div>
                          <div className="item-color color-8"></div>
                ...
                <div className="mt-20 text-center"> <a className="btn btn-border-medium" href="#">View More</a></div>
              </div>
            </section>
            <section className="section block-cate-home33 block-padding-40"> 
              <div className="container"> 
                <div className="row"> 
            ...
            <section className="section block-collection-home33">
              <div className="container"> 
                <div className="box-image-collection"> 
                  <div className="box-image-collection-inner">
                    <h2>Premium Collection</h2>
                    <p className="body-p2">A pair of powerful spectacles has sometimes sufficed to cure a person in love.</p><a className="btn btn-white" href="#">Shop Now</a>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-instagram-type-3 block-padding-40">
              <div className="container"> 
                <div className="text-center">
                  <h3 className="mb-25 wow fadeInLeft">#July<span className="primary-navy">.</span></h3>
