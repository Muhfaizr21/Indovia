...
const StoreLocation = () => (
  <>
    <Helmet>
      <title>Store Location | Larkon Store</title>
    </Helmet>
                ...
                <div className="row"> 
                  <div className="col-lg-6 col-md-6 mb-50"> 
                    <div className="cardStore">
                      <div className="cardImage"><img src="/assets/imgs/page/store/store.png" alt="Guza" /></div>
                  ...
                  <div className="col-lg-6 col-md-6 mb-50"> 
                    <div className="cardStore">
                      <div className="cardImage"><img src="/assets/imgs/page/store/store2.png" alt="Guza" /></div>
                      <div className="cardInfo">
                  ...
                  <div className="col-lg-6 col-md-6 mb-50"> 
                    <div className="cardStore">
                      <div className="cardImage"><img src="/assets/imgs/page/store/store3.png" alt="Guza" /></div>
                      <div className="cardInfo">
                  ...
                  <div className="col-lg-6 col-md-6 mb-50"> 
                    <div className="cardStore">
                      <div className="cardImage"><img src="/assets/imgs/page/store/store4.png" alt="Guza" /></div>
                      <div className="cardInfo">
