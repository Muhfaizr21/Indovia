...
const ProductSingle24 = () => (
  <>
    <Helmet>
      <title>Product Single 24 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-product-single-24">
            ...
            <div className="section block-breadcrumb">
              <div className="container"> 
                <div className="box-breadcrumb">
                  ...
                  <div className="box-product-next-prev"> <a className="prev-product btn-tooltip" href="#" aria-label="Lace Shirt Cut II" data-bs-placement="top"></a><a className="next-product btn-tooltip" href="#" aria-label="Lace Shirt Cut II" data-bs-placement="right"></a></div>
                </div>
              </div>
            </div>
                ...
                <div className="row"> 
                  ...
                  <div className="col-lg-6">
                    <div className="box-product-info"> 
                      ...
                      <div className="block-out-of-stock"> 
                        <h6 className="tone-red">Out of stock</h6>
                        <div className="box-savemore-border"> 
                          <h6 className="mb-10">Email me when available</h6>
                          <p className="body-p2 mb-15">Get notified via email when this product is back in stock!</p>
                          <div className="form-notify"> 
                            <form action="#">
                              <input className="form-control" type="text" placeholder="Email Address *" />
                              <button className="btn btn-black">Notify Me </button>
                            </form>
                          </div>
                        </div>
                      </div>
...
export default ProductSingle24;
