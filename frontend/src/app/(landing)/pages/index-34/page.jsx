...
const Index34 = () => (
  <>
    <Helmet>
      <title>Index 34 | Larkon Store</title>
    </Helmet>
                ...
                <div className="row"> 
                  <div className="col-md-4">
                    <div className="cardImageTextMiddle">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage34/mens.png" alt="Guza" /></a></div>
                  ...
                  <div className="col-md-4">
                    <div className="cardImageTextMiddle">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage34/womens.png" alt="Guza" /></a></div>
                      <div className="cardText"><a href="#">
                  ...
                  <div className="col-md-4">
                    <div className="cardImageTextMiddle">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage34/kids.png" alt="Guza" /></a></div>
                      <div className="cardText"><a href="#">
                ...
                <div className="row productNotsaleType02"> 
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage34/sp.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage34/sp.png" alt="guza" /></a>
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage34/sp2.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage34/sp2.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage34/sp3.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage34/sp3.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage34/sp4.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage34/sp4.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage34/sp5.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage34/sp5.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage34/sp6.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage34/sp6.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage34/sp7.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage34/sp7.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage34/sp8.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage34/sp8.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
            ...
            <div className="section block-banner-home33 block-padding-40">
              <div className="box-swiper"> 
                <div className="swiper-container swiper-group-center-items pb-0">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide"> 
                      <div className="card-category-banner"> <img src="/assets/imgs/page/homepage34/relaxed.jpg" alt="Guza" />
                    ...
                    <div className="swiper-slide"> 
                      <div className="card-category-banner"> <img src="/assets/imgs/page/homepage34/straight.jpg" alt="Guza" />
                        <div className="card-info"> 
                    ...
                    <div className="swiper-slide"> 
                      <div className="card-category-banner"> <img src="/assets/imgs/page/homepage34/bootcut.jpg" alt="Guza" />
                        <div className="card-info"> 
            ...
            <section className="section block-instagram-type-4 block-instagram-type-2 block-padding-40">
              ...
              <div className="box-gallery-instagram box-gallery-instagram-type2 mt-40 wow fadeInDown"> 
                <div className="box-gallery-instagram-type2-inner">
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage34/insta2.png" alt="Guza" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage34/insta.png" alt="Guza" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage34/insta2.png" alt="Guza" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage34/insta3.png" alt="Guza" /><a href="#">Shop on Instagram</a></div>
                </div>
              </div>
            </section>
          </main>
