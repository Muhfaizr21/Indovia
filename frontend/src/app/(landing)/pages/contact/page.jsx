...
const Contact = () => (
  <>
    <Helmet>
      <title>Contact | Larkon Store</title>
    </Helmet>
              ...
              <div className="container"> 
                <div className="row"> 
                  <div className="col-lg-5 mb-40 wow fadeInUp"> 
                    ...
                    <div className="socials mt-55 justify-content-start"><a className="ml-0" href="#"><img src="/assets/imgs/page/about1/fb.svg" alt="Guza" /></a><a href="#"><img src="/assets/imgs/page/about1/insta.svg" alt="Guza" /></a></div>
                  </div>
