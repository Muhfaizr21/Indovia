...
const Index5 = () => (
  <>
    <Helmet>
      <title>Index 5 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-5">
      <header className="header sticky-bar header-style-2">
          ...
          <main className="main">
            <section className="section banner-homepage2 banner-homepage5">
              <div className="box-swiper">
                <div className="swiper-container swiper-banner pb-0">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <div className="box-cover-image" style={{backgroundImage: "url(/assets/imgs/page/homepage5/banner.png)"}}></div>
                      <div className="box-banner-info">
                        <div className="row">
                          <div className="col-sm-7">
                            <h2 className="text-72-bold color-primary-dark mb-15">She is very<br className="d-none d-lg-block" />much herself.</h2>
                            <p className="text-18 mb-35">Use code HOLIDAY at checkout. Ends 11/29/21</p>
                            <div className="text-start"><a className="btn btn-brown" href="#">View Collection</a></div>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="swiper-slide">
                      <div className="box-cover-image" style={{backgroundImage: "url(/assets/imgs/page/homepage5/banner-2.png)"}}></div>
                      <div className="box-banner-info">
                        <div className="row">
                          <div className="col-sm-7">
                            <h2 className="text-72-bold color-primary-dark mb-15">She is very<br className="d-none d-lg-block" />much herself.</h2>
            ...
            <section className="section block-collection-1"> 
              <div className="container"> 
                <div className="image-background">
                  <div className="row align-items-center"> 
                    <div className="col-lg-6 wow fadeInLeft"><img src="/assets/imgs/page/homepage5/img-collection.png" alt="Indovia" /></div>
                    <div className="col-lg-6">
                      <div className="box-info-collection-1 wow fadeInDown">
                        <h2 className="text-48-semibold mb-15">2020 Collection</h2>
                        <p className="body-p2 mb-30">Thelma shoes are handmade by expert Italian artisans dedicated to preserving inherited techniques.</p><a className="btn btn-black" href="#">View Collection</a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="section block-about"> 
              <div className="container"> 
                <div className="text-center">
                  <h3 className="neutral-dark mb-40 wow fadeInDown">Customers Reviews</h3>
                </div>
                <div className="box-slide-customers wow fadeInUp">
                  <p className="overtime-t1 mb-15">VIBRANT YET REFINED</p>
                  <p className="text-36-semibold mb-30">We’re in the business of creating happy tears, stunned silences, “oh, wow”s, and booming belly laughs.</p><a className="link-underline" href="#">Read More</a>
                </div>
              </div>
            </section>
