...
const Index2 = () => (
  <>
    <Helmet>
      <title>Index 2 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-2">
      <header className="header sticky-bar">
          ...
          <main className="main">
                ...
                <div className="swiper-container swiper-banner pb-0">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <div className="box-cover-image" style={{backgroundImage: "url(/assets/imgs/page/homepage2/banner.png)"}}></div>
                    ...
                    <div className="swiper-slide">
                      <div className="box-cover-image" style={{backgroundImage: "url(/assets/imgs/page/homepage2/banner-2.png)"}}></div>
                      <div className="box-banner-info wow fadeInUp">
            ...
            <section className="section box-feature-cat">
              <div className="container"> 
                <div className="box-title-between">
                  <div className="box-title-main"> 
                    <h3 className="wow fadeInLeft">Featured Categories</h3>
                  </div>
                  <div className="box-link wow fadeInRight"><a className="link-underline" href="#">See All Catetogies</a></div>
                </div>
                <div className="row"> 
                  <div className="col-lg-4 col-md-6"> 
                    <div className="cardFeatureCat wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage2/cat.png" alt="Indovia" /></a></div>
                      <div className="cardInfo"><a href="#">
                          <h5 className="cardTitle">Shirts</h5></a>
                        <p className="link-l2 cardDesc">12 items</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-4 col-md-6"> 
                    <div className="cardFeatureCat wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage2/cat2.png" alt="Indovia" /></a></div>
                      <div className="cardInfo"><a href="#">
                          <h5 className="cardTitle">Jackets</h5></a>
                        <p className="link-l2 cardDesc">12 items</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-4 col-md-6"> 
                    <div className="cardFeatureCat wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage2/cat3.png" alt="Indovia" /></a></div>
                      <div className="cardInfo"><a href="#">
                          <h5 className="cardTitle">Shorts</h5></a>
                        <p className="link-l2 cardDesc">12 items</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-4 col-md-6"> 
                    <div className="cardFeatureCat wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage2/cat4.png" alt="Indovia" /></a></div>
                      <div className="cardInfo"><a href="#">
                          <h5 className="cardTitle">Tees</h5></a>
                        <p className="link-l2 cardDesc">12 items</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-4 col-md-6"> 
                    <div className="cardFeatureCat wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage2/cat5.png" alt="Indovia" /></a></div>
                      <div className="cardInfo"><a href="#">
                          <h5 className="cardTitle">Knits</h5></a>
                        <p className="link-l2 cardDesc">12 items</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-4 col-md-6"> 
                    <div className="cardFeatureCat wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage2/cat6.png" alt="Indovia" /></a></div>
                      <div className="cardInfo"><a href="#">
                          <h5 className="cardTitle">Pants</h5></a>
                        <p className="link-l2 cardDesc">12 items</p>
                      </div>
                    </div>
                  </div>
            ...
            <section className="section box-sale-countdown">
              <div className="container">
                <div className="row align-items-center">
                  <div className="col-lg-6 wow fadeInLeft"><img src="/assets/imgs/page/homepage2/banner-sale.png" alt="Indovia" /></div>
                  <div className="col-lg-6">
                    <div className="box-info-sale-countdown wow fadeInRight">
                      <p className="text-17-medium tone-red mb-15 text-uppercase">Sale Upto 60%</p>
                      <h3 className="mb-25">Blue classic long sleeves shirt</h3>
                      <div className="box-count box-count-square">
                        <div className="deals-countdown" data-countdown="2023/12/25 00:00:00"></div>
                      </div><a className="btn btn-black" href="#">Shop Now</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section className="section box-blogs">
              <div className="container">
                <div className="text-center">
                  <h3 className="mb-40 wow fadeInLeft">From the Blog</h3>
                </div>
                <div className="row">
