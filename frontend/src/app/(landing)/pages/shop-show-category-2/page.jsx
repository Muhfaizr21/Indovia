...
const ShopShowCategory2 = () => (
  <>
    <Helmet>
      <title>Shop Show Category 2 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-shop-show-category-2">
      <header className="header sticky-bar">
          ...
          <main className="main">
            ...
            <section className="section block-content-shop">
              <div className="container">
                <div className="box-shop-category-top">
                  <div className="box-swiper">
                    <div className="swiper-container swiper-6-items pb-0">
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
                          <div className="cardCategorySmall cardCategorySmallStyle2 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img src="/assets/imgs/page/shop6/kitchen.png" alt="Indovia" /></a></div>
                            <div className="cardInfo"><a href="#">
                                <h4 className="cardTitle">Kitchen (8)</h4></a></div>
                          </div>
                        </div>
                        <div className="swiper-slide">
                          <div className="cardCategorySmall cardCategorySmallStyle2 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img src="/assets/imgs/page/shop6/accessories.png" alt="Indovia" /></a></div>
                            <div className="cardInfo"><a href="#">
                                <h4 className="cardTitle">Accessories (12)</h4></a></div>
                          </div>
                        </div>
                        <div className="swiper-slide">
                          <div className="cardCategorySmall cardCategorySmallStyle2 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img src="/assets/imgs/page/shop6/medical.png" alt="Indovia" /></a></div>
                            <div className="cardInfo"><a href="#">
                                <h4 className="cardTitle">Medical (4)</h4></a></div>
                          </div>
                        </div>
                        <div className="swiper-slide">
                          <div className="cardCategorySmall cardCategorySmallStyle2 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img src="/assets/imgs/page/shop6/headphone.png" alt="Indovia" /></a></div>
                            <div className="cardInfo"><a href="#">
                                <h4 className="cardTitle">Hi-Tech (5)</h4></a></div>
                          </div>
                        </div>
                        <div className="swiper-slide">
                          <div className="cardCategorySmall cardCategorySmallStyle2 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img src="/assets/imgs/page/shop6/travel.png" alt="Indovia" /></a></div>
                            <div className="cardInfo"><a href="#">
                                <h4 className="cardTitle">Travel (3)</h4></a></div>
                          </div>
                        </div>
                        <div className="swiper-slide">
                          <div className="cardCategorySmall cardCategorySmallStyle2 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img src="/assets/imgs/page/shop6/bag.png" alt="Indovia" /></a></div>
                            <div className="cardInfo"><a href="#">
                                <h4 className="cardTitle">Bags (6)</h4></a></div>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="box-pagination-button box-pagination-leftright">
                      <div className="swiper-pagination swiper-pagination-6"></div>
                      <div className="swiper-button-prev swiper-button-prev-6 btn-prev-style-1"></div>
                      <div className="swiper-button-next swiper-button-next-6 btn-next-style-1"></div>
                    </div>
                  </div>
                </div>
                <div className="box-filter-top"> 
                  <div className="show-sm show-lg"> <a className="btn-open-filter" href="#">Filter </a></div>
                  <div className="wrapper-overlay"></div>
                  <div className="box-filters box-filters-left"> <span className="body-p2 neutral-medium-dark">Filter by</span>
                    <div className="dropdown dropdown-sort">
                      <button className="btn dropdown-toggle" id="dropdownCat" type="button" data-bs-toggle="dropdown" aria-expanded="false">Categories</button>
                      <div className="dropdown-menu dropdown-menu-light dropdown-menu-filter dropdown-menu-category" aria-labelledby="dropdownCat" style={{margin: "0px"}}>
                        <div className="box-dropdown-filter">
                          <h6 className="head-filter">Categories</h6>
                          <div className="box-collapse">
                            <ul className="list-filter-checkbox"> 
                              <li> 
                                <label className="cb-container">
                                  <input type="checkbox" /><span className="text-small">Womens <span className="neutral-medium">(12)</span></span><span className="checkmark"></span>
                                </label><span className="arrow-down"></span>
                              </li>
                              <li> 
                                <label className="cb-container">
                                  <input type="checkbox" /><span className="text-small">Mens <span className="neutral-medium">(9)</span></span><span className="checkmark"></span>
                                </label><span className="arrow-down"></span>
                                <ul> 
                                  <li> 
                                    <label className="cb-container">
                                      <input type="checkbox" /><span className="text-small">Hats<span className="neutral-medium">(4)</span></span><span className="checkmark"></span>
                                    </label>
                                  </li>
                                  <li> 
                                    <label className="cb-container">
                                      <input type="checkbox" /><span className="text-small">Glasses <span className="neutral-medium">(3)</span></span><span className="checkmark"></span>
                                    </label>
                                  </li>
                                  <li> 
                                    <label className="cb-container">
                                      <input type="checkbox" /><span className="text-small">Jeans<span className="neutral-medium">(2)</span></span><span className="checkmark"></span>
                                    </label>
                                  </li>
                                </ul>
                              </li>
                              <li> 
                                <label className="cb-container">
                                  <input type="checkbox" /><span className="text-small">Kids <span className="neutral-medium">(15)</span></span><span className="checkmark"></span>
                                </label><span className="arrow-down"></span>
                              </li>
                              <li> 
                                <label className="cb-container">
                                  <input type="checkbox" /><span className="text-small">Gifts <span className="neutral-medium">(10)</span></span><span className="checkmark"></span>
                                </label><span className="arrow-down"></span>
                              </li>
                            </ul>
                          </div>
                    ...
                    <div className="dropdown dropdown-sort">
                      <button className="btn dropdown-toggle" id="dropdownColor" type="button" data-bs-toggle="dropdown" aria-expanded="false">Color</button>
                      <div className="dropdown-menu dropdown-menu-light dropdown-menu-filter" aria-labelledby="dropdownColor" style={{margin: "0px"}}>
                        <div className="box-dropdown-filter">
                          <h6 className="head-filter">Colors </h6>
                          <div className="box-collapse">
                    ...
                    <div className="dropdown dropdown-sort">
                      <button className="btn dropdown-toggle" id="dropdownSize" type="button" data-bs-toggle="dropdown" aria-expanded="false">Size</button>
                      <div className="dropdown-menu dropdown-menu-light dropdown-menu-filter" aria-labelledby="dropdownSize" style={{margin: "0px"}}>
                        <div className="box-dropdown-filter">
                          <h6 className="head-filter">Size </h6>
                          <div className="box-collapse">
                            <ul className="list-filter-checkbox"> 
                              <li> 
                                <label className="cb-container">
                                  <input type="checkbox" /><span className="text-small">S <span className="neutral-medium">(3)</span></span><span className="checkmark"></span>
                                </label>
                              </li>
                              <li> 
                                <label className="cb-container">
                                  <input type="checkbox" /><span className="text-small">L <span className="neutral-medium">(9)</span></span><span className="checkmark"></span>
                                </label>
                              </li>
                              <li> 
                                <label className="cb-container">
                                  <input type="checkbox" /><span className="text-small">M <span className="neutral-medium">(4)</span></span><span className="checkmark"></span>
                                </label>
                              </li>
                              <li> 
                                <label className="cb-container">
                                  <input type="checkbox" /><span className="text-small">XL <span className="neutral-medium">(5)</span></span><span className="checkmark"></span>
                                </label>
                              </li>
                            </ul>
                          </div>
                    ...
                    <div className="dropdown dropdown-sort">
                      <button className="btn dropdown-toggle" id="dropdownBrand" type="button" data-bs-toggle="dropdown" aria-expanded="false">Brand</button>
                      <div className="dropdown-menu dropdown-menu-light dropdown-menu-filter" aria-labelledby="dropdownBrand" style={{margin: "0px"}}>
                        <div className="box-dropdown-filter">
                          <h6 className="head-filter">Brand </h6>
                          <div className="box-collapse">
                            <ul className="list-filter-checkbox"> 
                              <li> 
                                <label className="cb-container">
                                  <input type="checkbox" /><span className="text-small">Adidas</span><span className="checkmark"></span>
                                </label>
                              </li>
                              <li> 
                                <label className="cb-container">
                                  <input type="checkbox" /><span className="text-small">Chloe</span><span className="checkmark"></span>
                                </label>
                              </li>
                              <li> 
                                <label className="cb-container">
                                  <input type="checkbox" /><span className="text-small">Kendo</span><span className="checkmark"></span>
                                </label>
                              </li>
                              <li> 
                                <label className="cb-container">
                                  <input type="checkbox" /><span className="text-small">Nike</span><span className="checkmark"></span>
                                </label>
                              </li>
                              <li> 
                                <label className="cb-container">
                    ...
                    <div className="dropdown dropdown-sort">
                      <button className="btn dropdown-toggle" id="dropdownRrice" type="button" data-bs-toggle="dropdown" aria-expanded="false">Price</button>
                      <div className="dropdown-menu dropdown-menu-light dropdown-menu-filter dropdown-menu-category" aria-labelledby="dropdownRrice" style={{margin: "0px"}}>
                        <div className="box-dropdown-filter">
                          <h6 className="head-filter">Price </h6>
                          <div className="box-collapse scrollFilter">
                            <ul className="list-filter-checkbox"> 
                              <li> 
                                <label className="cb-container">
                                  <input type="checkbox" /><span className="text-small">$10.00 - $49.00</span><span className="checkmark"></span>
                                </label>
                              </li>
                              <li> 
                                <label className="cb-container">
                                  <input type="checkbox" /><span className="text-small">$50.00 - $99.00</span><span className="checkmark"></span>
                                </label>
                              </li>
                              <li> 
                                <label className="cb-container">
                                  <input type="checkbox" /><span className="text-small">$100.00 - $199.00</span><span className="checkmark"></span>
                                </label>
                              </li>
                              <li> 
                                <label className="cb-container">
                                  <input type="checkbox" /><span className="text-small">$200.00 +</span><span className="checkmark"></span>
                                </label>
                              </li>
                            </ul>
                          </div>
                  ...
                  <div className="box-sort"> 
                    ...
                    <div className="box-view-style"> <a className="view-type view-2" href="#" data-col="2"></a><a className="view-type view-3 active" href="#" data-col="3"></a><a className="view-type view-4" href="#" data-col="4"></a><a className="view-type view-5" href="#" data-col="5"></a></div>
                  </div>
                </div>
              </div>
              <div className="wrapper-overlay"></div>
              <div className="block-filter-middle block-filter-canvas wrapper-popup">
                <div className="container">
              ...
              <div className="container">
                <div className="box-your-filter box-your-filter-shop2">
                  <div className="block-text-filter"><span className="body-p2 neutral-medium-dark">Your filter</span></div>
                  <div className="block-ele-filter"><a className="btn btn-tag-filter" href="#">XS<span className="close-tag"></span></a><a className="btn btn-tag-filter" href="#">Women<span className="close-tag"></span></a><a className="clear-filter link-underline" href="#">Clear All</a></div>
                </div>
                <div className="box-list-products box-list-products-4 box-list-products-shop-2">
                  <div className="product-item">
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage1/product8.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png" alt="Indovia" /></a>
                  ...
                  <div className="product-item">
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage1/product7.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="product-item">
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage1/product6.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="product-item">
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage1/product5.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="product-item">
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage1/product4.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="product-item">
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage1/product3.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="product-item">
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage1/product2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="product-item">
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage1/product1.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
...
export default ShopShowCategory2;
