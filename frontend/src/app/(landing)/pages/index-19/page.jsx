...
const Index19 = () => (
  <>
    <Helmet>
      <title>Index 19 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-19">
      <header className="header sticky-bar header-type1">
          ...
          <main className="main">
            <section className="section banner-homepage19">
              <div className="container-banner"> 
                <div className="banner-video"> 
                  <div className="banner-video-inner"> 
                    <h1 className="mb-5">Together We <br className="d-none d-lg-block" />Grow Better</h1>
                    <p className="body-p1 mb-30">Let's create a healthy life together</p><a className="btn btn-border-white" href="#">Shop now</a>
                  </div>
                </div>
              </div>
            </section>
            <section className="section box-best-sellers-home17">
              <div className="container"> 
                <div className="box-title-between">
                  <div className="box-title-main"> 
                    <h5 className="wow fadeInLeft">Best sellers</h5>
                  </div>
                </div>
                <div className="box-best-seller-product"> 
                  <div className="box-swiper button-slide-square button-slide-square-2"> 
                    <div className="swiper-container swiper-group-4 pb-90">
                      <div className="swiper-wrapper">
                        <div className="swiper-slide"> 
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage19/sp.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage19/sp.png" alt="Indovia" /></a>
                              ...
                              <div className="box-quick-button"><a className="btn" href="#">
                                  ...
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="cardInfo">
                              <h6 className="text-17-medium mb-10">The Flamingo Flower</h6>
                              <p className="body-p2 cardDesc">$100.00</p>
                            </div>
                          </div>
                        </div>
                        <div className="swiper-slide"> 
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage19/sp2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage19/sp2.png" alt="Indovia" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                            ...
                            <div className="cardInfo">
                              <h6 className="text-17-medium mb-10">The Jungle Orchid</h6>
                              <p className="body-p2 cardDesc">$100.00</p>
                            </div>
                          </div>
                        </div>
                        <div className="swiper-slide"> 
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage19/sp3.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage19/sp3.png" alt="Indovia" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                            ...
                            <div className="cardInfo">
                              <h6 className="text-17-medium mb-10">The Yellow Friendship Rose</h6>
                              <p className="body-p2 cardDesc">$100.00</p>
                            </div>
                          </div>
                        </div>
                        <div className="swiper-slide"> 
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage19/sp4.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage19/sp4.png" alt="Indovia" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                            ...
                            <div className="cardInfo">
                              <h6 className="text-17-medium mb-10">The Peace Lily</h6>
                              <p className="body-p2 cardDesc">$100.00</p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="box-pagination-button">
                        <div className="swiper-pagination swiper-pagination-fleet-4 swiper-pagination-banner-style-2"></div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="section collection-homepage19">
              <div className="container">
                <div className="box-info-collection"> 
                  <h2 className="mb-10">Your plant. Your style</h2>
                  <p className="body-p1 mb-25">Mix and match your plants and planters!</p><a className="btn btn-border" href="#">Shop now</a>
                </div>
              </div>
                ...
                <div className="point point-1">
                  <div className="dropend">
                    ...
                    <div className="dropdown-menu">
                      <div className="popup-product-collection">
                        <div className="popup-image"> <img src="/assets/imgs/page/homepage19/sp5.png" alt="Indovia" /></div>
                        <div className="popup-info"><a className="text-16-medium" href="#">The Monstera</a>
                          <p className="body-p2">$100.00</p>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <section className="section box-product-list-home19">
              <div className="container"> 
                  ...
                  <div className="box-tabs wow fadeInRight"> 
                    <ul className="nav nav-tabs nav-tabs-style-2 nav-tabs-style-4" role="tablist">
                      <li className="nav-item" role="presentation">
                        <button className="nav-link active" id="bestsellers-tab" data-bs-toggle="tab" data-bs-target="#bestsellers" type="button" role="tab" aria-controls="bestsellers" aria-selected="true" data-index="1" data-items="1">Indoor Plants</button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="newproducts-tab" data-bs-toggle="tab" data-bs-target="#newproducts" type="button" role="tab" aria-controls="newproducts" aria-selected="false" data-index="2" data-items="1">Outdoor Plants</button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="featureproducts-tab" data-bs-toggle="tab" data-bs-target="#featureproducts" type="button" role="tab" aria-controls="featureproducts" aria-selected="false" data-index="3" data-items="1">Herbs & Veggies</button>
                      </li>
                    </ul>
                  </div>
                </div>
                  ...
                  <div className="tab-pane fade show active" id="bestsellers" role="tabpanel" aria-labelledby="bestsellers-tab">
                    <div className="row"> 
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage19/sp6.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage19/sp6.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage19/sp7.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage19/sp7.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage19/sp8.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage19/sp7.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage19/sp9.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage19/sp9.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage19/sp10.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage19/sp10.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                          ...
                          <div className="cardInfo">
                            ...
                            <p className="body-p2 cardDesc">$150.00</p>
                          </div>
                        </div>
                      </div>
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage19/sp11.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage19/sp11.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage19/sp12.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage19/sp12.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage19/sp13.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage19/sp13.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                    ...
                    <div className="mt-10 mb-40 text-center"> <a className="link-underline" href="#">See All Products</a></div>
                  </div>
            ...
            <section className="section box-news-home19">
              <div className="banner-news-19">
                <div className="container"> 
                  <div className="row align-items-center"> 
                    <div className="col-lg-6 mb-30">
                      <div className="mw-270">
                        <h3 className="mb-10 color-white">Which indoor <br className="d-none d-lg-block" />plants are best?</h3>
                        <p className="body-p1 mb-30 color-white">It is important to understand the most suitable environmental conditions for plants before purchasing.</p><a className="btn btn-border-white" href="#">Explore more</a>
                      </div>
                    </div>
                    <div className="col-lg-6 mb-30"> 
                      <div className="row"> 
                        <div className="col-sm-6"> <img className="w-100" src="/assets/imgs/page/homepage19/news.jpg" alt="Indovia" /></div>
                        <div className="col-sm-6"><img className="w-100" src="/assets/imgs/page/homepage19/news2.jpg" alt="Indovia" /></div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="section"> 
              ...
              <div className="box-gallery-instagram"> 
                <div className="gallery-item wow fadeInLeft"><img src="/assets/imgs/page/homepage19/inst.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage19/inst2.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage19/inst3.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage19/inst4.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInRight"><img src="/assets/imgs/page/homepage19/inst5.png" alt="Indovia" /></div>
              </div>
            </section>
          </main>
          <footer className="footer footer-type3-light">
            <div className="footer-1">
              <div className="container">
                <div className="row">
                  <div className="col-lg-4 mb-30">
                    <h6 className="neutral-dark mb-20">About Shop</h6>
                    <p className="neutral-medium-dark body-p2 desc-company">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Read more</p>
                  ...
                  <div className="col-lg-8 mb-30">
                    <div className="row">
                      <div className="col-lg-3 mb-30">
                        <h6 className="neutral-dark mb-20">Company</h6>
                      ...
                      <div className="col-lg-3 mb-30">
                        <h6 className="neutral-dark mb-20">Customer Care</h6>
                        <ul className="menu-footer">
                      ...
                      <div className="col-lg-6 mb-30">
                        <h6 className="neutral-dark mb-20">Newsletter</h6>
                        <p className="body-p2 neutral-dark">Sign up now to get first update about our new collection.</p>
