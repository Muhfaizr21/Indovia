...
const ProductSingle12 = () => (
  <>
    <Helmet>
      <title>Product Single 12 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-product-single-12">
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    <div className="box-product-info">
                      ...
                      <div className="block-link"><a className="link-l2 link-underline" href="#">Size Guide</a></div>
...
export default ProductSingle12;
