...
const ShopShowCategory2 = () => (
  <>
    <Helmet>
      <title>Shop Show Category 2 | Larkon Store</title>
    </Helmet>
                      ...
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
                          <div className="cardCategorySmall cardCategorySmallStyle2 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img src="/assets/imgs/page/shop6/kitchen.png" alt="Guza" /></a></div>
                        ...
                        <div className="swiper-slide">
                          <div className="cardCategorySmall cardCategorySmallStyle2 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img src="/assets/imgs/page/shop6/accessories.png" alt="Guza" /></a></div>
                            <div className="cardInfo"><a href="#">
                        ...
                        <div className="swiper-slide">
                          <div className="cardCategorySmall cardCategorySmallStyle2 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img src="/assets/imgs/page/shop6/medical.png" alt="Guza" /></a></div>
                            <div className="cardInfo"><a href="#">
                        ...
                        <div className="swiper-slide">
                          <div className="cardCategorySmall cardCategorySmallStyle2 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img src="/assets/imgs/page/shop6/headphone.png" alt="Guza" /></a></div>
                            <div className="cardInfo"><a href="#">
                        ...
                        <div className="swiper-slide">
                          <div className="cardCategorySmall cardCategorySmallStyle2 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img src="/assets/imgs/page/shop6/travel.png" alt="Guza" /></a></div>
                            <div className="cardInfo"><a href="#">
                        ...
                        <div className="swiper-slide">
                          <div className="cardCategorySmall cardCategorySmallStyle2 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img src="/assets/imgs/page/shop6/bag.png" alt="Guza" /></a></div>
                            <div className="cardInfo"><a href="#">
