...
const StoreLocation = () => (
  <>
    <Helmet>
      <title>Store Location | Indovia Store</title>
    </Helmet>
    <div className="landing-page-store-location">
          ...
          <main className="main">
            <section className="section banner-500">
              ...
              <div className="box-banner-info"> 
                <p className="overline-t2-medium text-uppercase primary-navy mb-10">Store Locations</p>
                <h2 className="color-primary-dark mb-30">Our stores are open <br className="d-none d-lg-block" />Day of the year  </h2>
              </div>
            </section>
            <section className="section block-our-store">
              <div className="container"> 
                <div className="row"> 
                  <div className="col-lg-6 col-md-6 mb-50"> 
                    <div className="cardStore">
                      <div className="cardImage"><img src="/assets/imgs/page/store/store.png" alt="Indovia" /></div>
                      <div className="cardInfo">
                        <h5 className="mb-10">Lincoln Park</h5>
                        <p className="body-p2 neutral-medium mb-25">211 W Armitage Ave, Chicago, IL 60614</p>
                        <p className="body-p2 neutral-medium-dark mb-10">T. +1 773 6216 240</p>
                        <p className="body-p2 neutral-medium-dark mb-10">E. hello@uxper.co</p>
                        <p className="body-p2 neutral-medium-dark mb-25">Mon: Closed, Tue-Sat: 12PM-6PM, Sun: Closed</p><a className="link-underline" href="#">See Inventory</a>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-6 col-md-6 mb-50"> 
                    <div className="cardStore">
                      <div className="cardImage"><img src="/assets/imgs/page/store/store2.png" alt="Indovia" /></div>
                      <div className="cardInfo">
                        <h5 className="mb-10">Georgetown</h5>
                        <p className="body-p2 neutral-medium mb-25">332 M St NW, Washington, DC 20007</p>
                        <p className="body-p2 neutral-medium-dark mb-10">T. +1 202 823 4267</p>
                        <p className="body-p2 neutral-medium-dark mb-10">E. hello@uxper.co</p>
                        <p className="body-p2 neutral-medium-dark mb-25">Mon: Closed, Tue-Sat: 12PM-6PM, Sun: Closed</p><a className="link-underline" href="#">See Inventory</a>
                      </div>
                    </div>
                  ...
                  <div className="col-lg-6 col-md-6 mb-50"> 
                    <div className="cardStore">
                      <div className="cardImage"><img src="/assets/imgs/page/store/store3.png" alt="Indovia" /></div>
                      <div className="cardInfo">
                        <h5 className="mb-10">Hayes Valley</h5>
                        <p className="body-p2 neutral-medium mb-25">123 Hayes St, San Francisco, CA 94102</p>
                        <p className="body-p2 neutral-medium-dark mb-10">T. +1 415 6485 211</p>
                        <p className="body-p2 neutral-medium-dark mb-10">E. hello@uxper.co</p>
                        <p className="body-p2 neutral-medium-dark mb-25">Mon: Closed, Tue-Sat: 12PM-6PM, Sun: Closed</p><a className="link-underline" href="#">See Inventory</a>
                      </div>
                    </div>
                  ...
                  <div className="col-lg-6 col-md-6 mb-50"> 
                    <div className="cardStore">
                      <div className="cardImage"><img src="/assets/imgs/page/store/store4.png" alt="Indovia" /></div>
                      <div className="cardInfo">
                        <h5 className="mb-10">Los Angeles</h5>
                        <p className="body-p2 neutral-medium mb-25">8425 Melrose Ave, Los Angeles, CA 90069</p>
                        <p className="body-p2 neutral-medium-dark mb-10">T. +1 970 429 4170</p>
                        <p className="body-p2 neutral-medium-dark mb-10">E. hello@uxper.co</p>
                        <p className="body-p2 neutral-medium-dark mb-25">Mon: Closed, Tue-Sat: 12PM-6PM, Sun: Closed</p><a className="link-underline" href="#">See Inventory</a>
                      </div>
                    </div>
