...
const Index25 = () => (
  <>
    <Helmet>
      <title>Index 25 | Larkon Store</title>
    </Helmet>
                    ...
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <div className="cardProductCategory01 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp.png" alt="guza" /></a></div>
                      ...
                      <div className="swiper-slide">
                        <div className="cardProductCategory01 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp2.png" alt="guza" /></a></div>
                          <div className="cardInfo">
                      ...
                      <div className="swiper-slide">
                        <div className="cardProductCategory01 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp3.png" alt="guza" /></a></div>
                          <div className="cardInfo">
                      ...
                      <div className="swiper-slide">
                        <div className="cardProductCategory01 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp8.png" alt="guza" /></a></div>
                          <div className="cardInfo">
                ...
                <div className="row"> 
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp4.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage25/sp4.png" alt="guza" /></a>
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp5.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage25/sp5.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp6.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage25/sp6.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp7.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage25/sp7.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp9.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage25/sp9.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp10.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage25/sp10.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp11.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage25/sp11.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage25/sp12.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage25/sp12.png" alt="guza" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                ...
                <div className="row"> 
                  <div className="col-md-4"> 
                    <div className="card-icon-box-type4">
                      <div className="card-icon-image"><img src="/assets/imgs/page/homepage25/ship.svg" alt="Guza" /></div>
                  ...
                  <div className="col-md-4"> 
                    <div className="card-icon-box-type4">
                      <div className="card-icon-image"><img src="/assets/imgs/page/homepage25/member.svg" alt="Guza" /></div>
                      <div className="card-icon-info">
                  ...
                  <div className="col-md-4"> 
                    <div className="card-icon-box-type4">
                      <div className="card-icon-image"><img src="/assets/imgs/page/homepage25/safe.svg" alt="Guza" /></div>
                      <div className="card-icon-info">
            ...
            <section className="section block-instagram-type-4 block-instagram-type-2">
              ...
              <div className="box-gallery-instagram box-gallery-instagram-type2 mt-40 wow fadeInDown"> 
                <div className="box-gallery-instagram-type2-inner">
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage25/instagram.png" alt="Guza" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage25/instagram2.png" alt="Guza" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage25/instagram3.png" alt="Guza" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage25/instagram.png" alt="Guza" /><a href="#">Shop on Instagram</a></div>
                </div>
              </div>
            </section>
