            ...
            <Col md={6}>
              <form action="#">
                ...
                <div className="mb-3">
                  ...
                  <InputMask mask={[/\d/, /\d/, '/', /\d/, /\d/, '/', /\d/, /\d/, /\d/, /\d/, ' ', /\d/, /\d/, ':', /\d/, /\d/, ':', /\d/, /\d/]} placeholder="__/__/___ __:__:__" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <InputMask mask={[/\d/, /\d/, /\d/, '.', /\d/, /\d/, /\d/, '.', /\d/, /\d/, /\d/, '.', /\d/, /\d/, /\d/, '.', /\d/, /\d/, /\d/, ',', /\d/, /\d/]} placeholder="__.___.__.__,__" className="form-control" />
            ...
            <Col md={6}>
              <form action="#">
                ...
                <div className="mb-3">
                  ...
                  <InputMask mask={['(', /[1-9]/, /\d/, ')', ' ', /\d/, /\d/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, /\d/]} placeholder="(__)____-____" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <InputMask mask={['(', /[1-9]/, /\d/, /\d/, ')', ' ', /\d/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, /\d/]} placeholder="(___)___-____" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <InputMask mask={['(', /[1-9]/, /\d/, ')', ' ', /\d/, /\d/, /\d/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, /\d/]} placeholder="(__)_____-____" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <InputMask mask={[/\d/, /\d/, /\d/, '.', /\d/, /\d/, /\d/, '.', /\d/, /\d/, /\d/, /\d/, '-', /\d/, /\d/]} placeholder="___.___.____-__" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <InputMask mask={[/\d/, /\d/, '.', /\d/, /\d/, /\d/, '.', /\d/, /\d/, /\d/, '/', /\d/, /\d/, /\d/, /\d/, '-', /\d/, /\d/]} placeholder="__.___.___/____-__" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <InputMask mask={[/\d/, /\d/, /\d/, '.', /\d/, /\d/, /\d/, '.', /\d/, /\d/, /\d/, '.', /\d/, /\d/, /\d/]} placeholder="___.___.___.___" className="form-control" />
