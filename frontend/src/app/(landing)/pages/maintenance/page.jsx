...
const Maintenance = () => (
  <>
    <Helmet>
      <title>Maintenance | Indovia Store</title>
    </Helmet>
    <div className="landing-page-maintenance">
          ...
          <main className="main">
            <div className="section">
              <div className="box-commingsoon">
                <div className="commingsoon-left">
                  <div className="box-logo-commingsoon mb-170"><a href="#"><img src="/assets/imgs/template/logo.svg" alt="Indovia" /></a></div>
                  <div className="box-info-commingsoon">
                    <h2 className="mb-10">Under Construction!</h2>
                    <p className="body-p2 mb-25">To make somethings right we need some time to rebuild. Get notified when we are done.</p>
                    <div className="form-newsletters mt-40">
                ...
                <div className="commingsoon-right maintenance-right"></div>
              </div>
            </div>
          </main>
