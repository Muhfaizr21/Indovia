...
const Index8 = () => (
  <>
    <Helmet>
      <title>Index 8 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-8">
      <header className="header sticky-bar header-type6">
            <div className="box-top-header"> 
              <div className="container">
                <div className="top-header"> 
                  <div className="socials-media"> <a className="social-icons-top fb" href="#"></a><a className="social-icons-top insta" href="#"></a><a className="social-icons-top tw" href="#"></a></div>
                  ...
                  <div className="lang-currency"> 
                    <div className="dropdown mr-20">
                      <button className="btn btn-line-bottom dropdown-toggle" id="dropdownLangHead" type="button" data-bs-toggle="dropdown" aria-expanded="false">EN</button>
                      <ul className="dropdown-menu" aria-labelledby="dropdownLangHead">
                    ...
                    <div className="dropdown">
                      <button className="btn btn-line-bottom dropdown-toggle" id="dropdownCurrencyHead" type="button" data-bs-toggle="dropdown" aria-expanded="false">USD</button>
                      <ul className="dropdown-menu" aria-labelledby="dropdownCurrencyHead">
          ...
          <main className="main">
            <section className="section banner-homepage2 banner-homepage8">
              <div className="box-swiper"> 
                <div className="swiper-container swiper-banner pb-0">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <div className="box-cover-image">
                        <div className="box-banner-info"> 
                          <div className="row align-items-center"> 
                            <div className="col-md-6 mb-30">
                              <p className="overline-t2-medium color-primary-dark mb-10 text-uppercase">New Collection</p>
                              <h2 className="heading-title-medium color-primary-dark mb-10">Italia Style</h2>
                              <p className="text-18-medium mb-30">Use code HOLIDAY at checkout. </p>
                              <div className="box-button-banner"> <a className="btn btn-black" href="#">Shop Now</a></div>
                            </div>
                            <div className="col-md-6 mb-30"><img src="/assets/imgs/page/homepage8/chair.png" alt="Indovia" /></div>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <section className="section block-collection-home8">
              <div className="container"> 
                <div className="row"> 
                  <div className="col-md-4"> 
                    <div className="cardCollection wow fadeInUp"> 
                      <div className="cardImage"> <img src="/assets/imgs/page/homepage8/collection.png" alt="Indovia" /></div>
                      <div className="cardInfo"> 
                        <h5 className="mb-30">Chairs</h5>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4"> 
                    <div className="cardCollection wow fadeInUp">
                      <div className="cardImage"> <img src="/assets/imgs/page/homepage8/collection2.png" alt="Indovia" /></div>
                      <div className="cardInfo"> 
                        <h5 className="mb-30">Final Reduction</h5>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4"> 
                    <div className="cardCollection wow fadeInUp">
                      <div className="cardImage"> <img src="/assets/imgs/page/homepage8/collection3.png" alt="Indovia" /></div>
                      <div className="cardInfo"> 
                        <h5 className="mb-30">Sale</h5>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="section block-product-home8">
              <div className="container"> 
                <div className="text-center"> 
                  <h3 className="wow fadeInUp">Handpicked Products</h3>
                </div>
                <div className="row mt-40"> 
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage8/product.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage8/product2.png" alt="Indovia" /></a>
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage8/product2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage8/product.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage8/product3.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage8/product4.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage8/product4.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage8/product3.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage8/product5.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage8/product6.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage8/product6.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage8/product5.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage8/product7.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage8/product8.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage8/product8.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage8/product7.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
            ...
            <section className="section box-banner-sale">
              <div className="container"> 
                <div className="text-center wow fadeInUp"> 
                  <h3>Seasonal Sale On</h3>
                  <p className="body-p2 neutral-medium-dark">A conscious collection made entirely from food crop waste, recycled <br className="d-none d-lg-block" />cotton, other more sustainable materials.</p>
                </div>
                <div className="mt-40 box-banner-image-sale"> 
                  <div className="box-dropdown-1 wow fadeInDown"> 
                    <div className="dropdown mr-20">
                      ...
                      <div className="dropdown-menu" aria-labelledby="dropdownFurniture1">Our Florence range includes - Radiator covers, Sideboards and Corner console tables. All products are available in any size and colour.</div>
                    </div>
                  </div>
                  <div className="box-dropdown-2 wow fadeInUp"> 
                    <div className="dropdown mr-20">
                      ...
                      <div className="dropdown-menu" aria-labelledby="dropdownFurniture2">Our Florence range includes - Radiator covers, Sideboards and Corner console tables. All products are available in any size and colour.</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section className="section block-instagram-type4-home7">
              ...
              <div className="box-gallery-instagram"> 
                <div className="gallery-item wow fadeInLeft"><img src="/assets/imgs/page/homepage8/insta.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage8/insta2.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage8/insta3.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage8/insta4.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInRight"><img src="/assets/imgs/page/homepage8/insta5.png" alt="Indovia" /></div>
              </div>
            </section>
