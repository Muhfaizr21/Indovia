...
const Index20 = () => (
  <>
    <Helmet>
      <title>Index 20 | Larkon Store</title>
    </Helmet>
                ...
                <div className="row align-items-center"> 
                  ...
                  <div className="col-lg-6">
                    <div className="box-image-banner-20">
                      <div className="image-banner-1"> <img src="/assets/imgs/page/homepage20/banner.png" alt="Guza" /></div>
                      <div className="image-banner-2"><img src="/assets/imgs/page/homepage20/banner2.png" alt="Guza" /></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="container">
                <div className="row mb-80">
                  <div className="col-lg-7">
                    <div className="box-banner-text-inner"><img src="/assets/imgs/page/homepage20/banner3.jpg" alt="Guza" />
                      ...
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage20/sp.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage20/sp.png" alt="guza" /></a>
                        ...
                        <div className="swiper-slide">
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage20/sp2.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage20/sp2.png" alt="guza" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                        ...
                        <div className="swiper-slide">
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage20/sp3.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage20/sp3.png" alt="guza" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
            ...
            <section className="section box-tip-home20">
              <div className="container"> 
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-7 mb-30"><img src="/assets/imgs/page/homepage20/tip.png" alt="Guza" /></div>
                </div>
              </div>
            </section>
