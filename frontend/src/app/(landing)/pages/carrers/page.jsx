...
const Carrers = () => (
  <>
    <Helmet>
      <title>Carrers | Indovia Store</title>
    </Helmet>
    <div className="landing-page-carrers">
      <header className="header sticky-bar">
          ...
          <main className="main">
            <div className="section banner-carrers">
              <div className="box-cover-image wow fadeInUp" style={{backgroundImage: "url(/assets/imgs/page/carrers/banner.png)"}}></div>
            </div>
            <section className="section block-testimonials block-testimonials-2">
              <div className="container"> 
                <div className="row align-items-center"> 
                  <div className="col-lg-4 wow fadeInUp"> 
                    <p className="text-17-medium text-uppercase mb-15 primary-navy">Our Values</p>
                    <h3 className="mb-15">Community, <br className="d-none d-lg-block" />Collaboration, <br className="d-none d-lg-block" />Transparency.</h3>
                    <p className="body-p2 neutral-medium-dark">We believe people are happier, healthier, and more fulfilled when they can afford to live well.</p>
                  </div>
                  <div className="col-lg-4 wow fadeInUp"> <img src="/assets/imgs/page/carrers/img1.png" alt="Indovia" /></div>
                  <div className="col-lg-4 wow fadeInUp"> <img src="/assets/imgs/page/carrers/img2.png" alt="Indovia" /></div>
                </div>
              </div>
            </section>
            <section className="section block-icon-box"> 
              <div className="container"> 
                <div className="text-center"> 
                  <h6 className="text-17-medium primary-navy text-uppercase mb-15 wow fadeInLeft">BeneFits</h6>
                  <h3 className="mb-65 wow fadeInRight">Values that define us</h3>
                </div>
                <div className="row"> 
                  <div className="col-lg-4 hasborder"> 
                    <div className="cardIcon wow fadeInUp">
                      ...
                      <div className="cardInfo">
                        <h6 className="cardTitle">Compensation</h6>
                        <p className="body-p2">Etiam eu turpis tincidunt, vehicula mi ut, imperdiet sem</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-4 hasborder"> 
                    <div className="cardIcon wow fadeInUp">
                      ...
                      <div className="cardInfo">
                        <h6 className="cardTitle">Flexibility</h6>
                        <p className="body-p2">Etiam eu turpis tincidunt, vehicula mi ut, imperdiet sem</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-4"> 
                    <div className="cardIcon wow fadeInUp">
                      ...
                      <div className="cardInfo">
                        <h6 className="cardTitle">Comprehensive Benefits</h6>
                        <p className="body-p2">Etiam eu turpis tincidunt, vehicula mi ut, imperdiet sem</p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="section block-testimonials block-testimonials-3">
              <div className="container"> 
                    ...
                    <div className="swiper-container swiper-banner">
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
                          <p className="text-34 mb-30 font-jost">“ We’re still so early — every individual makes a huge impact.”</p>
                          <p className="text-17-medium name-customers">Randy Workman</p>
                          <p className="body-p2">Founder of July.</p>
                        </div>
                        <div className="swiper-slide">
                          <p className="text-34 mb-30 font-jost">“ We’re still so early — every individual makes a huge impact.”</p>
                          <p className="text-17-medium name-customers">Randy Workman</p>
                        ...
                        <div className="swiper-slide">
                          <p className="text-34 mb-30 font-jost">“ We’re still so early — every individual makes a huge impact.”</p>
                          <p className="text-17-medium name-customers">Kevin Kay</p>
                          <p className="body-p2">Founder of July.</p>
                        </div>
                      </div>
                    </div>
            ...
            <section className="section block-open-positions">
              <div className="container"> 
                <div className="text-center"> 
                  <h6 className="text-17-medium primary-navy text-uppercase mb-15 wow fadeInLeft">Open positions</h6>
                  <h3 className="mb-65 wow fadeInRight">Joining us will Change Your Life</h3>
                </div>
                <div className="mt-60 wow fadeInUp"> 
                  <div className="box-open"> 
                    <div className="open-info"> 
                      <h6>Assistant Category Manager</h6>
                      <p className="body-p2 neutral-medium">Product / Full Time / Lake Colby, UK</p>
                    </div>
                    <div className="open-button"><a className="btn btn-black" href="#">Apply Now</a></div>
                  </div>
                  <div className="box-open"> 
                    <div className="open-info"> 
                      <h6>Assistant Category Manager</h6>
