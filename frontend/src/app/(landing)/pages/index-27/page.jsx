...
const Index27 = () => (
  <>
    <Helmet>
      <title>Index 27 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-27">
      <header className="header sticky-bar header-style-2 header-style-2-nofix">
          ...
          <main className="main">
            <section className="section banner-homepage2">
              <div className="box-swiper">
                <div className="swiper-container swiper-banner pb-0">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <div className="box-cover-image" style={{backgroundImage: "url(/assets/imgs/page/homepage27/banner.png)"}}></div>
                      <div className="box-banner-info wow fadeInUp">
                        <h2 className="heading-title-medium color-primary-dark mb-15">Rent it.<br className="d-block" />Wear it.<br className="d-sm-block" />Love it.</h2>
                        <p className="fonticon-20 mb-30">Use code HOLIDAY at checkout.</p>
                        <div className="text-start"><a className="btn btn-black" href="#">Shop Now</a></div>
                      </div>
                    </div>
                    <div className="swiper-slide">
                      <div className="box-cover-image" style={{backgroundImage: "url(/assets/imgs/page/homepage27/banner2.png)"}}></div>
                      <div className="box-banner-info wow fadeInUp">
                        <h2 className="heading-title-medium color-primary-dark mb-30">Rent it.<br className="d-sm-block" />Wear it.<br className="d-sm-block" />Love it.</h2>
                        <p className="fonticon-20 mb-30">Use code HOLIDAY at checkout.</p>
                        <div className="text-start"><a className="btn btn-black" href="#">Shop Now</a></div>
                      </div>
                    </div>
            ...
            <section className="section block-banner-2-home27 block-padding-40">
              <div className="container"> 
                <div className="banner-2-col"> 
                  <div className="box-banner-col">
                    <div className="banner-grey"> 
                      <div className="banner-info-top">
                        <h3>New Technology</h3>
                        <p className="body-p2">Leather Case with MagSafe</p><a className="btn btn-border-medium" href="#">Discover</a>
                      </div>
                      <div className="banner-image"> <img src="/assets/imgs/page/homepage27/new-tech.png" alt="Indovia" /></div>
                    </div>
                  </div>
                  <div className="box-banner-col">
                    <div className="banner-grey"> 
                      <div className="banner-info-top">
                        <h3>Wallet Case</h3>
                        <p className="body-p2">All-in-one design</p><a className="btn btn-border-medium" href="#">Discover</a>
                      </div>
                      <div className="banner-image"> <img src="/assets/imgs/page/homepage27/wallet.png" alt="Indovia" /></div>
                    </div>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-show-by-category block-padding-40">
              <div className="container"> 
                <div className="text-center"> 
                  <h3 className="mb-30">Browse by Category</h3>
                </div>
                <div className="showbycategory-list">
                  <div className="item-category"> <a href="#"> <span>Wood </span></a></div>
                  <div className="item-category"> <a href="#"> <span>Silicone</span></a></div>
                  <div className="item-category"> <a href="#"> <span>Wallet</span></a></div>
                  <div className="item-category"> <a href="#"> <span>Hard</span></a></div>
                  <div className="item-category"> <a href="#"> <span>Clear</span></a></div>
                </div>
              </div>
            </section>
            <section className="section block-our-products block-padding-40">
              <div className="container"> 
                <div className="text-center"> 
                  <h3 className="mb-20">Our Products</h3>
                </div>
                <div className="box-list-our-products"> 
                  <div className="box-tabs mt-0 mb-0 wow fadeInDown"> 
                    <ul className="nav nav-tabs nav-tabs-small justify-content-center" role="tablist">
                      <li className="nav-item" role="presentation">
                        <button className="nav-link active" id="hotitems-tab" data-bs-toggle="tab" data-bs-target="#hotitems" type="button" role="tab" aria-controls="hotitems" aria-selected="true">Hot items</button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="onsale-tab" data-bs-toggle="tab" data-bs-target="#onsale" type="button" role="tab" aria-controls="onsale" aria-selected="false">On Sale</button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="bestsellers-tab" data-bs-toggle="tab" data-bs-target="#bestsellers" type="button" role="tab" aria-controls="bestsellers" aria-selected="false">Best Sallers</button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="toprate-tab" data-bs-toggle="tab" data-bs-target="#toprate" type="button" role="tab" aria-controls="toprate" aria-selected="false">Top Rate</button>
                      </li>
                    </ul>
                  </div>
                  <div className="tab-content mt-40">
                    <div className="tab-pane fade show active" id="hotitems" role="tabpanel" aria-labelledby="hotitems-tab">
                      <div className="row">   
                        <div className="col-lg-3 col-sm-6"> 
                          <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage27/phone.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage27/phone.png" alt="Indovia" /></a>
                            ...
                            <div className="cardInfo">
                              <h6 className="text-16-medium">Rib Turtleneck Sweater</h6>
                              <p className="body-p2 cardDesc"><span className="sale-price">$150.00</span><span className="main-price">$100.00</span></p>
                            </div>
                          </div>
                        </div>
                        <div className="col-lg-3 col-sm-6"> 
                          <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage27/phone2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage27/phone2.png" alt="Indovia" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                        ...
                        <div className="col-lg-3 col-sm-6"> 
                          <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage27/phone3.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage27/phone3.png" alt="Indovia" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                        ...
                        <div className="col-lg-3 col-sm-6"> 
                          <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage27/phone4.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage27/phone4.png" alt="Indovia" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                            ...
                            <div className="cardInfo">
                              <h6 className="text-16-medium">Rib Turtleneck Sweater</h6>
                              <p className="body-p2 cardDesc"><span className="sale-price"></span><span className="main-price">$129.00</span></p>
                            </div>
                          </div>
                        </div>
                        <div className="col-lg-3 col-sm-6"> 
                          <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage27/phone5.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage27/phone5.png" alt="Indovia" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                        ...
                        <div className="col-lg-3 col-sm-6"> 
                          <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage27/phone6.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage27/phone6.png" alt="Indovia" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                        ...
                        <div className="col-lg-3 col-sm-6"> 
                          <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage27/phone7.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage27/phone7.png" alt="Indovia" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                        ...
                        <div className="col-lg-3 col-sm-6"> 
                          <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage27/phone8.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage27/phone8.png" alt="Indovia" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="mt-30 text-center"> <a className="btn btn-border" href="#">Load more</a></div>
                    </div>
                    ...
                    <div className="tab-pane fade" id="bestsellers" role="tabpanel" aria-labelledby="bestsellers-tab"> 
                      <div className="row">   
                        <div className="col-lg-3 col-sm-6"> 
                          <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage27/phone.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage27/phone.png" alt="Indovia" /></a>
                    ...
                    <div className="tab-pane fade" id="toprate" role="tabpanel" aria-labelledby="toprate-tab"> 
                      <div className="row">   
                        <div className="col-lg-3 col-sm-6"> 
                          <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage27/phone.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage27/phone.png" alt="Indovia" /></a>
            ...
            <section className="section block-testimonials">
              <div className="container"> 
                <div className="text-center">
                  <h3 className="neutral-dark mb-40 title-line-bottom wow fadeInLeft">Customers Reviews</h3>
                </div>
            ...
            <section className="section block-icon-box-type3 pb-80"> 
              <div className="container"> 
                <div className="row"> 
                  <div className="col-md-3 col-sm-6"> 
                    <div className="cardIcon cardIconType3 wow fadeInUp">
                      <div className="cardImage"><img src="/assets/imgs/page/homepage26/discount.svg" alt="Indovia" /></div>
                      <div className="cardInfo">
                        <h6 className="cardTitle">Get Discount</h6>
                        <p className="body-p2">Discounts for new customers</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-3 col-sm-6"> 
                    <div className="cardIcon cardIconType3 wow fadeInUp">
                      <div className="cardImage"><img src="/assets/imgs/page/homepage26/ship.svg" alt="Indovia" /></div>
                      <div className="cardInfo">
                        <h6 className="cardTitle">Set Shipping Time</h6>
                        <p className="body-p2">Receive goods at the desired time</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-3 col-sm-6"> 
                    <div className="cardIcon cardIconType3 wow fadeInUp">
                      <div className="cardImage"><img src="/assets/imgs/page/homepage26/return.svg" alt="Indovia" /></div>
                      <div className="cardInfo">
                        <h6 className="cardTitle">Return Policy</h6>
                        <p className="body-p2">Exchange within 30 days</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-3 col-sm-6"> 
                    <div className="cardIcon cardIconType3 wow fadeInUp">
                      <div className="cardImage"><img src="/assets/imgs/page/homepage26/check.svg" alt="Indovia" /></div>
                      <div className="cardInfo">
                        <h6 className="cardTitle">Check Product</h6>
                        <p className="body-p2">Check goods by barcode</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="section block-instagram-type-4 block-instagram-type-2 pb-0">
              <div className="container"> 
                <div className="text-center">
                  <h3 className="mb-5 wow fadeInLeft">Instagram with <span className="primary-navy">#July</span></h3>
                  <p className="body-p2 neutral-medium-dark wow fadeInUp">Follow us on Instagram to update every single day.</p>
                </div>
              </div>
              <div className="box-gallery-instagram box-gallery-instagram-type2 mt-40 wow fadeInDown"> 
                <div className="box-gallery-instagram-type2-inner">
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage27/insta3.png" alt="Indovia" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage27/insta1.png" alt="Indovia" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage27/insta2.png" alt="Indovia" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage27/insta3.png" alt="Indovia" /><a href="#">Shop on Instagram</a></div>
                </div>
              </div>
            </section>
          </main>
          <footer className="footer footer-type3-light footer-type3-grey">
