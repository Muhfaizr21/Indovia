...
const Lookbook = () => (
  <>
    <Helmet>
      <title>Lookbook | Larkon Store</title>
    </Helmet>
            ...
            <section className="section block-content-lookbook">
              <div className="list-lookbok">
                <div className="item-lookbook">
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook/img.png" alt="Guza" /></div>
                ...
                <div className="item-lookbook">
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook/img2.png" alt="Guza" /></div>
                  <div className="item-lookbook-info">
                ...
                <div className="item-lookbook">
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook/img3.png" alt="Guza" /></div>
                  <div className="item-lookbook-info">
                ...
                <div className="item-lookbook">
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook/img4.png" alt="Guza" /></div>
                  <div className="item-lookbook-info">
                ...
                <div className="item-lookbook">
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook/img5.png" alt="Guza" /></div>
                  <div className="item-lookbook-info">
                ...
                <div className="item-lookbook">
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook/img6.png" alt="Guza" /></div>
                  <div className="item-lookbook-info">
                ...
                <div className="item-lookbook">
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook/img7.png" alt="Guza" /></div>
                  <div className="item-lookbook-info">
                ...
                <div className="item-lookbook">
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook/img8.png" alt="Guza" /></div>
                  <div className="item-lookbook-info">
                ...
                <div className="item-lookbook">
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook/img9.png" alt="Guza" /></div>
                  <div className="item-lookbook-info">
