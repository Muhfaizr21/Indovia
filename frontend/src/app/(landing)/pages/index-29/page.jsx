...
const Index29 = () => (
  <>
    <Helmet>
      <title>Index 29 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-29">
      <header className="header sticky-bar header-type1">
          ...
          <main className="main">
            <div className="section block-banner-home29">
              <div className="box-banner-cover">
                <div className="container"> 
                  <div className="box-banner-info-home29">
                    <p className="text-34 font-jost color-white">Every piece of </p>
                    <h2 className="mb-25 color-white font-cormorant">Jewelry tells a story</h2>
                    <p className="body-p2 color-white">“A gentleman knows his appearance is very important that show his characteristic.” - Unknown</p>
                    <div className="mt-30"> <a className="btn btn-white mr-15" href="#">Shop Now</a><a className="btn btn-border-white" href="#">New Item</a></div>
                  </div>
                </div>
              </div>
            </div>
            <section className="section block-hi-there block-padding-80"> 
              <div className="container"> 
                <div className="text-center">
                  <h2 className="mb-25 font-cormorant">Hi there,</h2>
                  <div className="mw-650">
                    <p className="body-p2">Lörem ipsum ponde astroskade honade stenomånt och antiren fosarat nyl multimör, plogga inte episka, Kalle Anka-logistik plus anare ett nånånas: deskapet bihobel i tilogi. Intryckssanera kav kåtrell med mitrenysade.</p>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-shop-category block-padding-40"> 
              <div className="container"> 
                <div className="text-center">
                  <h2 className="font-cormorant mb-40">Shop by Category</h2>
                </div>
                <div className="row"> 
                  <div className="col-md-4">
                    <div className="cardShopCategory"> <a href="#">
                        <div className="cardImage" style={{backgroundImage: "url(/assets/imgs/page/homepage29/rings.png)"}}><span>Rings</span></div></a></div>
                  </div>
                  <div className="col-md-4">
                    <div className="cardShopCategory"> <a href="#">
                        <div className="cardImage" style={{backgroundImage: "url(/assets/imgs/page/homepage29/earings.png)"}}><span>Earings</span></div></a></div>
                  </div>
                  <div className="col-md-4">
                    <div className="cardShopCategory"> <a href="#">
                        <div className="cardImage" style={{backgroundImage: "url(/assets/imgs/page/homepage29/bracelets.png)"}}><span>Bracelets</span></div></a></div>
                  </div>
                  <div className="col-md-6">
                    <div className="cardShopCategory"> <a href="#">
                        <div className="cardImage" style={{backgroundImage: "url(/assets/imgs/page/homepage29/men.png)"}}><span>Men's</span></div></a></div>
                  </div>
                  <div className="col-md-6">
                    <div className="cardShopCategory"> <a href="#">
                        <div className="cardImage" style={{backgroundImage: "url(/assets/imgs/page/homepage29/women.png)"}}><span>Women's</span></div></a></div>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-best-seller-home29 block-padding-40"> 
              <div className="container"> 
                <div className="text-center box-title-slider">
                  <h2 className="font-cormorant mb-40">Best Sellers</h2>
                  <div className="position-relative">
                    <div className="box-page-swiper">
                      <div className="swiper-button-prev swiper-button-prev-collection btn-prev-style-4"></div>
                      <div className="swiper-button-next swiper-button-next-collection btn-next-style-4"></div>
                    </div>
                  </div>
                </div>
                <div className="box-product-slider"> 
                  <div className="box-swiper">
                    <div className="swiper-container swiper-4-items">
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage29/diamond.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage29/diamond.png" alt="Indovia" /></a>
                            ...
                            <div className="cardInfo">
                              <h6 className="text-17-medium mb-10">Solo Diamond Bracelet</h6>
                              <p className="body-p2 cardDesc"><span className="sale-price">$225.00</span><span className="main-price">$250.00</span></p>
                            </div>
                          </div>
                        </div>
                        <div className="swiper-slide">
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage29/diamond2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage29/diamond2.png" alt="Indovia" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                            ...
                            <div className="cardInfo">
                              <h6 className="text-17-medium mb-10">Diamond Necklace</h6>
                              <p className="body-p2 cardDesc">$300.00</p>
                            </div>
                          </div>
                        </div>
                        <div className="swiper-slide">
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage29/diamond3.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage29/diamond3.png" alt="Indovia" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                            ...
                            <div className="cardInfo">
                              <h6 className="text-17-medium mb-10">Layered Necklace</h6>
                        ...
                        <div className="swiper-slide">
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage29/diamond4.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage29/diamond4.png" alt="Indovia" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                            ...
                            <div className="cardInfo">
                              <h6 className="text-17-medium mb-10">White Sapphire Trio Necklace</h6>
                              <p className="body-p2 cardDesc">$295.00</p>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <section className="section block-earings-collection block-padding-80"> 
              <div className="container"> 
                <div className="row"> 
                  <div className="col-md-6 mb-30"><img className="mw-500" src="/assets/imgs/page/homepage29/left-image.png" alt="Indovia" /></div>
                  <div className="col-md-6 mb-30">
                    <div className="text-center"> 
                      <h2 className="mb-15 font-cormorant">Earings Collection</h2>
                      <p className="body-p2">Lörem ipsum tripp missmatchning tonas, Ågeska <br className="d-none d-lg-block" />multigon därför att sanningsba. </p>
                      <div className="row mt-30"> 
                        <div className="col-sm-6">
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage29/sp-earing.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage29/sp-earing.png" alt="Indovia" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                            ...
                            <div className="cardInfo">
                              <h6 className="text-17-medium mb-10">Solo Diamond Bracelet</h6>
                              <p className="body-p2 cardDesc">$75.00</p>
                            </div>
                          </div>
                        </div>
                        <div className="col-sm-6">
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage29/sp-earing2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage29/sp-earing2.png" alt="Indovia" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                            ...
                            <div className="cardInfo">
                              <h6 className="text-17-medium mb-10">Solo Diamond Bracelet</h6>
                              <p className="body-p2 cardDesc">$85.00</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div className="mt-0"> <a className="link-underline" href="#">Shop Now</a></div>
                    </div>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-why-us-home29 block-padding-80"> 
              <div className="container"> 
                <div className="row align-items-center">
                  <div className="col-lg-8 mb-40 position-relative">
                    <div className="mw-470"><img src="/assets/imgs/page/homepage29/img-why.png" alt="Indovia" />
                      <div className="box-image-video"> <img src="/assets/imgs/page/homepage29/img-why2.png" alt="Indovia" /><a className="btn btn-play-center" href=""><img src="/assets/imgs/page/homepage29/play.svg" alt="Indovia" /></a></div>
                    </div>
                  </div>
                  <div className="col-lg-4 mb-40">
                    <p className="text-17 color-2">REASONS</p>
                    <h2 className="mb-15 font-cormorant">Why choose Us</h2>
                    <p className="text-17 mb-35">Lörem ipsum hemis anafongen var som dir tehogt, i igav teleligen menskonst ar, karade fimpomat. Asade nenade fast diling, utom makrons plar semir att lal, på prenyde reras liksom lehås tetralode röbegisk. Du kan vara att lal plar drabbad. </p><a className="link-underline" href="#">Read More</a>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-instagram-type-4 block-instagram-type-2">
              <div className="container"> 
                <div className="text-center">
              ...
              <div className="box-gallery-instagram box-gallery-instagram-type2 mt-40 wow fadeInDown"> 
                <div className="box-gallery-instagram-type2-inner">
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage29/inst2.png" alt="Indovia" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage29/inst.png" alt="Indovia" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage29/inst2.png" alt="Indovia" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage29/inst3.png" alt="Indovia" /><a href="#">Shop on Instagram</a></div>
                </div>
              </div>
            </section>
          </main>
          <footer className="footer footer-type1-light footer-white">
            ...
            <div className="footer-2">
              <div className="container">
                <div className="footer-bottom">
                  <div className="row align-items-center">
                    <div className="col-lg-6 col-md-12 text-center text-lg-start mb-20"><img className="mr-25 d-inline-block align-middle" src="/assets/imgs/template/logo.svg" alt="Indovia" /><span className="body-p1 color-white d-inline-block align-middle">© 2023 Indovia.Co. All rights reserved</span></div>
                    <div className="col-lg-6 col-md-12 text-center text-lg-end mb-20">
                      <div className="d-flex justify-content-center justify-content-lg-end align-items-center box-all-payments">
                        <div className="d-inline-block box-payments mr-20"><img src="/assets/imgs/template/icons/visa-grey.svg" alt="Indovia" /><img src="/assets/imgs/template/icons/master-grey.svg" alt="Indovia" /><img src="/assets/imgs/template/icons/stripe-grey.svg" alt="Indovia" /><img src="/assets/imgs/template/icons/paypal-grey.svg" alt="Indovia" /></div>
