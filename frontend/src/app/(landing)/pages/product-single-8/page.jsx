...
const ProductSingle8 = () => (
  <>
    <Helmet>
      <title>Product Single 8 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-product-single-8">
              ...
              <div className="container">
                <div className="row mb-40">
                  <div className="col-lg-6">
                    <div className="detail-gallery detail-gallery-6 detail-gallery-7 detail-gallery-8">
                      <div className="box-main-gallery">
                        <figure className="border-radius-10"><a className="zoom-image glightbox" href="/assets/imgs/page/product/img2.png"></a><a className="glightbox link-image" href="/assets/imgs/page/product/img2.png"><img src="/assets/imgs/page/product/img2.png" alt="kidify" /></a></figure>
                        <figure className="border-radius-10"><a className="zoom-image glightbox" href="/assets/imgs/page/product/img.png"></a><a className="glightbox link-image" href="/assets/imgs/page/product/img.png"><img src="/assets/imgs/page/product/img.png" alt="kidify" /></a></figure>
                        <figure className="border-radius-10"><a className="zoom-image glightbox" href="/assets/imgs/page/product/img.png"></a><a className="glightbox link-image" href="/assets/imgs/page/product/img.png"><img src="/assets/imgs/page/product/img.png" alt="kidify" /></a></figure>
                        <figure className="border-radius-10"><a className="zoom-image glightbox" href="/assets/imgs/page/product/img.png"></a><a className="glightbox link-image" href="/assets/imgs/page/product/img.png"><img src="/assets/imgs/page/product/img.png" alt="kidify" /></a></figure>
                        <figure className="border-radius-10"><a className="zoom-image glightbox" href="/assets/imgs/page/product/img.png"></a><a className="glightbox link-image" href="/assets/imgs/page/product/img.png"><img src="/assets/imgs/page/product/img.png" alt="kidify" /></a></figure>
                        <figure className="border-radius-10"><a className="zoom-image glightbox" href="/assets/imgs/page/product/img.png"></a><a className="glightbox link-image" href="/assets/imgs/page/product/img.png"><img src="/assets/imgs/page/product/img.png" alt="kidify" /></a></figure>
                  ...
                  <div className="col-lg-6">
                    <div className="box-product-info box-product-info-stick">
                      ...
                      <div className="box-detail-product box-detail-product-2">
                        <ul className="nav-tabs nav-tab-product justify-content-start" role="tablist">
