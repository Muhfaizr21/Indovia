...
const ProductSingle6 = () => (
  <>
    <Helmet>
      <title>Product Single 6 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-product-single-6">
              ...
              <div className="container">
                <div className="row mb-40">
                  <div className="col-lg-6">
                    <div className="detail-gallery detail-gallery-6">
