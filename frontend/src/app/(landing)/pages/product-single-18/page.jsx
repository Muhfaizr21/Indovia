...
const ProductSingle18 = () => (
  <>
    <Helmet>
      <title>Product Single 18 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-product-single-18">
                  ...
                  <div className="col-lg-6">
                    <div className="box-product-info"> 
                      ...
                      <div className="block-description"> 
                        <p className="body-p2 neutral-medium-dark">The shorts are made from soft organic cotton. They have an elasticated waistband with an internal drawstring and side pockets. Designed for simplicity and made from high quality materials. Its sleek geometry and material combinations creates a modern look.</p>
                      </div>
                      <div className="block-buy-on-amazone"> <a className="btn btn-black" href="#">Buy On Amazon</a></div>
                      ...
                      <div className="block-socials-product block-socials-product-big"> <span className="body-p2 neutral-medium-dark">Share:</span><a className="social-neutral-dark" href="#">
...
export default ProductSingle18;
