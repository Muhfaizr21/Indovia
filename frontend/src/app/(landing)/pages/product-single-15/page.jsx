...
const ProductSingle15 = () => (
  <>
    <Helmet>
      <title>Product Single 15 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-product-single-15">
                  ...
                  <div className="col-lg-6">
                    <div className="box-product-info">
                      ...
                      <div className="block-color"><span>Color:</span>
                        <label>Navy</label>
                        <div className="list-img-colors">
                          <div className="box-img-colors">
                            <div className="item-img-color"><img src="/assets/imgs/page/product15/img-color.png" alt="Indovia" /></div>
                            <div className="item-img-color active"><img src="/assets/imgs/page/product15/img-color2.png" alt="Indovia" /></div>
                            <div className="item-img-color"><img src="/assets/imgs/page/product15/img-color3.png" alt="Indovia" /></div>
                          </div>
                        </div>
                      </div>
...
export default ProductSingle15;
