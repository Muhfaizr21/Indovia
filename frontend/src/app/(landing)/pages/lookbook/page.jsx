...
const Lookbook = () => (
  <>
    <Helmet>
      <title>Lookbook | Indovia Store</title>
    </Helmet>
    <div className="landing-page-lookbook">
      <header className="header sticky-bar header-style-2">
          ...
          <main className="main">
            <section className="section block-content-lookbook">
              <div className="list-lookbok">
                <div className="item-lookbook">
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook/img.png" alt="Indovia" /></div>
                  <div className="item-lookbook-info">
                    <p className="text-24 color-white">WINTER 2023</p>
                    <div className="box-button-lookbook"><a className="btn btn-border-white" href="#">Discover</a></div>
                  </div>
                </div>
                <div className="item-lookbook">
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook/img2.png" alt="Indovia" /></div>
                  <div className="item-lookbook-info">
                    <p className="text-24 color-white">MENWEAR 2023</p>
                    <div className="box-button-lookbook"><a className="btn btn-border-white" href="#">Discover</a></div>
                  </div>
                </div>
                <div className="item-lookbook">
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook/img3.png" alt="Indovia" /></div>
                  <div className="item-lookbook-info">
                    <p className="text-24 color-white">SUMNER 2023</p>
                    <div className="box-button-lookbook"><a className="btn btn-border-white" href="#">Discover</a></div>
                  </div>
                </div>
                <div className="item-lookbook">
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook/img4.png" alt="Indovia" /></div>
                  <div className="item-lookbook-info">
                    <p className="text-24 color-white">JACKETS 2023</p>
                    <div className="box-button-lookbook"><a className="btn btn-border-white" href="#">Discover</a></div>
                  </div>
                </div>
                <div className="item-lookbook">
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook/img5.png" alt="Indovia" /></div>
                  <div className="item-lookbook-info">
                    <p className="text-24 color-white">RESORT 2023</p>
                    <div className="box-button-lookbook"><a className="btn btn-border-white" href="#">Discover</a></div>
                  </div>
                </div>
                <div className="item-lookbook">
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook/img6.png" alt="Indovia" /></div>
                  <div className="item-lookbook-info">
                    <p className="text-24 color-white">FALL / SPRING 2023</p>
                    <div className="box-button-lookbook"><a className="btn btn-border-white" href="#">Discover</a></div>
                  </div>
                </div>
                <div className="item-lookbook">
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook/img7.png" alt="Indovia" /></div>
                  <div className="item-lookbook-info">
                    <p className="text-24 color-white">BEACH CAPSULE</p>
                    <div className="box-button-lookbook"><a className="btn btn-border-white" href="#">Discover</a></div>
                  </div>
                </div>
                <div className="item-lookbook">
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook/img8.png" alt="Indovia" /></div>
                  <div className="item-lookbook-info">
                    <p className="text-24 color-white">Autumn JEANS 2023</p>
                    <div className="box-button-lookbook"><a className="btn btn-border-white" href="#">Discover</a></div>
                  </div>
                </div>
                <div className="item-lookbook">
                  <div className="item-lookbook-image"><img src="/assets/imgs/page/lookbook/img9.png" alt="Indovia" /></div>
                  <div className="item-lookbook-info">
                    <p className="text-24 color-white">FALL / WINTER 2022</p>
                    <div className="box-button-lookbook"><a className="btn btn-border-white" href="#">Discover</a></div>
                  </div>
                </div>
              </div>
