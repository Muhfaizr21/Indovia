...
const Index34 = () => (
  <>
    <Helmet>
      <title>Index 34 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-34">
      <header className="header sticky-bar header-type1">
          ...
          <main className="main">
            <div className="section block-banner-home34 section banner-homepage22">
              <div className="box-swiper">
                <div className="swiper-container swiper-banner pb-0">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <div className="box-cover-image wow fadeInUp" style={{backgroundImage: "url(/assets/imgs/page/homepage34/banner.jpg)"}}></div>
                      <div className="box-banner-info wow fadeInLeft">
                        <h5 className="color-white mb-15">New season, New Clothes</h5>
                        <h1 className="text-68-medium color-white mb-30">UP TO 50% OFF</h1>
                        <div className="text-center"><a className="btn btn-border-white mr-20" href="#">Shop Mens</a><a className="btn btn-border-white" href="#">Shop Womens</a></div>
                      </div>
                    </div>
                    <div className="swiper-slide">
                      <div className="box-cover-image wow fadeInUp" style={{backgroundImage: "url(/assets/imgs/page/homepage34/banner2.jpg)"}}></div>
                      <div className="box-banner-info wow fadeInLeft">
                        <h5 className="color-white mb-15">New season, New Clothes</h5>
                        <h1 className="text-68-medium color-white mb-30">UP TO 50% OFF</h1>
                        <div className="text-center"><a className="btn btn-border-white mr-20" href="#">Shop Mens</a><a className="btn btn-border-white" href="#">Shop Womens</a></div>
            ...
            <section className="section block-cate-home34 block-padding-40"> 
              <div className="container"> 
                <div className="row"> 
                  <div className="col-md-4">
                    <div className="cardImageTextMiddle">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage34/mens.png" alt="Indovia" /></a></div>
                      <div className="cardText"><a href="#">
                          <h2 className="mb-20">MENS</h2></a><a className="btn btn-border-white-medium" href="#">Shop Now</a></div>
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="cardImageTextMiddle">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage34/womens.png" alt="Indovia" /></a></div>
                      <div className="cardText"><a href="#">
                          <h2 className="mb-20">WOMENS</h2></a><a className="btn btn-border-white-medium" href="#">Shop Now</a></div>
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="cardImageTextMiddle">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage34/kids.png" alt="Indovia" /></a></div>
                      <div className="cardText"><a href="#">
                          <h2 className="mb-20">KIDS</h2></a><a className="btn btn-border-white-medium" href="#">Shop Now</a></div>
                    </div>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-product-home34 block-padding-40"> 
              <div className="container"> 
                <div className="text-center">
                  <h4 className="mb-40">SHOP FREE-SPIRITED STYLES</h4>
                </div>
                <div className="row productNotsaleType02"> 
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage34/sp.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage34/sp.png" alt="Indovia" /></a>
                      ...
                      <div className="cardInfo">
                        <h6 className="text-17-medium mb-10">Black Jeans</h6>
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage34/sp2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage34/sp2.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="cardInfo">
                        <h6 className="text-17-medium mb-10">Modern Jeans</h6>
                        <p className="body-p2 cardDesc">$135.00</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage34/sp3.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage34/sp3.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="cardInfo">
                        <h6 className="text-17-medium mb-10">Straight Ankle Women Jeans</h6>
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage34/sp4.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage34/sp4.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="cardInfo">
                        <h6 className="text-17-medium mb-10">Low Rise 2.0 Jeans</h6>
                        <p className="body-p2 cardDesc">$150.00</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage34/sp5.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage34/sp5.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage34/sp6.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage34/sp6.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage34/sp7.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage34/sp7.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage34/sp8.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage34/sp8.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                ...
                <div className="text-center mt-20"> <a className="btn btn-border" href="#">View More</a></div>
              </div>
            </section>
            <div className="section block-banner-home33 block-padding-40">
              <div className="box-swiper"> 
                <div className="swiper-container swiper-group-center-items pb-0">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide"> 
                      <div className="card-category-banner"> <img src="/assets/imgs/page/homepage34/relaxed.jpg" alt="Indovia" />
                        <div className="card-info"> 
                          <h2 className="mb-15">RELAXED</h2><a className="btn btn-border-white-medium" href="#">Shop Now</a>
                        </div>
                      </div>
                    </div>
                    <div className="swiper-slide"> 
                      <div className="card-category-banner"> <img src="/assets/imgs/page/homepage34/straight.jpg" alt="Indovia" />
                        <div className="card-info"> 
                          <h2 className="mb-15">STRAIGHT</h2><a className="btn btn-border-white-medium" href="#">Shop Now</a>
                        </div>
                      </div>
                    </div>
                    <div className="swiper-slide"> 
                      <div className="card-category-banner"> <img src="/assets/imgs/page/homepage34/bootcut.jpg" alt="Indovia" />
                        <div className="card-info"> 
                          <h2 className="mb-15">BOOTCUT</h2><a className="btn btn-border-white-medium" href="#">Shop Now</a>
                        </div>
                      </div>
                    </div>
                    <div className="swiper-slide"> 
                ...
                <div className="box-pagination-button box-pagination-leftright">
                  <div className="swiper-button-prev swiper-button-prev-group-center-items btn-prev-style-1"></div>
                  <div className="swiper-button-next swiper-button-next-group-center-items btn-next-style-1"></div>
                </div>
              </div>
            </div>
            ...
            <section className="section block-instagram-type-4 block-instagram-type-2 block-padding-40">
              <div className="container"> 
                <div className="text-center">
              ...
              <div className="box-gallery-instagram box-gallery-instagram-type2 mt-40 wow fadeInDown"> 
                <div className="box-gallery-instagram-type2-inner">
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage34/insta2.png" alt="Indovia" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage34/insta.png" alt="Indovia" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage34/insta2.png" alt="Indovia" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage34/insta3.png" alt="Indovia" /><a href="#">Shop on Instagram</a></div>
                </div>
              </div>
            </section>
          </main>
