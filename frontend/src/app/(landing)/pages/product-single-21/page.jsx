...
const ProductSingle21 = () => (
  <>
    <Helmet>
      <title>Product Single 21 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-product-single-21">
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    <div className="box-product-info">
                      ...
                      <div className="block-save-more">
                        <h6 className="mb-10">Buy more save more.</h6>
                        <div className="box-savemore-border">
                          <div className="item-savemore"><span className="btn btn-red">$2.00 OFF</span>
                            <div className="info-savemore">
                              <p className="text-16-medium">4 items get $2,00 OFF</p>
                              <p className="body-p1">on each product</p>
                            </div><a className="btn btn-add" href="#">Add</a>
                          </div>
                          <div className="item-savemore"><span className="btn btn-red">$4.00 OFF</span>
                            <div className="info-savemore">
                              <p className="text-16-medium">8 items get $4,00 OFF</p>
                              <p className="body-p1">on each product</p>
                            </div><a className="btn btn-add" href="#">Add</a>
                          </div>
                          <div className="item-savemore"><span className="btn btn-red">$6.00 OFF</span>
                            <div className="info-savemore">
                              <p className="text-16-medium">12 items get $6,00 OFF</p>
                              <p className="body-p1">on each product</p>
                            </div><a className="btn btn-add" href="#">Add</a>
                          </div>
                        </div>
...
export default ProductSingle21;
