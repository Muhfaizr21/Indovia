...
const Landing404 = () => (
  <>
    <Helmet>
      <title>404 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-404">
      <header className="header sticky-bar">
          ...
          <main className="main">
            <section className="section block-content-404">
              <div className="container"> 
                <div className="text-center"> 
                  <div className="box-image-404"> <img src="/assets/imgs/page/404/404.svg" alt="Indovia" /></div>
                  <h1 className="mb-25">404 - Not found!</h1>
                  <p className="text-20">This page could not be found.<br />Continue to the Home Page</p>
                </div>
              </div>
            </section>
          </main>
