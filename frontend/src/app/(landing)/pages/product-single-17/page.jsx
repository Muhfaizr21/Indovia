...
const ProductSingle17 = () => (
  <>
    <Helmet>
      <title>Product Single 17 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-product-single-17">
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    <div className="box-product-info">
                      ...
                      <div className="block-stock"><span className="text-stock">2,000 items left in stock</span>
...
export default ProductSingle17;
