...
const Index9 = () => (
  <>
    <Helmet>
      <title>Index 9 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-9">
      <header className="header sticky-bar">
          ...
          <main className="main">
            <section className="section banner-homepage7 banner-homepage9">
              <div className="box-swiper"> 
                <div className="swiper-container swiper-banner pb-0">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <div className="box-cover-image"> <img src="/assets/imgs/page/homepage9/banner.png" alt="Indovia" /></div>
                      <div className="box-banner-info"> 
                        <div className="text-center"> 
                          <p className="overline-t2-medium color-primary-dark mb-10">HANDMADE & NEW</p>
                          <h2 className="text-72-bold color-primary-dark mb-10">Excellence House</h2>
                          <p className="fonticon-24 mb-30">Use code HOLIDAY at checkout. Ends 11/29/21</p>
                          <div className="text-center"> <a className="btn btn-black" href="#">Shop Now</a></div>
                        </div>
                      </div>
                    </div>
                    <div className="swiper-slide">
                      ...
                      <div className="box-banner-info"> 
                        <div className="text-center"> 
                          <p className="overline-t2-medium color-primary-dark mb-10">HANDMADE & NEW</p>
                          <h2 className="text-72-bold color-primary-dark mb-10">Find Your Fit</h2>
                          <p className="fonticon-24 mb-30">Use code HOLIDAY at checkout. Ends 11/29/21</p>
                          <div className="text-center"> <a className="btn btn-black" href="#">Shop Now</a></div>
                        </div>
                      </div>
            ...
            <section className="section block-product-home8">
              <div className="container"> 
                <div className="text-center"> 
                  <h3 className="mb-50 wow fadeInUp">Featured Categories</h3>
                </div>
                <div className="box-swiper"> 
                  <div className="swiper-container swiper-6-items pb-0">
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <div className="cardCategorySmall wow fadeInUp">
                          <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage9/cat.png" alt="Indovia" /></a></div>
                          <div className="cardInfo"><a href="#">
                              <h4 className="cardTitle">Chairs (8)</h4></a></div>
                        </div>
                      </div>
                      <div className="swiper-slide">
                        <div className="cardCategorySmall wow fadeInUp">
                          <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage9/cat2.png" alt="Indovia" /></a></div>
                          <div className="cardInfo"><a href="#">
                              <h4 className="cardTitle">Table (12)</h4></a></div>
                        </div>
                      </div>
                      <div className="swiper-slide">
                        <div className="cardCategorySmall wow fadeInUp">
                          <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage9/cat3.png" alt="Indovia" /></a></div>
                          <div className="cardInfo"><a href="#">
                              <h4 className="cardTitle">Console (4)</h4></a></div>
                        </div>
                      </div>
                      <div className="swiper-slide">
                        <div className="cardCategorySmall wow fadeInUp">
                          <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage9/cat4.png" alt="Indovia" /></a></div>
                          <div className="cardInfo"><a href="#">
                              <h4 className="cardTitle">Lighting (5)</h4></a></div>
                        </div>
                      </div>
                      <div className="swiper-slide">
                        <div className="cardCategorySmall wow fadeInUp">
                          <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage9/cat5.png" alt="Indovia" /></a></div>
                          <div className="cardInfo"><a href="#">
                              <h4 className="cardTitle">Sofas (3)</h4></a></div>
                        </div>
                      </div>
                      <div className="swiper-slide">
                        <div className="cardCategorySmall wow fadeInUp">
                          <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage9/cat6.png" alt="Indovia" /></a></div>
                          <div className="cardInfo"><a href="#">
                              <h4 className="cardTitle">Beds (6)</h4></a></div>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <section className="section block-product-home8">
              <div className="container"> 
                ...
                <div className="row mt-40"> 
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage8/product2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage8/product3.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage8/product4.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage8/product5.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage8/product6.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage8/product7.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="col-lg-3 col-md-4 col-sm-6"> 
                    <div className="cardProduct wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage8/product8.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage8/product.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                ...
                <div className="text-center"> <a className="btn btn-border" href="#">View All Products</a></div>
              </div>
            </section>
            <section className="section block-banner-body"> 
              <div className="container"> 
                <div className="box-text-banner-video">
                  <h1 className="heading-title-medium color-white wow fadeInUp">Simple Products, Elevated</h1>
                </div>
              </div>
            </section>
            ...
            <section className="section block-instagram-type4-home7">
              ...
              <div className="box-gallery-instagram"> 
                <div className="gallery-item wow fadeInLeft"><img src="/assets/imgs/page/homepage9/insta.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage9/insta2.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage9/insta3.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage9/insta4.png" alt="Indovia" /></div>
                <div className="gallery-item wow fadeInRight"><img src="/assets/imgs/page/homepage9/insta5.png" alt="Indovia" /></div>
              </div>
            </section>
