...
const Index24 = () => (
  <>
    <Helmet>
      <title>Index 24 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-24">
      <header className="header sticky-bar header-style-2 header-style-2-nofix">
          ...
          <main className="main">
            <section className="section block-banner-home24">
              <div className="container"> 
                <div className="box-banner-home24"> 
                  <div className="box-banner-home24-inner"> 
                    <h2>July Coffee Roasters</h2>
                    <p className="body-p2">Fresh, delicious coffee, making an impact.</p><a className="btn btn-white" href="#">Shop now</a>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-new-arrival-home24">
              <div className="container"> 
                <div className="text-center"> 
                  <h3 className="font-oswald text-uppercase mb-40">New arrival</h3>
                </div>
                <div className="row"> 
                  <div className="col-md-4 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage24/sp.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage24/sp.png" alt="Indovia" /></a>
                      ...
                      <div className="cardInfo">
                        <h6 className="text-17-medium mb-10">Milk Chocolate & Citrus</h6>
                  ...
                  <div className="col-md-4 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage24/sp2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage24/sp2.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="cardInfo">
                        <h6 className="text-17-medium mb-10">Chocolate & Hazelnut</h6>
                        <p className="body-p2 cardDesc">$100.00</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage24/sp3.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage24/sp3.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="cardInfo">
                        <h6 className="text-17-medium mb-10">Bittersweet Chocolate & Citrus Fruit</h6>
                        <p className="body-p2 cardDesc">$100.00</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      ...
                      <div className="cardInfo">
                        <h6 className="text-17-medium mb-10">Dark Chocolate & Malt Biscuits</h6>
                        <p className="body-p2 cardDesc">$100.00</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      ...
                      <div className="cardInfo">
                        <h6 className="text-17-medium mb-10">Plum & Dark Chocolate</h6>
                        <p className="body-p2 cardDesc">$100.00</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4 col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      ...
                      <div className="cardInfo">
                        <h6 className="text-17-medium mb-10">Malt & Cocoa</h6>
                        <p className="body-p2 cardDesc">$100.00</p>
                      </div>
                    </div>
                  </div>
            ...
            <section className="section block-home-coffee">
              <div className="container"> 
                <div className="row align-items-center">
                  <div className="col-lg-6 mb-30"><img src="/assets/imgs/page/homepage24/img.png" alt="Indovia" /></div>
                  <div className="col-lg-6 mb-30">
                    <div className="home-coffee-info">
                      <h3 className="font-bebas mb-15">Great Chefs. <br className="d-none d-lg-block" />Great Coffees. <br className="d-none d-lg-block" />Great causes.</h3>
                      <p className="body-p2 neutral-medium-dark mb-25">Unique and handcrafted coffees from people with a passion for coffee. We want to bring new flavors to life. Each cup of coffee not only tastes great, but also brings comfort to everyone.</p><a className="btn btn-black" href="#">Explore the collection</a>
                    </div>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-espresso-coffee">
              <div className="container"> 
                <div className="row">
                  <div className="col-lg-4">
                    <div className="text-center pt-100">
                      <h3 className="font-bebas mb-15">ESpresso coffee</h3>
                      <p className="body-p2 mb-25 neutral-medium-dark">Espresso is a coffee-brewing method of Italian origin, in which a small amount of nearly boiling water is forced under 9–10 bars...</p><a className="link-underline" href="#">Shop now</a>
                    </div>
                  </div>
                  <div className="col-lg-8">
                    <div className="box-swiper button-slide-square button-slide-square-2">                             
                      <div className="swiper-container swiper-2-items pb-80">
                        ...
                        <div className="box-pagination-button">
                          <div className="swiper-pagination swiper-pagination-items-2 swiper-pagination-banner-style-2"></div>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <section className="section block-filter-coffee">
              <div className="container"> 
                <div className="row">
                  <div className="col-lg-8">
                    <div className="box-swiper button-slide-square button-slide-square-2">                             
                  ...
                  <div className="col-lg-4">
                    <div className="text-center pt-100">
                      <h3 className="font-bebas mb-15">Filter coffee</h3>
                      <p className="body-p2 mb-25 neutral-medium-dark">Filter roast is roasted at a lower temperature and for a shorter time. Often it produces a clearer picture of a coffee's unique taste as there are...</p><a className="link-underline" href="#">Shop now</a>
                    </div>
                  </div>
                </div>
              </div>
            </section>
            <section className="section box-banner-coffee-home24">
              <div className="container"> 
                <div className="box-banner-coffee-bg"> 
                  <div className="box-banner-coffee-info"> 
                    <h1 className="heading-h1 text-uppercase mb-25">Your Perfect coffee...</h1><a className="btn btn-white" href="#">Get started</a>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-instagram-type-5"> 
              <div className="container"> 
                ...
                <div className="box-gallery-instagram-type-5 wow fadeInRight"> 
                  <div className="gallery-1"><img src="/assets/imgs/page/homepage24/inst-img.png" alt="kidify" /></div>
                  <div className="gallery-2"> <img src="/assets/imgs/page/homepage24/inst-img2.png" alt="kidify" /><img src="/assets/imgs/page/homepage24/inst-img3.png" alt="kidify" /><img src="/assets/imgs/page/homepage24/inst-img4.png" alt="kidify" /><img src="/assets/imgs/page/homepage24/inst-img5.png" alt="kidify" /><img src="/assets/imgs/page/homepage24/inst-img6.png" alt="kidify" /><img src="/assets/imgs/page/homepage24/inst-img7.png" alt="kidify" /></div>
                </div>
              </div>
            </section>
          </main>
