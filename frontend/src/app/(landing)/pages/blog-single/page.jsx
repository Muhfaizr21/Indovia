      ...
      <header className="header sticky-bar header-type1">
          ...
          <main className="main">
            <div className="section block-breadcrumb">
              <div className="container"> 
                <div className="breadcrumbs wow fadeInUp"> 
                  <ul> 
                    <li> <a href="#">Home </a></li>
                    <li> <a href="#">Blog</a></li>
                    <li> <a href="#">5 Tips to Increase Your Online Sales</a></li>
                  </ul>
                </div>
              </div>
            </div>
            <section className="section block-blog-single">
              <div className="container-blog-single">
                <div className="blog-head wow fadeInUp">
                  <div className="text-center"><a className="text-17-medium text-uppercase" href="#">fashion</a>
                ...
                <div className="blog-content"><img className="w-100" src="/assets/imgs/page/blog/single.png" alt="Indovia" />
                  <div className="blog-content-inner">
                    ...
                    <p> Aliquam cursus enim urna, ut congue leo tristique id. Quisque quis diam at ipsum facilisis mollis. Nulla bibendum ornare libero, sed eleifend urna tincidunt sed. Vestibulum sit amet malesuada neque, vitae tincidunt enim. Etiam ut vestibulum felis.</p>
                    <ul>
                    ...
                    <quote>“ Without Was be great it them green which seed. They’re lights i of life. Abundantly. Void night divide appear be won’t days they’re beast in. You day blessed there i very stars man Saw had, make let light his above. ”<span className="text-17 author-name">- Kevin Kay</span></quote>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc pretium nisi sed ante convallis scelerisque. Donec aliquet massa vel mollis sagittis. Fusce eu lectus ac magna vehicula malesuada. Aenean accumsan maximus feugiat. Phasellus laoreet, ipsum eget egestas euismod, quam nulla pretium turpis, quis posuere tortor mi eget orci. Aliquam cursus enim urna, ut congue leo tristique id. Quisque quis diam at ipsum facilisis mollis. Nulla bibendum ornare libero, sed eleifend urna tincidunt sed. Vestibulum sit amet malesuada neque, vitae tincidunt enim. Etiam ut vestibulum felis. Nulla bibendum ornare libero, sed eleifend urna tincidunt sed. Vestibulum sit amet malesuada neque, vitae tincidunt enim.</p>
                        ...
                        <div className="item-comment">
                          ...
                          <div className="comment-info">
                            <div className="comment-info-top">
                              ...
                              <div className="comment-date">September 30, 2022</div>
                            </div>
                            <div className="comment-info-bottom">
                              <p className="body-p2">Vivamus viverra consequat ipsum, nec auctor dolor eleifend sit amet. Nulla cursus fringilla metus a dictum</p>
                            </div>
                          </div>
                        </div>
                        <div className="item-comment">
                    ...
                    <div className="block-form-comment">
                      <h4>Leave a Reply</h4>
                      <p className="text-16 neutral-medium mb-30">Your email address will not be published. Required fields are marked *</p>
                      <div className="row">
