...
const Index32 = () => (
  <>
    <Helmet>
      <title>Index 32 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-32">
      <header className="header sticky-bar header-type1">
          ...
          <main className="main">
            <section className="section block-banner-home32">
              <div className="box-banner-cover">
                <div className="container"> 
                  <div className="row align-items-center justify-content-end height-720">
                    <div className="col-lg-4">
                      <div className="text-start"> 
                        <p className="text-16-medium mb-10">Staff Pick</p>
                        <h1 className="mb-15">Design Book</h1>
                        <h6 className="mb-25">“This book moved me in so many ways. Highly recommended." - Jerry, Reviewer</h6><a className="btn btn-black" href="#">Shop Now</a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="section block-shop-category block-padding-40"> 
              ...
              <div className="container-slider-padding">
                <div className="box-swiper button-slide-square button-slide-square-2"> 
                  <div className="swiper-container swiper-group-5-items pb-90">
                    <div className="swiper-wrapper">
                      <div className="swiper-slide"> 
                        <div className="cardCollection wow fadeInUp"> 
                          <div className="cardImage"> <img src="/assets/imgs/page/homepage32/cat.png" alt="Indovia" /></div>
                          <div className="cardInfo"> 
                            <h5 className="mb-30">Educated books</h5>
                          </div>
                        </div>
                      </div>
                      <div className="swiper-slide"> 
                        <div className="cardCollection wow fadeInUp"> 
                          <div className="cardImage"> <img src="/assets/imgs/page/homepage32/cat2.png" alt="Indovia" /></div>
                          <div className="cardInfo"> 
                            <h5 className="mb-30">Kids books</h5>
                          </div>
                        </div>
                      </div>
                      <div className="swiper-slide"> 
                        <div className="cardCollection wow fadeInUp"> 
                          <div className="cardImage"> <img src="/assets/imgs/page/homepage32/cat3.png" alt="Indovia" /></div>
                          <div className="cardInfo"> 
                            <h5 className="mb-30">Fashion books</h5>
                          </div>
                        </div>
                      </div>
                      <div className="swiper-slide"> 
                        <div className="cardCollection wow fadeInUp"> 
                          <div className="cardImage"> <img src="/assets/imgs/page/homepage32/cat4.png" alt="Indovia" /></div>
                          <div className="cardInfo"> 
                            <h5 className="mb-30">English books</h5>
                          </div>
                        </div>
                      </div>
                      <div className="swiper-slide"> 
                        <div className="cardCollection wow fadeInUp"> 
                          <div className="cardImage"> <img src="/assets/imgs/page/homepage32/cat.png" alt="Indovia" /></div>
                          <div className="cardInfo"> 
                            <h5 className="mb-30">Book combos</h5>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="box-pagination-button">
                      <div className="swiper-pagination swiper-pagination-group-5-items swiper-pagination-banner-style-2"></div>
                    </div>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-july-book"> 
              <div className="container"> 
                <div className="text-center">
                  <h3 className="wow fadeInLeft">July Book</h3>
                  <div className="box-tabs wow fadeInRight"> 
                    <ul className="nav nav-tabs nav-tabs-style-2" role="tablist">
                      <li className="nav-item" role="presentation">
                        <button className="nav-link active" id="mens-tab" data-bs-toggle="tab" data-bs-target="#mens" type="button" role="tab" aria-controls="mens" aria-selected="true">Hot items</button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="womens-tab" data-bs-toggle="tab" data-bs-target="#womens" type="button" role="tab" aria-controls="womens" aria-selected="false">On sale</button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="kids-tab" data-bs-toggle="tab" data-bs-target="#kids" type="button" role="tab" aria-controls="kids" aria-selected="false">Best Sallers </button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="bags-tab" data-bs-toggle="tab" data-bs-target="#bags" type="button" role="tab" aria-controls="bags" aria-selected="false">Best Sallers</button>
                      </li>
                    </ul>
                  </div>
                </div>
                    ...
                    <div className="row"> 
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage32/book.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage32/book.png" alt="Indovia" /></a>
                          ...
                          <div className="cardInfo">
                            <h6 className="text-17-medium mb-10">Santa Fe Modern</h6>
                            <p className="body-p2 cardDesc">$39.95</p>
                          </div>
                        </div>
                      </div>
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage32/book2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage32/book2.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                          ...
                          <div className="cardInfo">
                            <h6 className="text-17-medium mb-10">Interiors in Context</h6>
                            <p className="body-p2 cardDesc">$47.50</p>
                          </div>
                        </div>
                      </div>
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage32/book3.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage32/book3.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                          ...
                          <div className="cardInfo">
                            <h6 className="text-17-medium mb-10">The Architect, His Circle</h6>
                            <p className="body-p2 cardDesc">$47.50</p>
                          </div>
                        </div>
                      </div>
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage32/book4.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage32/book4.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                          ...
                          <div className="cardInfo">
                            <h6 className="text-17-medium mb-10">Home Farm Cooking</h6>
                            <p className="body-p2 cardDesc">$35.00</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="text-center mt-20"> <a className="btn btn-border-medium" href="#">View More</a></div>
                  </div>
            ...
            <section className="section block-new-collection block-padding-80 pb-0">
              <div className="container"> 
                <div className="text-center">
                  <h3 className="wow fadeInLeft mb-40">New Collection</h3>
                </div>
                <div className="row"> 
                  <div className="col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage32/collection.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage32/collection.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="cardInfo">
                        <h6 className="text-17-medium mb-10">Finley</h6>
                        <p className="body-p2 cardDesc">$500.00</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-sm-6"> 
                    <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                      <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage32/collection2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage32/collection2.png" alt="Indovia" /></a>
                        <div className="button-select"><a href="#">Select Options</a></div>
                        <div className="box-quick-button"><a className="btn" href="#">
                            <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                              <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="cardInfo">
                        <h6 className="text-17-medium mb-10">The Animal Vol 1</h6>
                        <p className="body-p2 cardDesc">$250.00</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="section block-banner-book"> 
              <div className="container"> 
                <div className="box-book-grey">
                  <div className="row align-items-center"> 
                    <div className="col-lg-5">
                      <div className="text-center">
                        <h3 className="mb-25">Black Friday Sale</h3><a className="link-underline" href="#">Shop Now</a>
                      </div>
                    </div>
                    <div className="col-lg-7"> 
                      <div className="text-center"> <img className="img-book" src="/assets/imgs/page/homepage32/bg-book.png" alt="Indovia" /></div>
                    </div>
                  </div>
                </div>
              </div>
