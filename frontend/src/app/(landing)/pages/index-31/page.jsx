...
const Index31 = () => (
  <>
    <Helmet>
      <title>Index 31 | Larkon Store</title>
    </Helmet>
          ...
          <main className="main">
                ...
                <div className="row"> 
                  <div className="col-md-4">
                    <div className="card-our-category"> 
                      <div className="card-image"> <img src="/assets/imgs/page/homepage31/cat.png" alt="Guza" /></div>
                      <div className="card-info"> <a className="link-underline" href="#">Classic</a></div>
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="card-our-category"> 
                      <div className="card-image"> <img src="/assets/imgs/page/homepage31/cat2.png" alt="Guza" /></div>
                      <div className="card-info"> <a className="link-underline" href="#">Modern</a></div>
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="card-our-category"> 
                      <div className="card-image"> <img src="/assets/imgs/page/homepage31/cat3.png" alt="Guza" /></div>
                        ...
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage31/watch-sp.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage31/watch-sp.png" alt="guza" /></a>
                          ...
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage31/watch-sp2.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage31/watch-sp2.png" alt="guza" /></a>
                                <div className="button-select"><a href="#">Select Options</a></div>
                                <div className="box-quick-button"><a className="btn" href="#">
                                    <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                      <g clipPath="url(#clip0_116_452)">
                          ...
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage31/watch-sp3.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage31/watch-sp3.png" alt="guza" /></a>
                                <div className="button-select"><a href="#">Select Options</a></div>
                                <div className="box-quick-button"><a className="btn" href="#">
                                    <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                      <g clipPath="url(#clip0_116_452)">
                          ...
                          <div className="swiper-slide">
                            <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                              <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage31/watch-sp4.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage31/watch-sp4.png" alt="guza" /></a>
                                <div className="button-select"><a href="#">Select Options</a></div>
                                <div className="box-quick-button"><a className="btn" href="#">
                                    <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                      <g clipPath="url(#clip0_116_452)">
            ...
            <section className="section block-our-collection block-padding-40"> 
              <div className="container"> 
                <div className="row align-items-center"> 
                  ...
                  <div className="col-lg-4 col-sm-6 mb-30"><img className="w-100" src="/assets/imgs/page/homepage31/watch1.png" alt="Guza" /></div>
                  <div className="col-lg-4 col-sm-6 mb-30"><img className="w-100" src="/assets/imgs/page/homepage31/watch2.png" alt="Guza" /></div>
                </div>
              </div>
            </section>
                ...
                <div className="row align-items-center"> 
                  <div className="col-lg-6 mb-30">
                    <div className="row image-story"> 
                      <div className="col-lg-12"><img className="w-100" src="/assets/imgs/page/homepage31/story.png" alt="Guza" /></div>
                      <div className="col-lg-6 col-sm-6"><img className="w-100" src="/assets/imgs/page/homepage31/story2.png" alt="Guza" /></div>
                      <div className="col-lg-6 col-sm-6"><img className="w-100" src="/assets/imgs/page/homepage31/story3.png" alt="Guza" /></div>
                    </div>
                  </div>
                  <div className="col-lg-6 mb-30">
            ...
            <section className="section block-brands block-padding-40">
              <div className="container"> 
                <div className="brand-list"> 
                  <div className="brand-item"> <img src="/assets/imgs/page/homepage31/rolex.png" alt="Guza" /></div>
                  <div className="brand-item"> <img src="/assets/imgs/page/homepage31/chopard.png" alt="Guza" /></div>
                  <div className="brand-item"> <img src="/assets/imgs/page/homepage31/omega.png" alt="Guza" /></div>
                  <div className="brand-item"> <img src="/assets/imgs/page/homepage31/patex.png" alt="Guza" /></div>
                  <div className="brand-item"> <img src="/assets/imgs/page/homepage31/hublot.png" alt="Guza" /></div>
                </div>
              </div>
            </section>
            <section className="section block-instagram-type-3 block-instagram-type-3-grey block-padding-40">
              ...
              <div className="box-gallery-instagram mt-65 wow fadeInDown"> 
                <div className="gallery-item"><img src="/assets/imgs/page/homepage31/insta.png" alt="Guza" /></div>
                <div className="gallery-item"><img src="/assets/imgs/page/homepage31/insta2.png" alt="Guza" /></div>
                <div className="gallery-item"><img src="/assets/imgs/page/homepage31/insta3.png" alt="Guza" /></div>
                <div className="gallery-item"><img src="/assets/imgs/page/homepage31/insta4.png" alt="Guza" /></div>
                <div className="gallery-item"><img src="/assets/imgs/page/homepage31/insta5.png" alt="Guza" /></div>
              </div>
            </section>
