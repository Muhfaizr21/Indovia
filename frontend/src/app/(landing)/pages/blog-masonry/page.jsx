...
const BlogMasonry = () => (
  <>
    <Helmet>
      <title>Blog Masonry | Indovia Store</title>
    </Helmet>
    <div className="landing-page-blog-masonry">
      <header className="header sticky-bar">
          ...
          <main className="main">
            ...
            <section className="section block-blog-list">
              <div className="container">
                <ul className="nav-tabs nav-tab-grey wow fadeInUp">
                  <li><a href="#">All</a></li>
                ...
                <div className="row" data-masonry='{"percentPosition": true }'>
                  <div className="col-lg-4 col-md-6">
                    <div className="cardBlog wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/blog-masonry/img.png" alt="Indovia" /></a></div>
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="cardBlog wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/blog-masonry/img2.png" alt="Indovia" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet</p><a className="link-underline link-l2" href="#">Read More</a>
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="cardBlog wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/blog-masonry/img3.png" alt="Indovia" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet</p><a className="link-underline link-l2" href="#">Read More</a>
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="cardBlog wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/blog-masonry/img4.png" alt="Indovia" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet</p><a className="link-underline link-l2" href="#">Read More</a>
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="cardBlog wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/blog-masonry/img5.png" alt="Indovia" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet</p><a className="link-underline link-l2" href="#">Read More</a>
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="cardBlog wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/blog-masonry/img6.png" alt="Indovia" /></a></div>
                      <div className="cardInfo">
                        <div className="cardTags"><a href="#">Fashion</a><span className="date-post">Dec 1, 2022</span></div><a className="cardTitle" href="#">
                          <h5>The Best Winter Trend for 2022/2023</h5></a>
                        <p className="cardDesc body-p2">At this point, your 2022 wardrobe is probably looking a lot like your closet</p><a className="link-underline link-l2" href="#">Read More</a>
                ...
                <div className="text-center mt-40 wow fadeInUp"><a className="btn btn-black" href="#">
