...
const Index12 = () => (
  <>
    <Helmet>
      <title>Index 12 | Larkon Store</title>
    </Helmet>
                ...
                <div className="row"> 
                  <div className="col-lg-4 mb-30"> 
                    <div className="cardBorderImageLeft"> 
                      <div className="cardImage"> <img src="/assets/imgs/page/homepage12/certified.svg" alt="Guza" /></div>
                  ...
                  <div className="col-lg-4 mb-30"> 
                    <div className="cardBorderImageLeft"> 
                      <div className="cardImage"> <img src="/assets/imgs/page/homepage12/ship.svg" alt="Guza" /></div>
                      <div className="cardInfo"> 
                        <h5>Free Shipping</h5>
                        <p className="text-17 neutral-medium-dark">Etiam eu turpis tincidunt, vehicula mi ut</p>
                      </div>
                  ...
                  <div className="col-lg-4 mb-30"> 
                    <div className="cardBorderImageLeft"> 
                      <div className="cardImage"> <img src="/assets/imgs/page/homepage12/vegetables.svg" alt="Guza" /></div>
                      <div className="cardInfo"> 
                        <h5>Warranty</h5>
                        <p className="text-17 neutral-medium-dark">Etiam eu turpis tincidunt, vehicula mi ut</p>
                      </div>
                          ...
                          <div className="swiper-wrapper">
                            <div className="swiper-slide">
                              <div className="cardProductStyle3 wow fadeInUp">
                                <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage12/product.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage12/product2.png" alt="guza" /></a>
                            ...
                            <div className="swiper-slide">
                              <div className="cardProductStyle3 wow fadeInUp">
                                <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage12/product2.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage12/product3.png" alt="guza" /></a>
                                  <div className="button-select"><a href="#">Select Options</a></div>
                                  <div className="box-quick-button"><a className="btn" href="#">
                                      <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_116_452)">
                            ...
                            <div className="swiper-slide">
                              <div className="cardProductStyle3 wow fadeInUp">
                                <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage12/product3.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage12/product.png" alt="guza" /></a>
                                  <div className="button-select"><a href="#">Select Options</a></div>
                                  <div className="box-quick-button"><a className="btn" href="#">
                                      <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_116_452)">
              ...
              <div className="container"> 
                <div className="row align-items-center"> 
                  <div className="col-lg-7">
                    <div className="box-about-image-homepage12"> <img src="/assets/imgs/page/homepage12/about.jpg" alt="Guza" /></div>
                  </div>
                    ...
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <div className="cardReview"> 
                          <div className="cardRate"> <img src="/assets/imgs/template/icons/star.svg" alt="Guza" /><img src="/assets/imgs/template/icons/star.svg" alt="Guza" /><img src="/assets/imgs/template/icons/star.svg" alt="Guza" /><img src="/assets/imgs/template/icons/star.svg" alt="Guza" /><img src="/assets/imgs/template/icons/star.svg" alt="Guza" /></div>
            ...
            <section className="section block-instagram-type-5"> 
              <div className="container"> 
                ...
                <div className="box-gallery-instagram-type-5 wow fadeInRight"> 
                  <div className="gallery-1"><img src="/assets/imgs/page/homepage12/inst-img.png" alt="Guza" /></div>
                  <div className="gallery-2"> <img src="/assets/imgs/page/homepage12/inst-img2.png" alt="Guza" /><img src="/assets/imgs/page/homepage12/inst-img3.png" alt="Guza" /><img src="/assets/imgs/page/homepage12/inst-img4.png" alt="Guza" /><img src="/assets/imgs/page/homepage12/inst-img5.png" alt="Guza" /><img src="/assets/imgs/page/homepage12/inst-img6.png" alt="Guza" /><img src="/assets/imgs/page/homepage12/inst-img7.png" alt="Guza" /></div>
                </div>
              </div>
            </section>
          </main>
