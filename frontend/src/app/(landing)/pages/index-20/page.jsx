...
const Index20 = () => (
  <>
    <Helmet>
      <title>Index 20 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-20">
      <header className="header sticky-bar header-style-2">
          ...
          <main className="main">
            <section className="section banner-homepage20">
              <div className="container">
                <div className="row align-items-center"> 
                  <div className="col-lg-6">
                    <h1 className="mb-15">Speacial bike? <br className="d-none d-lg-block" />Special price!</h1>
                    <p className="body-p2 mb-40">Nemo TIG Gravel Special Green, IN PROMPT DELIVERY</p><a className="btn btn-border" href="#">Go to the bike</a>
                  </div>
                  <div className="col-lg-6">
                    <div className="box-image-banner-20">
                      <div className="image-banner-1"> <img src="/assets/imgs/page/homepage20/banner.png" alt="Indovia" /></div>
                      <div className="image-banner-2"><img src="/assets/imgs/page/homepage20/banner2.png" alt="Indovia" /></div>
                    </div>
                  </div>
                </div>
              </div>
            </section>
            <section className="section box-product-home20">
              <div className="container">
                <div className="row mb-80">
                  <div className="col-lg-7">
                    <div className="box-banner-text-inner"><img src="/assets/imgs/page/homepage20/banner3.jpg" alt="Indovia" />
                      <div className="box-texts">
                        <div className="text-1 text-68-medium primary-navy">ebike</div>
                        <div className="text-2 text-68-medium"><span className="text-white">citybike</span><span className="text-black">citybike</span></div>
                        <div className="text-3 text-68-medium"><span className="text-white">mountain bike</span><span className="text-black">mountain bike</span></div>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-5">
                    <div className="box-review-home20">
                      <p className="text-18 neutral-medium-dark">“It doesn't matter what pushes you to pedal, the thing it is important to never stay with your feet on the ground."</p>
                      <p className="text-17-medium neutral-dark">- Alberto</p>
                    </div>
                  </div>
                </div>
                <div className="box-best-seller-product">
                  <div className="box-swiper button-slide-square button-slide-square-2">
                    <div className="swiper-container swiper-3-items pb-90">
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage20/sp.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage20/sp.png" alt="Indovia" /></a>
                            ...
                            <div className="cardInfo">
                              <h6 className="text-17-medium mb-10">Guerciotti Lembeek 2023</h6>
                        ...
                        <div className="swiper-slide">
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage20/sp2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage20/sp2.png" alt="Indovia" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                        ...
                        <div className="swiper-slide">
                          <div className="cardProductStyle3 cardProductType03 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage20/sp3.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage20/sp3.png" alt="Indovia" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="box-pagination-button">
                        <div className="swiper-pagination swiper-pagination-items-3 swiper-pagination-banner-style-2"></div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="section box-tip-home20">
              <div className="container"> 
                <div className="row align-items-center">
                  <div className="col-lg-5 mb-30">
                    <h3 className="mb-15">Many people ask us: <br className="d-none d-lg-block" />how do I choose the <br className="d-none d-lg-block" />right bike for my needs?</h3>
                    <p className="text-18 primary-navy mb-40">"We are available to advise you and guide you in the purchase."</p><a className="link-underline" href="#">Useful tips</a>
                  </div>
                  <div className="col-lg-7 mb-30"><img src="/assets/imgs/page/homepage20/tip.png" alt="Indovia" /></div>
                </div>
              </div>
            </section>
            <section className="section box-product-2-home20">
              <div className="container">
                <div className="box-title-between justify-content-center">
                  <div className="box-title-main">
                    <h3 className="wow fadeInLeft">Welcome to the high-range bikes</h3>
                  </div>
                </div>
                <div className="box-best-seller-product">
                  <div className="box-swiper button-slide-square button-slide-square-2">
