...
const Index14 = () => (
  <>
    <Helmet>
      <title>Index 14 | Larkon Store</title>
    </Helmet>
          ...
          <main className="main">
                ...
                <div className="swiper-container swiper-banner pb-0">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <div className="box-cover-image"> <img src="/assets/imgs/page/homepage14/banner.jpg" alt="Guza" /></div>
              ...
              <div className="container"> 
                <div className="row"> 
                  <div className="col-lg-6">
                    <div className="box-cat"><img src="/assets/imgs/page/homepage14/cat.png" alt="Guza" />
                      <div className="box-link"><a className="link-cat" href="#">Skateboard</a></div>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="box-cat"><img src="/assets/imgs/page/homepage14/cat2.png" alt="Guza" />
                      <div className="box-link"><a className="link-cat" href="#">Deck Skate</a></div>
                    </div>
                    <div className="box-cat"><img src="/assets/imgs/page/homepage14/cat3.png" alt="Guza" />
                          ...
                          <div className="cardImage"> 
                            <div className="box-swiper"> 
                              <div className="swiper-container swiper-product pb-0" data-lg="1" data-md="1" data-sm="1" data-xs="1" data-prev=".swiper-button-prev-product-1" data-next=".swiper-button-next-product-1" data-pagination=".swiper-pagination-product-1">
                                <div className="swiper-wrapper">
                                  <div className="swiper-slide"><img className="imageMain" src="/assets/imgs/page/homepage14/product.png" alt="guza" /></div>
                                  <div className="swiper-slide"><img className="imageMain" src="/assets/imgs/page/homepage14/product2.png" alt="guza" /></div>
                                </div>
                              </div>
                    ...
                    <div className="box-slider-product-images">
                      <div className="box-swiper">
                        <div className="swiper-container swiper-1-item pb-0">
                          <div className="swiper-wrapper">
                            <div className="swiper-slide"><img src="/assets/imgs/page/homepage14/product-main.png" alt="Guza" /></div>
                            <div className="swiper-slide"><img src="/assets/imgs/page/homepage14/product-main.png" alt="Guza" /></div>
                          </div>
                        </div>
            ...
            <section className="section block-instagram-type4-home7">
              ...
              <div className="box-gallery-instagram"> 
                <div className="gallery-item wow fadeInLeft"><img src="/assets/imgs/page/homepage14/inst.png" alt="Guza" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage14/inst2.png" alt="Guza" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage14/inst3.png" alt="Guza" /></div>
                <div className="gallery-item wow fadeInUp"><img src="/assets/imgs/page/homepage14/inst4.png" alt="Guza" /></div>
                <div className="gallery-item wow fadeInRight"><img src="/assets/imgs/page/homepage14/inst5.png" alt="Guza" /></div>
              </div>
            </section>
          </main>
              ...
              <div className="container">
                <div className="footer-bottom">
                  <div className="row align-items-center">
                    <div className="col-lg-6 col-md-12 text-center text-lg-start mb-20"><span className="body-p1 color-white">© 2023 Guza.Co. All rights reserved</span>
