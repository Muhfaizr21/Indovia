...
const Index27 = () => (
  <>
    <Helmet>
      <title>Index 27 | Larkon Store</title>
    </Helmet>
                ...
                <div className="banner-2-col"> 
                  <div className="box-banner-col">
                    <div className="banner-grey"> 
                      ...
                      <div className="banner-image"> <img src="/assets/imgs/page/homepage27/new-tech.png" alt="Guza" /></div>
                    </div>
                  </div>
                  <div className="box-banner-col">
                    <div className="banner-grey"> 
                      ...
                      <div className="banner-image"> <img src="/assets/imgs/page/homepage27/wallet.png" alt="Guza" /></div>
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <div className="row">   
                        <div className="col-lg-3 col-sm-6"> 
                          <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage27/phone.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage27/phone.png" alt="guza" /></a>
                        ...
                        <div className="col-lg-3 col-sm-6"> 
                          <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage27/phone2.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage27/phone2.png" alt="guza" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                        ...
                        <div className="col-lg-3 col-sm-6"> 
                          <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage27/phone3.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage27/phone3.png" alt="guza" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                        ...
                        <div className="col-lg-3 col-sm-6"> 
                          <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage27/phone4.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage27/phone4.png" alt="guza" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                        ...
                        <div className="col-lg-3 col-sm-6"> 
                          <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage27/phone5.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage27/phone5.png" alt="guza" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                        ...
                        <div className="col-lg-3 col-sm-6"> 
                          <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage27/phone6.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage27/phone6.png" alt="guza" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                        ...
                        <div className="col-lg-3 col-sm-6"> 
                          <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage27/phone7.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage27/phone7.png" alt="guza" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                        ...
                        <div className="col-lg-3 col-sm-6"> 
                          <div className="cardProductStyle3 cardProductType03 cardProductType01 wow fadeInUp">
                            <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage27/phone8.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage27/phone8.png" alt="guza" /></a>
                              <div className="button-select"><a href="#">Select Options</a></div>
                              <div className="box-quick-button"><a className="btn" href="#">
                                  <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_116_452)">
                ...
                <div className="row"> 
                  <div className="col-md-3 col-sm-6"> 
                    <div className="cardIcon cardIconType3 wow fadeInUp">
                      <div className="cardImage"><img src="/assets/imgs/page/homepage26/discount.svg" alt="Guza" /></div>
                      <div className="cardInfo">
                  ...
                  <div className="col-md-3 col-sm-6"> 
                    <div className="cardIcon cardIconType3 wow fadeInUp">
                      <div className="cardImage"><img src="/assets/imgs/page/homepage26/ship.svg" alt="Guza" /></div>
                      <div className="cardInfo">
                  ...
                  <div className="col-md-3 col-sm-6"> 
                    <div className="cardIcon cardIconType3 wow fadeInUp">
                      <div className="cardImage"><img src="/assets/imgs/page/homepage26/return.svg" alt="Guza" /></div>
                      <div className="cardInfo">
                  ...
                  <div className="col-md-3 col-sm-6"> 
                    <div className="cardIcon cardIconType3 wow fadeInUp">
                      <div className="cardImage"><img src="/assets/imgs/page/homepage26/check.svg" alt="Guza" /></div>
                      <div className="cardInfo">
            ...
            <section className="section block-instagram-type-4 block-instagram-type-2 pb-0">
              ...
              <div className="box-gallery-instagram box-gallery-instagram-type2 mt-40 wow fadeInDown"> 
                <div className="box-gallery-instagram-type2-inner">
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage27/insta3.png" alt="Guza" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage27/insta1.png" alt="Guza" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage27/insta2.png" alt="Guza" /><a href="#">Shop on Instagram</a></div>
                  <div className="gallery-item"><img src="/assets/imgs/page/homepage27/insta3.png" alt="Guza" /><a href="#">Shop on Instagram</a></div>
                </div>
              </div>
            </section>
