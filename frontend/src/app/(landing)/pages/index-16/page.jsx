...
const Index16 = () => (
  <>
    <Helmet>
      <title>Index 16 | Larkon Store</title>
    </Helmet>
                ...
                <div className="row"> 
                  <div className="col-lg-3 col-sm-6"> 
                    <div className="box-icon-type-1"> 
                      <div className="item-image"> <img src="/assets/imgs/page/homepage3/ship.svg" alt="Guza" /></div>
                      <div className="item-info"> <span className="text-18">Shipping Worldwide</span></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-sm-6"> 
                    <div className="box-icon-type-1"> 
                      <div className="item-image"> <img src="/assets/imgs/page/homepage4/return.svg" alt="Guza" /></div>
                      <div className="item-info"> <span className="text-18">60 - Days Returns</span></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-sm-6"> 
                    <div className="box-icon-type-1"> 
                      <div className="item-image"> <img src="/assets/imgs/page/homepage4/payment.svg" alt="Guza" /></div>
                      <div className="item-info"> <span className="text-18">Security Payment</span></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-sm-6"> 
                    <div className="box-icon-type-1"> 
                      <div className="item-image"> <img src="/assets/imgs/page/homepage4/cart.svg" alt="Guza" /></div>
                            ...
                            <div className="row"> 
                              <div className="col-lg-3 col-md-4 col-sm-6"> 
                                <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                                  <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage16/sp1.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage16/sp8.png" alt="guza" /></a>
                              ...
                              <div className="col-lg-3 col-md-4 col-sm-6"> 
                                <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                                  <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage16/sp2.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage16/sp7.png" alt="guza" /></a>
                                    <div className="button-select"><a href="#">Select Options</a></div>
                                    <div className="box-quick-button"><a className="btn" href="#">
                                        <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                          <g clipPath="url(#clip0_116_452)">
                              ...
                              <div className="col-lg-3 col-md-4 col-sm-6"> 
                                <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                                  <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage16/sp3.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage16/sp6.png" alt="guza" /></a>
                                    <div className="button-select"><a href="#">Select Options</a></div>
                                    <div className="box-quick-button"><a className="btn" href="#">
                                        <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                          <g clipPath="url(#clip0_116_452)">
                              ...
                              <div className="col-lg-3 col-md-4 col-sm-6"> 
                                <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                                  <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage16/sp4.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage16/sp5.png" alt="guza" /></a>
                                    <div className="button-select"><a href="#">Select Options</a></div>
                                    <div className="box-quick-button"><a className="btn" href="#">
                                        <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                          <g clipPath="url(#clip0_116_452)">
                              ...
                              <div className="col-lg-3 col-md-4 col-sm-6"> 
                                <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                                  <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage16/sp5.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage16/sp4.png" alt="guza" /></a>
                                    <div className="button-select"><a href="#">Select Options</a></div>
                                    <div className="box-quick-button"><a className="btn" href="#">
                                        <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                          <g clipPath="url(#clip0_116_452)">
                              ...
                              <div className="col-lg-3 col-md-4 col-sm-6"> 
                                <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                                  <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage16/sp6.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage16/sp3.png" alt="guza" /></a>
                                    <div className="button-select"><a href="#">Select Options</a></div>
                                    <div className="box-quick-button"><a className="btn" href="#">
                                        <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                          <g clipPath="url(#clip0_116_452)">
                              ...
                              <div className="col-lg-3 col-md-4 col-sm-6"> 
                                <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                                  <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage16/sp7.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage16/sp2.png" alt="guza" /></a>
                                    <div className="button-select"><a href="#">Select Options</a></div>
                                    <div className="box-quick-button"><a className="btn" href="#">
                                        <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                          <g clipPath="url(#clip0_116_452)">
                              ...
                              <div className="col-lg-3 col-md-4 col-sm-6"> 
                                <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                                  <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage16/sp8.png" alt="guza" /><img className="imageHover" src="/assets/imgs/page/homepage16/sp1.png" alt="guza" /></a>
                                    <div className="button-select"><a href="#">Select Options</a></div>
                                    <div className="box-quick-button"><a className="btn" href="#">
                                        <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                          <g clipPath="url(#clip0_116_452)">
                ...
                <div className="row"> 
                  <div className="col-lg-2 col-md-4 col-sm-6"> 
                    <div className="cardCategoryCircle"> 
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage16/cat.png" alt="Guza" /></a></div>
                      <div className="cardInfo"> 
                  ...
                  <div className="col-lg-2 col-md-4 col-sm-6"> 
                    <div className="cardCategoryCircle"> 
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage16/cat2.png" alt="Guza" /></a></div>
                      <div className="cardInfo"> 
                  ...
                  <div className="col-lg-2 col-md-4 col-sm-6"> 
                    <div className="cardCategoryCircle"> 
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage16/cat3.png" alt="Guza" /></a></div>
                      <div className="cardInfo"> 
                  ...
                  <div className="col-lg-2 col-md-4 col-sm-6"> 
                    <div className="cardCategoryCircle"> 
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage16/cat4.png" alt="Guza" /></a></div>
                      <div className="cardInfo"> 
                  ...
                  <div className="col-lg-2 col-md-4 col-sm-6"> 
                    <div className="cardCategoryCircle"> 
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage16/cat5.png" alt="Guza" /></a></div>
                      <div className="cardInfo"> 
                  ...
                  <div className="col-lg-2 col-md-4 col-sm-6"> 
                    <div className="cardCategoryCircle"> 
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage16/cat6.png" alt="Guza" /></a></div>
                      <div className="cardInfo"> 
                  ...
                  <div className="col-lg-6 mb-30">
                    <div className="box-banner-3">
                      <div className="box-banner-3-left">
                        <div className="box-banner-3-image"><img src="/assets/imgs/page/homepage16/speaker.svg" alt="Guza" /></div>
                      ...
                      <div className="box-banner-3-right"> <img src="/assets/imgs/page/homepage16/speaker2.png" alt="Guza" /></div>
                    </div>
                  </div>
                  <div className="col-lg-6 mb-30">
                    <div className="box-banner-3 box-banner-3-2">
                      <div className="box-banner-3-left">
                        <div className="box-banner-3-image"><img src="/assets/imgs/page/homepage16/smartwatch.svg" alt="Guza" /></div>
                        <div className="box-banner-3-info">
                      ...
                      <div className="box-banner-3-right"> <img src="/assets/imgs/page/homepage16/smartwatch.png" alt="Guza" /></div>
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <div className="swiper-slide">
                        <div className="cardReview"> 
                          <div className="cardAuthor mb-20"> 
                            <div className="cardImageAuthor"><img src="/assets/imgs/page/homepage12/author.png" alt="Guza" /></div>
                            <div className="cardNameAuthor">
                              <p className="text-17-medium">Kate Smith</p>
                            </div>
                          </div>
                          <div className="cardRate mb-10"> <img src="/assets/imgs/template/icons/star.svg" alt="Guza" /><img src="/assets/imgs/template/icons/star.svg" alt="Guza" /><img src="/assets/imgs/template/icons/star.svg" alt="Guza" /><img src="/assets/imgs/template/icons/star.svg" alt="Guza" /><img src="/assets/imgs/template/icons/star.svg" alt="Guza" /></div>
