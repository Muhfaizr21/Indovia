...
const Index16 = () => (
  <>
    <Helmet>
      <title>Index 16 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-16">
      <header className="header sticky-bar header-style-2 header-style-2-nofix">
          ...
          <main className="main">
            <section className="section icon-box-type1 wow fadeInUp"> 
              <div className="container"> 
                <div className="row"> 
                  <div className="col-lg-3 col-sm-6"> 
                    <div className="box-icon-type-1"> 
                      <div className="item-image"> <img src="/assets/imgs/page/homepage3/ship.svg" alt="Indovia" /></div>
                      <div className="item-info"> <span className="text-18">Shipping Worldwide</span></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-sm-6"> 
                    <div className="box-icon-type-1"> 
                      <div className="item-image"> <img src="/assets/imgs/page/homepage4/return.svg" alt="Indovia" /></div>
                      <div className="item-info"> <span className="text-18">60 - Days Returns</span></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-sm-6"> 
                    <div className="box-icon-type-1"> 
                      <div className="item-image"> <img src="/assets/imgs/page/homepage4/payment.svg" alt="Indovia" /></div>
                      <div className="item-info"> <span className="text-18">Security Payment</span></div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-sm-6"> 
                    <div className="box-icon-type-1"> 
                      <div className="item-image"> <img src="/assets/imgs/page/homepage4/cart.svg" alt="Indovia" /></div>
                      <div className="item-info"> <span className="text-18">Order Tracking</span></div>
                    </div>
                  </div>
                </div>
              </div>
            </section>
            <section className="section banner-homepage2 banner-homepage16"> 
              <div className="container"> 
                <div className="row"> 
                  <div className="col-lg-8">
                    <div className="box-swiper button-slide-square"> 
                      <div className="swiper-container swiper-banner pb-0">
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <div className="banner-home-16">
                              <div className="banner-home-16-inner">
                                <h3 className="mb-10">Grab these HOT deals, <br className="d-none d-lg-block" />now!</h3>
                                <p className="body-p1 mb-25">Limited-time savings you won’t believe on the tech you want <br className="d-none d-lg-block" />want & need.</p><a className="btn btn-border" href="#">Shop now</a>
                              </div>
                            </div>
                          </div>
                          <div className="swiper-slide">
                            <div className="banner-home-16">
                              <div className="banner-home-16-inner">
                                <h3 className="mb-10">Grab these HOT deals, <br className="d-none d-lg-block" />now!</h3>
                                <p className="body-p1 mb-25">Limited-time savings you won’t believe on the tech you <br className="d-none d-lg-block" />want & need.</p><a className="btn btn-border" href="#">Shop now</a>
                              </div>
                            </div>
                          </div>
                          <div className="swiper-slide">
                        ...
                        <div className="box-pagination-button">
                          <div className="swiper-pagination swiper-pagination-banner swiper-pagination-banner-style-2"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-4">
                    <div className="row"> 
                      <div className="col-lg-12 col-md-6">
                        <div className="banner-home-16-2"> 
                          <p className="text-18">SAVE 20%</p>
                          <h3 className="mb-55">Apple AirPods Max</h3><a className="btn btn-border" href="#">Buy now</a>
                        </div>
                      </div>
                      <div className="col-lg-12 col-md-6">   
                        <div className="banner-home-16-3">
                          <p className="text-18">NEW ARRIVALS</p>
                          <h3 className="mb-25">Macbook Air <br className="d-none d-lg-block" />M2 Chip</h3><a className="btn btn-border" href="#">Learn more</a>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <section className="section block-shop-1"> 
              <div className="container"> 
                <div className="text-center">
                  <div className="box-tabs wow fadeInRight"> 
                    <ul className="nav nav-tabs nav-tabs-style-2 nav-tabs-style-4" role="tablist">
                      <li className="nav-item" role="presentation">
                        <button className="nav-link active" id="bestsellers-tab" data-bs-toggle="tab" data-bs-target="#bestsellers" type="button" role="tab" aria-controls="bestsellers" aria-selected="true" data-index="1" data-items="1">Best Sellers</button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="newproducts-tab" data-bs-toggle="tab" data-bs-target="#newproducts" type="button" role="tab" aria-controls="newproducts" aria-selected="false" data-index="2" data-items="1">New Products</button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="featureproducts-tab" data-bs-toggle="tab" data-bs-target="#featureproducts" type="button" role="tab" aria-controls="featureproducts" aria-selected="false" data-index="3" data-items="1">Feature Products</button>
                      </li>
                    </ul>
                  </div>
                </div>
                <div className="tab-content">
                  <div className="tab-pane fade show active" id="bestsellers" role="tabpanel" aria-labelledby="bestsellers-tab">
                    <div className="box-swiper button-slide-square button-slide-square-2">                             
                      <div className="swiper-container swiper-tab-1">
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <div className="row"> 
                              <div className="col-lg-3 col-md-4 col-sm-6"> 
                                <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                                  <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage16/sp1.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage16/sp8.png" alt="Indovia" /></a>
                                  ...
                                  <div className="cardInfo">
                                    <h6 className="text-17-medium mb-10">Huawei Watch Charging Cradle</h6>
                                    <p className="body-p2 cardDesc"><span className="price-line">$150.00</span><span className="price-main">$100.00</span></p>
                                  </div>
                                </div>
                              </div>
                              <div className="col-lg-3 col-md-4 col-sm-6"> 
                                <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                                  <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage16/sp2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage16/sp7.png" alt="Indovia" /></a>
                                    <div className="button-select"><a href="#">Select Options</a></div>
                                    <div className="box-quick-button"><a className="btn" href="#">
                                        <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                          <g clipPath="url(#clip0_116_452)">
                                  ...
                                  <div className="cardInfo">
                                    <h6 className="text-17-medium mb-10">Smart Watches</h6>
                                    <p className="body-p2 cardDesc"><span className="price-line">$150.00</span><span className="price-main">$100.00</span></p>
                                  </div>
                                </div>
                              </div>
                              <div className="col-lg-3 col-md-4 col-sm-6"> 
                                <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                                  <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage16/sp3.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage16/sp6.png" alt="Indovia" /></a>
                                    <div className="button-select"><a href="#">Select Options</a></div>
                                    <div className="box-quick-button"><a className="btn" href="#">
                                        <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                          <g clipPath="url(#clip0_116_452)">
                                  ...
                                  <div className="cardInfo">
                                    <h6 className="text-17-medium mb-10">Meizu HD50 On-Ear Headphones</h6>
                                    <p className="body-p2 cardDesc"><span className="price-line">$150.00</span><span className="price-main">$100.00</span></p>
                                  </div>
                                </div>
                              </div>
                              <div className="col-lg-3 col-md-4 col-sm-6"> 
                                <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                                  <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage16/sp4.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage16/sp5.png" alt="Indovia" /></a>
                                    <div className="button-select"><a href="#">Select Options</a></div>
                                    <div className="box-quick-button"><a className="btn" href="#">
                                        <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                          <g clipPath="url(#clip0_116_452)">
                                  ...
                                  <div className="cardInfo">
                                    <h6 className="text-17-medium mb-10">Mi Power Bank 2nd 20000mAh</h6>
                                    <p className="body-p2 cardDesc"><span className="price-line">$150.00</span><span className="price-main">$100.00</span></p>
                                  </div>
                                </div>
                              </div>
                              <div className="col-lg-3 col-md-4 col-sm-6"> 
                                <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                                  <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage16/sp5.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage16/sp4.png" alt="Indovia" /></a>
                                    <div className="button-select"><a href="#">Select Options</a></div>
                                    <div className="box-quick-button"><a className="btn" href="#">
                                        <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                          <g clipPath="url(#clip0_116_452)">
                                  ...
                                  <div className="cardInfo">
                                    <h6 className="text-17-medium mb-10">Meizu EP51 Sport Bluetooth Stereo Headset</h6>
                                    <p className="body-p2 cardDesc"><span className="price-line">$150.00</span><span className="price-main">$100.00</span></p>
                                  </div>
                                </div>
                              </div>
                              <div className="col-lg-3 col-md-4 col-sm-6"> 
                                <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                                  <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage16/sp6.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage16/sp3.png" alt="Indovia" /></a>
                                    <div className="button-select"><a href="#">Select Options</a></div>
                                    <div className="box-quick-button"><a className="btn" href="#">
                                        <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                          <g clipPath="url(#clip0_116_452)">
                                  ...
                                  <div className="cardInfo">
                                    <h6 className="text-17-medium mb-10">Huawei TalkBand B2 Smart Bracelet</h6>
                                    <p className="body-p2 cardDesc"><span className="price-line">$150.00</span><span className="price-main">$100.00</span></p>
                                  </div>
                                </div>
                              </div>
                              <div className="col-lg-3 col-md-4 col-sm-6"> 
                                <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                                  <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage16/sp7.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage16/sp2.png" alt="Indovia" /></a>
                                    <div className="button-select"><a href="#">Select Options</a></div>
                                    <div className="box-quick-button"><a className="btn" href="#">
                                        <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                          <g clipPath="url(#clip0_116_452)">
                                  ...
                                  <div className="cardInfo">
                                    <h6 className="text-17-medium mb-10">Xiaomi Mi Bluetooth Speaker 2</h6>
                                    <p className="body-p2 cardDesc"><span className="price-line">$150.00</span><span className="price-main">$100.00</span></p>
                                  </div>
                                </div>
                              </div>
                              <div className="col-lg-3 col-md-4 col-sm-6"> 
                                <div className="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                                  <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage16/sp8.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage16/sp1.png" alt="Indovia" /></a>
                                    <div className="button-select"><a href="#">Select Options</a></div>
                                    <div className="box-quick-button"><a className="btn" href="#">
                                        <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                          <g clipPath="url(#clip0_116_452)">
                                  ...
                                  <div className="cardInfo">
                                    <h6 className="text-17-medium mb-10">Power Bank</h6>
                                    <p className="body-p2 cardDesc"><span className="price-line">$150.00</span><span className="price-main">$100.00</span></p>
                                  </div>
                                </div>
                              </div>
                        ...
                        <div className="box-pagination-button">
                          <div className="swiper-pagination swiper-pagination-tab-1 swiper-pagination-banner-style-2"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="tab-pane fade" id="newproducts" role="tabpanel" aria-labelledby="haircare-tab"> 
                    <div className="box-swiper button-slide-square button-slide-square-2">   
                      <div className="swiper-container swiper-tab-2">
                        ...
                        <div className="box-pagination-button">
                          <div className="swiper-pagination swiper-pagination-tab-2 swiper-pagination-banner-style-2"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="tab-pane fade" id="featureproducts" role="tabpanel" aria-labelledby="haircare-tab"> 
                    <div className="box-swiper button-slide-square button-slide-square-2">   
                      <div className="swiper-container swiper-tab-3">
                        ...
                        <div className="box-pagination-button">
                          <div className="swiper-pagination swiper-pagination-tab-3 swiper-pagination-banner-style-2"></div>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <section className="section banner-2-homepage16"> 
              <div className="container"> 
                <div className="text-center"> 
                  <h2 className="color-white mb-10">Awesome tech gifts</h2>
                  <p className="body-p1 color-white mb-30">Surprise them with the latest gadgets.</p><a className="btn btn-border-white" href="#">Shop now</a>
                </div>
              </div>
            </section>
            <section className="section category-homepage16"> 
              <div className="container"> 
                <h3 className="mb-40">Shop by Category</h3>
                <div className="row"> 
                  <div className="col-lg-2 col-md-4 col-sm-6"> 
                    <div className="cardCategoryCircle"> 
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage16/cat.png" alt="Indovia" /></a></div>
                      <div className="cardInfo"> 
                        <p className="text-17-medium">Mobile</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-2 col-md-4 col-sm-6"> 
                    <div className="cardCategoryCircle"> 
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage16/cat2.png" alt="Indovia" /></a></div>
                      <div className="cardInfo"> 
                        <p className="text-17-medium">Smart home</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-2 col-md-4 col-sm-6"> 
                    <div className="cardCategoryCircle"> 
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage16/cat3.png" alt="Indovia" /></a></div>
                      <div className="cardInfo"> 
                        <p className="text-17-medium">Home Audio</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-2 col-md-4 col-sm-6"> 
                    <div className="cardCategoryCircle"> 
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage16/cat4.png" alt="Indovia" /></a></div>
                      <div className="cardInfo"> 
                        <p className="text-17-medium">Headphones</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-2 col-md-4 col-sm-6"> 
                    <div className="cardCategoryCircle"> 
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage16/cat5.png" alt="Indovia" /></a></div>
                      <div className="cardInfo"> 
                        <p className="text-17-medium">Tablets</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-2 col-md-4 col-sm-6"> 
                    <div className="cardCategoryCircle"> 
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage16/cat6.png" alt="Indovia" /></a></div>
                      <div className="cardInfo"> 
                        <p className="text-17-medium">Smart Watch</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="section banner-3-homepage16"> 
              <div className="container"> 
                <div className="row"> 
                  <div className="col-lg-6 mb-30">
                    <div className="box-banner-3">
                      <div className="box-banner-3-left">
                        <div className="box-banner-3-image"><img src="/assets/imgs/page/homepage16/speaker.svg" alt="Indovia" /></div>
                        <div className="box-banner-3-info">
                          <h4 className="mb-5">Next-level audio</h4>
                          <p className="text-16 mb-20">Turn up the drama on movie night with speakers & sound barts</p><a className="btn btn-border" href="#">Shop now</a>
                        </div>
                      </div>
                      <div className="box-banner-3-right"> <img src="/assets/imgs/page/homepage16/speaker2.png" alt="Indovia" /></div>
                    </div>
                  </div>
                  <div className="col-lg-6 mb-30">
                    <div className="box-banner-3 box-banner-3-2">
                      <div className="box-banner-3-left">
                        <div className="box-banner-3-image"><img src="/assets/imgs/page/homepage16/smartwatch.svg" alt="Indovia" /></div>
                        <div className="box-banner-3-info">
                          <h4 className="mb-5">Apple Watch</h4>
                          <p className="text-16 mb-20">Give Dad the gift of Apple Watch. Now up to $70 off.</p><a className="btn btn-border" href="#">Shop now</a>
                        </div>
                      </div>
                      <div className="box-banner-3-right"> <img src="/assets/imgs/page/homepage16/smartwatch.png" alt="Indovia" /></div>
                    </div>
                  </div>
                </div>
              </div>
            </section>
            <section className="section block-review block-testimonials-type4">
              <div className="container"> 
                <div className="text-center"> 
                  <h3 className="mb-40">Our Lovely Customers</h3>
                </div>
                <div className="box-swiper box-button-leftright box-page-style2 pb-90"> 
                  <div className="swiper-container swiper-3-items pb-0">
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <div className="cardReview"> 
                          <div className="cardAuthor mb-20"> 
                            <div className="cardImageAuthor"><img src="/assets/imgs/page/homepage12/author.png" alt="Indovia" /></div>
                            <div className="cardNameAuthor">
                              <p className="text-17-medium">Kate Smith</p>
                            </div>
                          </div>
                          <div className="cardRate mb-10"> <img src="/assets/imgs/template/icons/star.svg" alt="Indovia" /><img src="/assets/imgs/template/icons/star.svg" alt="Indovia" /><img src="/assets/imgs/template/icons/star.svg" alt="Indovia" /><img src="/assets/imgs/template/icons/star.svg" alt="Indovia" /><img src="/assets/imgs/template/icons/star.svg" alt="Indovia" /></div>
                          <h6 className="mb-20">Perfect indoor play tent!</h6>
                          <div className="cardText mb-0"> 
                            <h6 className="text-18">I like the way the staff advises me. Thank you for the very good quality of the case. I will come back and buy more stuff.</h6>
                          </div>
                        </div>
                      </div>
                      <div className="swiper-slide">
                  ...
                  <div className="box-pagination-button">
                    <div className="swiper-pagination swiper-pagination-items-3"></div>
                  </div>
                  <div className="swiper-button-prev swiper-button-prev-items-3 btn-prev-style-1"></div>
                  <div className="swiper-button-next swiper-button-next-items-3 btn-next-style-1"></div>
                </div>
              </div>
            </section>
          </main>
              ...
              <div className="container">
                <div className="row">
                  <div className="col-lg-4 mb-30">
                    ...
                    <p className="color-white body-p2 desc-company">Lorem ipsum dolor sit amet, consectetur adipisicing elit.<a href="#">Read more</a></p>
                    <p className="neutral-dark body-p2 email-footer">E. hello@uxper.co</p>
                    <p className="neutral-dark body-p2 phone-footer">T. (00) 342 489 33</p>
                  </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-3 mb-30">
                        ...
                        <ul className="menu-footer">
                          ...
                          <li><a href="/custome-service">Help & FAQs</a></li>
                          <li><a href="/faq">Return My Order</a></li>
                          <li><a href="/store-location">Refer a Friend</a></li>
                        </ul>
                      </div>
                      <div className="col-lg-3 mb-30">
                        <h6 className="color-white mb-20">Terms & Policies</h6>
                        <ul className="menu-footer">
                          <li><a href="/faq">Duties & Taxes</a></li>
                          <li><a href="/store-location">Shipping Info</a></li>
                          <li><a href="/store-location">Privacy Policy</a></li>
                          <li><a href="/store-location">Terms Conditions</a></li>
                        </ul>
                      </div>
                      <div className="col-lg-3 mb-30">
                  ...
                  <div className="row align-items-center">
                    ...
                    <div className="col-lg-6 col-md-12 text-center text-lg-end mb-20">
                      <div className="d-flex justify-content-center justify-content-lg-end align-items-center box-all-payments">
                        <div className="d-inline-block box-payments mr-20"><img src="/assets/imgs/template/icons/visa-grey.svg" alt="" /><img src="/assets/imgs/template/icons/master-grey.svg" alt="" /><img src="/assets/imgs/template/icons/stripe-grey.svg" alt="" /><img src="/assets/imgs/template/icons/paypal-grey.svg" alt="" /></div>
