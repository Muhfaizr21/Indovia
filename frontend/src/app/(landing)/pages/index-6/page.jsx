...
const Index6 = () => (
  <>
    <Helmet>
      <title>Index 6 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-6">
      <header className="header sticky-bar header-style-3">
          ...
          <main className="main">
                ...
                <div className="row">
                  <div className="col-lg-6">
                    <div className="cardBanner wow fadeInLeft">
                      <div className="cardImage"><img src="/assets/imgs/page/homepage6/womens.png" alt="Indovia" /></div>
                      <div className="cardInfo">
                        <p className="text-17-medium color-white mb-15 text-uppercase">Don’t sleep on it</p>
                  ...
                  <div className="col-lg-6">
                    <div className="cardBanner wow fadeInRight">
                      <div className="cardImage"><img src="/assets/imgs/page/homepage6/mens.png" alt="Indovia" /></div>
                      <div className="cardInfo">
                        <p className="text-17-medium color-white mb-15 text-uppercase">Don’t sleep on it</p>
            ...
            <section className="section block-what-trending">
              <div className="container"> 
                ...
                <div className="box-tabs box-tabs-left box-tabs-center wow fadeInRight"> 
                  <ul className="nav nav-tabs nav-tabs-medium" role="tablist">
                ...
                <div className="tab-content">
                  <div className="tab-pane fade show active" id="mens" role="tabpanel" aria-labelledby="mens-tab">
                    <div className="box-swiper"> 
                      ...
                      <div className="text-center mt-10"> <a className="btn btn-black" href="#">See All Products</a></div>
                    </div>
                  </div>
                ...
                <div className="row"> 
                  <div className="col-lg-4"> 
                    <div className="cardFeature wow fadeInUp"> 
                      <div className="cardImage"> <img src="/assets/imgs/page/homepage6/collection1.png" alt="Indovia" /></div>
                      <div className="cardInfo"> 
                        <div className="cardInfoInner">
                          <p className="text-17-medium text-uppercase mb-15">New Collection 2020</p>
                          <h2 className="text-46-medium mb-30">A Closer look discover all</h2><a className="btn btn-play popup-youtube" href="https://www.youtube.com/watch?v=9ilb5AhvVwU"></a>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-4"> 
                    <div className="cardFeature cardFeatureTop wow fadeInUp"> 
                      <div className="cardImage"> <img src="/assets/imgs/page/homepage6/collection2.png" alt="Indovia" /></div>
                      <div className="cardInfo"> 
                        <div className="cardInfoInner">
                          <p className="text-16-medium text-uppercase mb-15">New Arrivals</p>
                          <h2 className="text-46-medium">Final Reduction <br className="d-none d-lg-block" />Up to 70% OFF</h2>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-4"> 
                    <div className="cardFeature cardFeatureTop2 wow fadeInUp">
                      <div className="cardImage"> <img src="/assets/imgs/page/homepage6/collection3.png" alt="Indovia" /></div>
                      <div className="cardInfo"> 
                        <div className="cardInfoInner">
                          <p className="text-14-bold text-uppercase mb-10">Shop Till Drop</p>
                          <h2 className="heading-title-medium mb-5">Sale</h2>
                          <p className="text-14-bold text-uppercase mb-10">For Clearance</p>
                          <h2 className="heading-title-medium mb-5">30%</h2>
                          <p className="text-14-bold text-uppercase mb-25">off your purchase</p><a className="btn btn-white" href="#">Shop Now</a>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <section className="section block-product-tabs"> 
              <div className="container"> 
                <div className="text-center">
                  <div className="box-tabs"> 
                    <ul className="nav nav-tabs nav-tabs-big" role="tablist">
                      <li className="nav-item" role="presentation">
                        <button className="nav-link active" id="bestseller-tab" data-bs-toggle="tab" data-bs-target="#bestseller" type="button" role="tab" aria-controls="bestseller" aria-selected="true">Best Sellers</button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="newproducts-tab" data-bs-toggle="tab" data-bs-target="#newproducts" type="button" role="tab" aria-controls="newproducts" aria-selected="false">New Products</button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button className="nav-link" id="salesproducts-tab" data-bs-toggle="tab" data-bs-target="#salesproducts" type="button" role="tab" aria-controls="salesproducts" aria-selected="false">Sales Products</button>
                      </li>
                    </ul>
                  </div>
                </div>
                <div className="tab-content">
                  <div className="tab-pane fade show active" id="bestseller" role="tabpanel" aria-labelledby="bestseller-tab">
                    <div className="row"> 
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProduct wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage2/product1.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProduct wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage2/product2.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage1/product2-hover.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProduct wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage2/product3.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProduct wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage2/product4.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage1/product2-hover.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProduct wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage2/product5.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProduct wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage2/product6.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage1/product2-hover.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProduct wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage2/product7.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProduct wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage2/product8.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage1/product2-hover.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                  ...
                  <div className="tab-pane fade" id="newproducts" role="tabpanel" aria-labelledby="newproducts-tab"> 
                    <div className="row"> 
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProduct wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage2/product8.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage1/product2-hover.png" alt="Indovia" /></a>
                  ...
                  <div className="tab-pane fade" id="salesproducts" role="tabpanel" aria-labelledby="salesproducts-tab"> 
                    <div className="row"> 
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProduct wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage2/product5.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png" alt="Indovia" /></a>
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProduct wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage2/product4.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6"> 
                        <div className="cardProduct wow fadeInUp">
                          <div className="cardImage"><a href="#"><img className="imageMain" src="/assets/imgs/page/homepage2/product7.png" alt="Indovia" /><img className="imageHover" src="/assets/imgs/page/homepage1/product2-hover.png" alt="Indovia" /></a>
                            <div className="button-select"><a href="#">Select Options</a></div>
                            <div className="box-quick-button"><a className="btn" href="#">
                                <svg className="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#clip0_116_452)">
