...
const Index18 = () => (
  <>
    <Helmet>
      <title>Index 18 | Indovia Store</title>
    </Helmet>
    <div className="landing-page-index-18">
      <header className="header sticky-bar header-style-2 header-style-2-nofix">
          ...
          <main className="main">
            <div className="section banner-homepage18"> 
              <div className="container-banner-home18"> 
                <div className="banner-main-1">
                  <div className="banner-main-inner">
                    <h1 className="mb-20">Women’s</h1>
                    <ul className="menu-banner"> 
