...
const AboutUs1 = () => (
  <>
    <Helmet>
      <title>About Us 1 | Larkon Store</title>
    </Helmet>
            ...
            <section className="section block-our-shop">
              <div className="container"> 
                ...
                <div className="row mt-60 wow fadeInUp"> 
                  <div className="col-lg-6"><img src="/assets/imgs/page/about1/about1.png" alt="Guza" /></div>
                  <div className="col-lg-6"><img src="/assets/imgs/page/about1/about2.png" alt="Guza" /></div>
                </div>
              </div>
            </section>
                ...
                <div className="row mt-60 wow zoomIn"> 
                  <div className="col-lg-4">
                    <div className="cardTeam"> 
                      <div className="cardImage"><img src="/assets/imgs/page/about1/team.png" alt="Guza" /></div>
                      <div className="cardInfo"> 
                        <h6 className="cardTitle text-17-medium">Anna Madsen</h6>
                        <p className="cardDesc text-17 neutral-medium-dark">Co-founder</p>
                        <div className="socials"><a href="#"><img src="/assets/imgs/page/about1/fb.svg" alt="Guza" /></a><a href="#"><img src="/assets/imgs/page/about1/insta.svg" alt="Guza" /></a></div>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-4">
                    <div className="cardTeam"> 
                      <div className="cardImage"><img src="/assets/imgs/page/about1/team2.png" alt="Guza" /></div>
                      <div className="cardInfo"> 
                  ...
                  <div className="col-lg-4">
                    <div className="cardTeam"> 
                      <div className="cardImage"><img src="/assets/imgs/page/about1/team3.png" alt="Guza" /></div>
                      <div className="cardInfo"> 
