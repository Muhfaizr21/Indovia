...
const Index2 = () => (
  <>
    <Helmet>
      <title>Index 2 | Larkon Store</title>
    </Helmet>
                ...
                <div className="row"> 
                  <div className="col-lg-4 col-md-6"> 
                    <div className="cardFeatureCat wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage2/cat.png" alt="Guza" /></a></div>
                  ...
                  <div className="col-lg-4 col-md-6"> 
                    <div className="cardFeatureCat wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage2/cat2.png" alt="Guza" /></a></div>
                      <div className="cardInfo"><a href="#">
                  ...
                  <div className="col-lg-4 col-md-6"> 
                    <div className="cardFeatureCat wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage2/cat3.png" alt="Guza" /></a></div>
                      <div className="cardInfo"><a href="#">
                  ...
                  <div className="col-lg-4 col-md-6"> 
                    <div className="cardFeatureCat wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage2/cat4.png" alt="Guza" /></a></div>
                      <div className="cardInfo"><a href="#">
                  ...
                  <div className="col-lg-4 col-md-6"> 
                    <div className="cardFeatureCat wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage2/cat5.png" alt="Guza" /></a></div>
                      <div className="cardInfo"><a href="#">
                  ...
                  <div className="col-lg-4 col-md-6"> 
                    <div className="cardFeatureCat wow fadeInUp">
                      <div className="cardImage"><a href="#"><img src="/assets/imgs/page/homepage2/cat6.png" alt="Guza" /></a></div>
                      <div className="cardInfo"><a href="#">
            ...
            <section className="section box-sale-countdown">
              <div className="container">
                <div className="row align-items-center">
                  <div className="col-lg-6 wow fadeInLeft"><img src="/assets/imgs/page/homepage2/banner-sale.png" alt="Guza" /></div>
